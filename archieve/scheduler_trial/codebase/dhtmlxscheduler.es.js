...
dhtmlxScheduler v.7.2.11 Professional Evaluation
...
function pa(e) {
  ...
  function d(o) {
    const { event: c, layout: h, viewName: y, sectionId: x, eventNode: g } = o;
    (function(l, f) {
      switch (f) {
        case "month":
    ...
    const u = {};
    let v = { start_date: c.start_date, end_date: c.end_date, css: "dhx_scheduler_dnd_marker", html: g };
    if (h == "timeline") {
      const l = e.getView(y);
      if (l.round_position) {
    ...
    return h != "timeline" && h != "month" || (v = { ...v, end_date: e.date.add(c.start_date, 1, "minute") }), x && (u[y] = x, v.sections = u), v;
  }
  function r(o) {
    const { layout: c } = o;
    let h;
    switch (c) {
      case "month":
        h = function(y) {
          let x = [];
          const { event: g, layout: u, viewName: v, sectionId: l } = y, f = [];
          let m = new Date(g.start_date);
          for (; m.valueOf() < g.end_date.valueOf(); ) {
            let D = { start_date: m };
            f.push(D), m = e.date.week_start(e.date.add(m, 1, "week"));
          }
          let b = e.$container.querySelectorAll(`[${e.config.event_attribute}='${g.id}']`);
          for (let D = 0; D < b.length; D++) {
            const k = { event: f[D], layout: u, viewName: v, sectionId: l, eventNode: b[D].cloneNode(!0) };
            x.push(d(k));
          }
          return x;
        }(o);
      ...
      case "units":
        h = function(y) {
          let x = [];
          const { event: g, layout: u, viewName: v, eventNode: l } = y;
          let f = function(m) {
            const b = e.getView(m);
            return b.y_property ? b.y_property : b.map_to ? b.map_to : void 0;
          }(v);
          if (f) {
            const m = String(g[f]).split(e.config.section_delimiter).map((D) => String(D)), b = [];
            for (let D = 0; D < m.length; D++) {
              b[D] = l.cloneNode(!0);
              const k = { event: g, layout: u, viewName: v, sectionId: m[D], eventNode: b[D] };
              x.push(d(k));
            }
          }
          return x;
      ...
      default:
        h = function(y) {
          const { event: x, layout: g, viewName: u, sectionId: v } = y;
          let l = [], f = e.$container.querySelectorAll(`[${e.config.event_attribute}='${x.id}']:not(.dhx_cal_select_menu):not(.dhx_drag_marker)`);
          if (f)
            for (let m = 0; m < f.length; m++) {
              let b = f[m].cloneNode(!0);
              const D = { event: { start_date: /* @__PURE__ */ new Date(+b.getAttribute("data-bar-start")), end_date: /* @__PURE__ */ new Date(+b.getAttribute("data-bar-end")) }, layout: g, viewName: u, sectionId: v, eventNode: b };
              l.push(d(D));
            }
          return l;
        }(o);
  ...
  e.attachEvent("onBeforeDrag", function(o, c, h) {
    ...
    if (t && n()) {
      t = !1;
      const y = e.getState().mode, x = _(y), g = e.getActionData(h).section;
      s && r({ event: s, layout: x, viewName: y, sectionId: g, eventNode: a });
    }
...
function ga(e) {
  ...
  e.blockTime = function(n, _, d) {
    ...
    for (var r = !0, o = new Date(n.start_date.valueOf()), c = e.date.add(o, 1, "day"), h = e._marked_timespans; o < n.end_date; o = e.date.date_part(c), c = e.date.add(o, 1, "day")) {
      var y = +e.date.date_part(new Date(o)), x = s(n, h, o.getDay(), y, _);
      if (x)
        for (var g = 0; g < x.length; g += 2) {
          var u = e._get_zone_minutes(o), v = n.end_date > c || n.end_date.getDate() != o.getDate() ? 1440 : e._get_zone_minutes(n.end_date), l = x[g], f = x[g + 1];
    ...
    if (n.rec_type && n._end_date || n.rrule) {
      const x = n._end_date || n.end_date;
      return !d.limit_start || !d.limit_end || x.valueOf() >= d.limit_start.valueOf() && n.start_date.valueOf() <= d.limit_end.valueOf();
    }
    r = [n];
    for (var o = !0, c = 0; c < r.length; c++) {
      var h = !0, y = r[c];
      y._timed = e.isOneDayEvent(y), (h = !d.limit_start || !d.limit_end || y.start_date.valueOf() >= d.limit_start.valueOf() && y.end_date.valueOf() <= d.limit_end.valueOf()) && (h = !e.checkInMarkedTimespan(y, i, function(x, g, u, v, l) {
        var f = !0;
        return g <= l && g >= v && ((l == 1440 || u <= l) && (f = !1), x._timed && _._drag_id && _._drag_mode == "new-size" ? (x.start_date.setHours(0), x.start_date.setMinutes(l)) : f = !1), (u >= v && u <= l || g < v && u > l) && (x._timed && _._drag_id && _._drag_mode == "new-size" ? (x.end_date.setHours(0), x.end_date.setMinutes(v)) : f = !1), f;
    ...
    var c = [];
    if (n && n[_])
      for (var h = n[_], y = this._get_relevant_blocked_zones(d, r, h, o), x = 0; x < y.length; x++)
        c = this._add_timespan_zones(c, y[x].zones);
    return c;
    ...
    if (!this._table_view) {
      if (this._props && this._props[this._mode]) {
        var c, h, y = this._props[this._mode], x = y.size || y.options.length;
        y.days > 1 ? (y.size && y.options.length && (n = (y.position + n) / y.options.length * y.size), c = n, h = n + x) : h = (c = 0) + x;
        for (var g = [], u = c; u < h; u++) {
          var v = u;
          o.days = v;
    ...
    if (h) {
      for (var y in h)
        if (h.hasOwnProperty(y)) {
          var x = h[y];
          for (x instanceof Array || (x = [x]), o = 0; o < x.length; o++)
            (b = e._lame_copy({}, n)).sections = {}, b.sections[y] = x[o], d.push(b);
        }
    } else
      d.push(n);
    for (var g = 0; g < d.length; g++) {
      var u = d[g], v = u.start_date, l = u.end_date;
      if (v && l)
        for (var f = e.date.date_part(new Date(v)), m = e.date.add(f, 1, "day"); f < l; ) {
          var b;
          delete (b = e._lame_copy({}, u)).start_date, delete b.end_date, b.days = f.valueOf();
          var D = v > f ? e._get_zone_minutes(v) : 0, k = l > m || l.getDate() != f.getDate() ? 1440 : e._get_zone_minutes(l);
          b.zones = [D, k], _.push(b), f = m, m = e.date.add(m, 1, "day");
        }
      else
    ...
    if (e._table_view && e._mode == "month") {
      ...
      for (m = 0; m < l.length; m++) {
        ...
        if (!this._ignores[b]) {
          var D = e._get_block_by_config(n);
          D.className = v, D.style.top = "0px", D.style.height = "100%";
          for (var k = 0; k < u.length; k += 2) {
            var S = u[m];
            if ((M = u[m + 1]) <= S)
              return [];
            (N = D.cloneNode(!0)).style.left = "0px", N.style.width = "100%", _.appendChild(N), r.push(N);
          }
        }
      }
    } else {
      ...
      if (this._props && this._props[this._mode] && n.sections && n.sections[this._mode]) {
        ...
        p = w.order[n.sections[this._mode]];
        var E = w.order[n.sections[this._mode]];
        w.days > 1 ? p = p * (w.size || w.options.length) + E : (p = E, w.size && p > w.position + w.size && (p = 0));
      }
      for (_ = _ || e.locate_holder(p), m = 0; m < u.length; m += 2) {
        var M, N;
        if (S = Math.max(u[m], 60 * o.first_hour), (M = Math.min(u[m + 1], 60 * o.last_hour)) <= S) {
          if (m + 2 < u.length)
            continue;
          return [];
        }
        ...
        N.style.top = Math.round((60 * S * 1e3 - this.config.first_hour * A) * this.config.hour_size_px / A) % T + "px", N.style.height = Math.max(Math.round(60 * (M - S) * 1e3 * this.config.hour_size_px / A) % T, 1) + "px", _.appendChild(N), r.push(N);
      }
    }
    return r;
    ...
    if (n.id = r, h) {
      for (var x in h)
        if (h.hasOwnProperty(x)) {
          d[x] || (d[x] = {});
          var g = h[x], u = d[x];
          u[g] || (u[g] = {}), u[g][c] || (u[g][c] = {}), u[g][c][y] || (u[g][c][y] = [], e._marked_timespans_types || (e._marked_timespans_types = {}), e._marked_timespans_types[y] || (e._marked_timespans_types[y] = !0));
          var v = u[g][c][y];
    ...
    for (var r = 0; r < d.length; r += 2)
      for (var o = d[r], c = d[r + 1], h = r + 2 == d.length, y = 0; y < _.length; y += 2) {
        var x = _[y], g = _[y + 1];
        if (g > c && x <= c || x < o && g >= o)
          d[r] = Math.min(o, x), d[r + 1] = Math.max(c, g), r -= 2;
        else {
          if (!h)
            continue;
          var u = o > x ? 0 : 2;
    ...
    for (var d = n.slice(), r = 0; r < d.length; r += 2)
      for (var o = d[r], c = d[r + 1], h = 0; h < _.length; h += 2) {
        ...
        if (x > o && y < c) {
          var g = !1;
          o >= y && c <= x && d.splice(r, 2), o < y && (d.splice(r, 2, o, y), g = !0), c > x && d.splice(g ? r + 2 : r, g ? 0 : 2, x, c), r -= 2;
          break;
        }
      }
    return d;
    ...
    if (_) {
      if (o !== void 0)
        ...
        for (var x in _)
          if (_[x][c]) {
            var g = e._lame_clone(n);
            n.days = x, e._addMarkerTimespanConfig(g), e._delete_marked_timespans_list(_[x][c], n);
          }
    }
    ...
    if (!e._table_view || e._mode == "month") {
      ...
      if (this._props && this._props[o]) {
        var x = this._props[o], g = x.options, u = g[e._get_unit_index(x, _)];
        if (x.days > 1) {
          var v = Math.round((_ - e._min_date) / 864e5), l = x.size || g.length;
      ...
      if (e.config.overwrite_marked_timespans) {
        ...
        b[r] && h.push.apply(h, e._get_configs_to_render(b[r])), b[d] && h.push.apply(h, e._get_configs_to_render(b[d]));
      for (var k = 0; k < h.length; k++)
        y.push.apply(y, e._render_marked_timespan(h[k], n, _));
      return y;
    }
...
function ma(e) {
  ...
  return e.$stateProvider.registerProvider("batchUpdate", function() {
    ...
    const y = { setModeDate: { date: null, mode: null }, needRender: !1, needUpdateView: !1, repaintEvents: {} }, x = (u, v) => {
      u && (y.setModeDate.date = u), v && (y.setModeDate.mode = v);
    };
    var g = { render: (u, v) => {
      y.needRender = !0, x(u, v);
    }, setCurrentView: (u, v) => {
      y.needRender = !0, x(u, v);
    }, updateView: (u, v) => {
      y.needUpdateView = !0, x(u, v);
    }, render_data: () => y.needRender = !0, render_view_data: (u) => {
      u && u.length ? u.forEach((v) => y.repaintEvents[v.id] = !0) : y.needRender = !0;
    } };
    if (n.call(this, g), t = !0, this.callEvent("onBeforeBatchUpdate", []), d(r), this.callEvent("onAfterBatchUpdate", []), _.call(this), t = !1, !o)
      if (y.needRender)
...
function xa(e) {
  ...
  })(e), pa(e), ga(e), function(i) {
    i.batchUpdate = ma(i);
  }(e), function(i) {
    i.ext || (i.ext = {}), i.ext.liveUpdates = { RemoteEvents: ya, remoteUpdates: ba(i) };
  }(e);
}
var wa = Date.now();
function ot(e) {
  ...
  if (i && typeof i == "object")
    switch (!0) {
      ...
      default:
        for (t in a = {}, i) {
          const n = typeof i[t];
          n === "string" || n === "number" || n === "boolean" ? a[t] = i[t] : ot(i[t]) ? a[t] = new Date(i[t]) : Object.prototype.hasOwnProperty.apply(i, [t]) && (a[t] = e(i[t]));
        }
    }
  return a || i;
}, defined: function(e) {
...
function ka(e) {
  function i(g) {
    ...
    return (g || "").split(" ").forEach(function(v) {
      u.classList.add(v);
    }), u;
  }
  var t = function() {
    ...
    var u = i("dhx_cal_tab");
    return u.setAttribute("name", g.view + "_tab"), u.setAttribute("data-tab", g.view), e.config.fix_tab_position && (g.$firstTab ? u.classList.add("dhx_cal_tab_first") : g.$lastTab ? u.classList.add("dhx_cal_tab_last") : g.view !== "week" && u.classList.add("dhx_cal_tab_standalone"), g.$segmentedTab && u.classList.add("dhx_cal_tab_segmented")), u;
  }, n = function() {
    ...
    return g.click || u.$_eventAttached || e.event(u, "click", function() {
  ...
  function c(g) {
    ...
    if (u) {
      var v = u(g);
      if (g.css && v.classList.add(g.css), g.width && ((l = g.width) === 1 * l && (l += "px"), v.style.width = l), g.height && ((l = g.height) === 1 * l && (l += "px"), v.style.height = l), g.click && e.event(v, "click", g.click), g.html && (v.innerHTML = g.html), g.align) {
        var l = "";
        g.align == "right" ? l = "flex-end" : g.align == "left" && (l = "flex-start"), v.style.justifyContent = l;
      }
      return v;
    }
  }
  ...
  function y(g) {
    ...
    for (var l = 0; l < u.length; l++) {
      ...
      var b = c(m);
      v.appendChild(b), (m.cols || m.rows) && b.appendChild(y(m.cols || m.rows));
    }
    return v;
  }
  e._init_nav_bar = function(g) {
    var u = this.$container.querySelector(".dhx_cal_navline");
    return u || ((u = document.createElement("div")).className = "dhx_cal_navline dhx_cal_navline_flex", e._update_nav_bar(g, u), u);
  };
  var x = null;
  e._update_nav_bar = function(g, u) {
    if (g) {
      var v = !1, l = g.height || e.xy.nav_height;
      x !== null && x === l || (v = !0), v && (e.xy.nav_height = l), u.innerHTML = "", u.appendChild(y(g)), e.unset_actions(), e._els = [], e.get_elements(), e.set_actions(), u.style.display = l === 0 ? "none" : "", x = l;
    }
  };
}
function Ea(e) {
...
function Ma(e) {
  ...
  var s = !1, n = Qt({ target: e }, "dhx_form_repeat", !1);
...
const Ce = { getAbsoluteLeft: function(e) {
  ...
  for (t.sort(function(n, _) {
    ...
    var s = t[a];
    (Na(s) || Aa(s) || Ta(s)) && Ma(s) || (t.splice(a, 1), a--);
  }
  return t;
}, getClassName: Zt, locateCss: Qt, getRootNode: Ot, hasShadowParent: function(e) {
  return !!Ot(e);
}, isShadowDomSupported: ea, getActiveElement: function() {
  ...
  var t = document.documentElement, a = function(s) {
    ...
    if (s.getBoundingClientRect) {
      var o = s.getBoundingClientRect(), c = document.body, h = document.documentElement || document.body.parentNode || document.body, y = window.pageYOffset || h.scrollTop || c.scrollTop, x = window.pageXOffset || h.scrollLeft || c.scrollLeft, g = h.clientTop || c.clientTop || 0, u = h.clientLeft || c.clientLeft || 0;
      n = o.top + y - g, _ = o.left + x - u, d = document.body.offsetWidth - o.right, r = document.body.offsetHeight - o.bottom;
    } else {
      for (; s; )
...
function Oa(e) {
  ...
  e.date = { init: function() {
    ...
    var r = s() ? t : i, o = r(n, _), c = /^[0-9]{4}(\-|\/)[0-9]{2}(\-|\/)[0-9]{2} ?(([0-9]{1,2}:[0-9]{1,2})(:[0-9]{1,2})?)?$/, h = /^[0-9]{2}\/[0-9]{2}\/[0-9]{4} ?(([0-9]{1,2}:[0-9]{2})(:[0-9]{1,2})?)?$/, y = /^[0-9]{2}\-[0-9]{2}\-[0-9]{4} ?(([0-9]{1,2}:[0-9]{1,2})(:[0-9]{1,2})?)?$/, x = /^([\+-]?\d{4}(?!\d{2}\b))((-?)((0[1-9]|1[0-2])(\3([12]\d|0[1-9]|3[01]))?|W([0-4]\d|5[0-2])(-?[1-7])?|(00[1-9]|0[1-9]\d|[12]\d{2}|3([0-5]\d|6[1-6])))([T\s]((([01]\d|2[0-3])((:?)[0-5]\d)?|24\:?00)([\.,]\d+(?!:))?)?(\17[0-5]\d([\.,]\d+)?)?([zZ]|([\+-])([01]\d|2[0-3]):?([0-5]\d)?)?)?)?$/, g = r("%Y-%m-%d %H:%i:%s", _), u = r("%m/%d/%Y %H:%i:%s", _), v = r("%d-%m-%Y %H:%i:%s", _);
    return function(l) {
    ...
    t._parsers.xml = { canParse: function(a, s) {
      ...
      for (var _ = t.ajax.xpath("//coll_options", a.xmlDoc), d = 0; d < _.length; d++) {
        ...
        for (var c = t.ajax.xpath(".//item", _[d]), h = 0; h < c.length; h++) {
          for (var y = c[h].attributes, x = { key: c[h].getAttribute("value"), label: c[h].getAttribute("label") }, g = 0; g < y.length; g++) {
            var u = y[g];
            u.nodeName != "value" && u.nodeName != "label" && (x[u.nodeName] = u.nodeValue);
          }
          o.push(x);
        }
      }
  ...
  e._lightbox_controls = {}, e.formSection = function(t) {
    ...
    for (var r = "", o = 0; o < a.length; o++) {
      ...
      switch (c) {
        case "%Y":
          var x, g, u;
          h = "dhx_lightbox_year_select", t._time_format_order[3] = o, t.year_range && (isNaN(t.year_range) ? t.year_range.push && (g = t.year_range[0], u = t.year_range[1]) : x = t.year_range), x = x || 10;
          var v = v || Math.floor(x / 2);
          g = g || n.getFullYear() - v, u = u || g + x;
          for (var l = g; l < u; l++)
    ...
    if (r.auto_end_date && r.event_duration)
      for (var x = function() {
        ...
        o[g].$_eventAttached || (o[g].$_eventAttached = !0, e.event(o[g], "change", x));
    function u(v, l, f) {
      for (var m = n._time_values, b = 60 * f.getHours() + f.getMinutes(), D = b, k = !1, S = 0; S < m.length; S++) {
        var p = m[S];
        if (p === b) {
          k = !0;
          break;
      ...
      v[l + c[0]].value = k ? b : D, k || D || (v[l + c[0]].selectedIndex = -1), v[l + c[1]].value = f.getDate(), v[l + c[2]].value = f.getMonth(), v[l + c[3]].value = f.getFullYear();
    }
    ...
    for (var c = this.config.lightbox.sections, h = 0; h < c.length; h++) {
      var y = c[h], x = e._get_lightbox_section_node(y), g = this.form_blocks[y.type], u = s[y.map_to] !== void 0 ? s[y.map_to] : y.default_value;
      g.set_value.call(this, x, u, s, y), c[h].focus && g.focus.call(this, x);
    }
    e._lightbox_id = t;
    ...
    if (!this._lightbox) {
      ...
      a += "</div>", a += "</div>", t.innerHTML = a, e.config.drag_lightbox && (e.event(t.firstChild, "mousedown", e._ready_to_dnd), e.event(t.firstChild, "selectstart", function(x) {
...
function Ha(e) {
  e._init_touch_events = function() {
    ...
    var s, n, _, d, r, o, c = 0;
    function h(x, g, u) {
      e.event(x, g, function(v) {
        return !!e._is_lightbox_open() || (a(v) ? void 0 : u(v));
      }, { passive: !1 });
    }
    function y(x) {
      a(x) || (e._hide_global_tip(), d && (e._on_mouse_up(t(x)), e._temp_touch_block = !1), e._drag_id = null, e._drag_mode = null, e._drag_pos = null, e._pointerDragId = null, clearTimeout(_), d = o = !1, r = !0);
    }
    h(document.body, i[0], function(x) {
      if (!a(x)) {
        var g = t(x);
        if (g) {
          if (d)
            return function(u) {
              if (!a(u)) {
                ...
                v == "create" && l && (e.render_view_data = function() {
                  for (var m = e.getState().drag_id, b = e.getEvent(m), D = l.y_property, k = e.getEvents(b.start_date, b.end_date), S = 0; S < k.length; S++)
                    k[S][D] != b[D] && (k.splice(S, 1), S--);
            ...
            }(g), x.preventDefault && x.preventDefault(), x.cancelBubble = !0, e._update_global_tip(), !1;
          n = t(x), o && (n ? (s.target != n.target || Math.abs(s.pageX - n.pageX) > 5 || Math.abs(s.pageY - n.pageY) > 5) && (r = !0, clearTimeout(_)) : r = !0);
        }
      }
    }), h(this._els.dhx_cal_data[0], "touchcancel", y), h(this._els.dhx_cal_data[0], "contextmenu", function(x) {
      if (!a(x))
        return o ? (x && x.preventDefault && x.preventDefault(), x.cancelBubble = !0, !1) : void 0;
    }), h(this._obj, i[1], function(x) {
      var g;
      if (document && document.body && document.body.classList.add("dhx_cal_touch_active"), !a(x))
        if (e._pointerDragId = x.pointerId, d = r = !1, o = !0, g = n = t(x)) {
          var u = /* @__PURE__ */ new Date();
          if (!r && !d && u - c < 250)
            return e._click.dhx_cal_data(g), window.setTimeout(function() {
              e.$destroyed || e._on_dbl_click(g);
            }, 50), x.preventDefault && x.preventDefault(), x.cancelBubble = !0, e._block_next_stop = !0, !1;
          if (c = u, !r && !d && e.config.touch_drag) {
            var v = e._locate_event(document.activeElement), l = e._locate_event(g.target), f = s ? e._locate_event(s.target) : null;
            if (v && l && v == l && v != f)
              return x.preventDefault && x.preventDefault(), x.cancelBubble = !0, e._ignore_next_click = !1, e._click.dhx_cal_data(g), s = g, !1;
            _ = setTimeout(function() {
              if (!e.$destroyed) {
                d = !0;
                var m = s.target, b = e._getClassName(m);
                m && b.indexOf("dhx_body") != -1 && (m = m.previousSibling), e._on_mouse_down(s, m), e._drag_mode && e._drag_mode != "create" && e.for_rendered(e._drag_id, function(D, k) {
          ...
          r = !0;
    }), h(this._els.dhx_cal_data[0], i[2], function(x) {
      if (document && document.body && document.body.classList.remove("dhx_cal_touch_active"), !a(x))
        return e.config.touch_swipe_dates && !d && function(g, u, v, l) {
          if (!g || !u)
            return !1;
          for (var f = g.target; f && f != e._obj; )
            f = f.parentNode;
          if (f != e._obj || e.matrix && e.matrix[e.getState().mode] && e.matrix[e.getState().mode].scrollable)
            return !1;
          var m = Math.abs(g.pageY - u.pageY), b = Math.abs(g.pageX - u.pageX);
          return m < l && b > v && (!m || b / m > 3) && (g.pageX > u.pageX ? e._click.dhx_cal_next_button() : e._click.dhx_cal_prev_button(), !0);
        }(s, n, 200, 100) && (e._block_next_stop = !0), d && (e._ignore_next_click = !0, setTimeout(function() {
          e._ignore_next_click = !1;
        }, 100)), y(x), e._block_next_stop ? (e._block_next_stop = !1, x.preventDefault && x.preventDefault(), x.cancelBubble = !0, !1) : void 0;
...
function za(e) {
  ...
  e._addThemeClass = function() {
    ...
    (function() {
      const x = e.$container;
      clearInterval(_), x && (_ = setInterval(() => {
        const g = getComputedStyle(x).getPropertyValue("--dhx-scheduler-theme");
    ...
    if (c) {
      o = r;
      for (let x in e.xy)
        h[x] = d.getPropertyValue(`--dhx-scheduler-xy-${x}`);
      ...
      o = function() {
        for (var x = document.getElementsByTagName("link"), g = 0; g < x.length; g++) {
          var u = x[g].href.match("dhtmlxscheduler_([a-z]+).css");
          if (u)
            return u[1];
        }
      }(), y = e._is_material_skin();
    if (e._theme_info = { theme: o, cssVarTheme: c, oldMaterialTheme: y, values: h }, e._theme_info.cssVarTheme) {
      const x = this._theme_info.values;
      for (let g in e.xy)
        isNaN(parseInt(x[g])) || (e.xy[g] = parseInt(x[g]));
    }
  ...
  e.attachEvent("onDestroy", function() {
    ...
    this._build_skin_info(), this.skin || (this.skin = this._theme_info.theme), e._addThemeClass(), e.skin === "flat" ? e.templates.hour_scale = n : e.templates.hour_scale === n && (e.templates.hour_scale = e.date.date_to_str(e.config.hour_date)), e.attachEvent("onTemplatesReady", function() {
      ...
      e.templates.month_day = function(o) {
        ...
        if (e.config.header)
          return;
        const c = Array.from(o.querySelectorAll(".dhx_cal_tab")), h = ["day", "week", "month"].map((x) => c.find((g) => g.getAttribute("data-tab") === x)).filter((x) => x !== void 0);
        let y = c.length > 0 ? c[0] : null;
        h.reverse().forEach((x) => {
          o.insertBefore(x, y), y = x;
        });
...
function Pa(e) {
  ...
  function a(l, f, m) {
    var b = l.callback;
    b && b(f, m), g.hide(l.box), t = l.box = null;
  }
  function s(l) {
    if (t) {
      ...
      if (u.keyboard) {
        if (f == 13 || f == 32) {
          ...
          Ce.getClassName(b).indexOf("scheduler_popup_button") > -1 && b.click ? b.click() : (a(t, !0), m = !0);
        }
        f == 27 && (a(t, !1), m = !0);
      }
  ...
  function _(l, f, m) {
    var b = e._waiAria.messageButtonAttrString(l), D = (f || "").toLowerCase().replace(/ /g, "_");
    return `<div ${b} class='scheduler_popup_button dhtmlx_popup_button ${`scheduler_${D}_button dhtmlx_${D}_button`}' data-result='${m}' result='${m}' ><div>${l}</div></div>`;
  }
  function d() {
  ...
  function r(l, f, m) {
    var b = l.tagName ? l : function(S, p, w) {
    ...
    l.hidden || n(!0), document.body.appendChild(b);
    var D = Math.abs(Math.floor(((window.innerWidth || document.documentElement.offsetWidth) - b.offsetWidth) / 2)), k = Math.abs(Math.floor(((window.innerHeight || document.documentElement.offsetHeight) - b.offsetHeight) / 2));
    return l.position == "top" ? b.style.top = "-3px" : b.style.top = k + "px", b.style.left = D + "px", e.event(b, "keydown", s), g.focus(b), l.hidden && g.hide(b), e.callEvent("onMessagePopup", [b]), b;
  }
  function o(l) {
    return r(l, !0, !1);
  }
  ...
  function x(l, f, m, b, D) {
    return typeof l != "object" && (l = { text: l, type: f, expire: m, id: b, callback: D }), l.id = l.id || ve.uid(), l.expire = l.expire || u.expire, l;
  }
  ...
  var u = function(l, f, m, b) {
    switch ((l = x.apply(this, arguments)).type = l.type || "info", l.type.split("-")[0]) {
      case "alert":
        return o(l);
      case "confirm":
        return c(l);
...
ct.prototype = { setTransactionMode: function(e, i) {
  ...
  if (e) {
    ...
    if (this._tMode === "CUSTOM") {
      var s = this.getState(i), n = this.getActionByState(s);
    ...
    switch (this._tMode) {
      case "GET":
        r = this._cleanupArgumentsBeforeSend(e), o.url = h + a.urlSeparator(h) + this.serialize(r, i), o.method = "GET";
        break;
      case "POST":
        r = this._cleanupArgumentsBeforeSend(e), o.url = h, o.method = "POST", o.data = this.serialize(r, i);
        break;
      case "JSON":
        r = {};
        var y = this._cleanupItemBeforeSend(e);
        for (var x in y)
          x !== this.action_param && x !== "id" && x !== "gr_id" && (r[x] = y[x]);
        o.url = h, o.method = "POST", o.data = JSON.stringify({ id: i, action: e[this.action_param], data: r });
        break;
      case "REST":
      case "REST-JSON":
        switch (h = c.replace(/(&|\?)editing=true/, ""), r = "", this.getState(i)) {
          case "inserted":
...
const Ia = (e) => {
  bt() || setTimeout(() => {
    ...
    if (typeof 1770101122000 > "u")
      return;
    const t = `$_${Date.now()}_validate`, a = setInterval(() => {
      Date.now() - 1770101122000 > 27648e5 && e.message({ type: "error", text: i, expire: -1, id: t });
  ...
  bt() || setTimeout(function() {
    ...
    const t = `$_${Date.now()}_validate`, a = setInterval(function() {
      Date.now() - 1770101122000 > 5184e6 && e.message({ type: "error", text: i, expire: -1, id: t });
...
`);
    ...
    const t = function() {
      var a, s;
      setTimeout(function() {
        Date.now() - 1770101122000 > 7776e6 && I.alert(i), t();
...
class Fa {
  ...
  _renderDayGrid(i) {
    ...
    const y = this.scheduler, x = y.date.week_start(y.date.month_start(new Date(t))), g = y.date.month_start(new Date(t)), u = y.date.add(y.date.month_start(new Date(t)), 1, "month");
    ...
    let f = this._weeksBetween(x, v);
    n && f < n && (v = y.date.add(v, n - f, "week"));
    let m = x;
    const b = document.createElement("div");
    for (b.classList.add("dhx_cal_datepicker_days"), this._domEvents.attach(b, "click", (D) => {
      const k = D.target.closest("[data-cell-date]"), S = new Date(k.getAttribute("data-cell-date"));
      this.callEvent("onDateClick", [S, D]);
    }); m.valueOf() < v.valueOf(); ) {
      if (!_ || !_(m)) {
        const D = document.createElement("div");
        D.setAttribute("data-cell-date", y.templates.format_date(m)), D.setAttribute("data-day", m.getDay()), D.innerHTML = y.templates.month_day(m), m.valueOf() < g.valueOf() ? D.classList.add("dhx_before") : m.valueOf() >= u.valueOf() && D.classList.add("dhx_after"), m.getDay() !== 0 && m.getDay() !== 6 || D.classList.add("dhx_cal_datepicker_weekend"), m.valueOf() == l.valueOf() && D.classList.add("dhx_now"), d && r && m.valueOf() >= d.valueOf() && m.valueOf() < r.valueOf() && D.classList.add("dhx_cal_datepicker_current"), o[m.valueOf()] && D.classList.add("dhx_cal_datepicker_event"), D.classList.add("dhx_cal_datepicker_date"), b.appendChild(D);
      }
    ...
    r.init = function(u, v, l) {
      if (!this.$destroyed) {
        if (v = v || r._currentDate(), l = l || "week", this._obj && this.unset_actions(), this._obj = typeof u == "string" ? document.getElementById(u) : u, this.$container = this._obj, this.$root = this._obj, !this.$container.offsetHeight && this.$container.offsetWidth && this.$container.style.height === "100%" && window.console.error(r._commonErrorMessages.collapsedContainer(), this.$container), this.config.wai_aria_attributes && this.config.wai_aria_application_role && this.$container.setAttribute("role", "application"), this.config.header || y(this.$container) || (this.config.header = function(f) {
          ...
          if (f.matrix)
            for (const b in f.matrix)
              m.push(b);
          if (f._props)
            for (const b in f._props)
              m.push(b);
          if (f._grid && f._grid.names)
            for (const b in f._grid.names)
              m.push(b);
...
`));
      ...
      if (r._is_material_skin()) {
        ...
        const m = r.$root.querySelector(".dhx_cal_navline");
        let b = 0;
        m && (b += m.offsetHeight);
        const D = r.$root.querySelector(".dhx_cal_header");
        let k, S, p = 0;
        D && (p += D.offsetHeight), p ? (k = b + 1, S = p) : (k = b - 4, S = 5), this.set_xy(l, u, S, 0, k);
      } else
        l && l.parentNode.removeChild(l);
      this._lightbox && (r.$container.offsetWidth < 1200 || this._setLbPosition(document.querySelector(".dhx_cal_light"))), this._data_width = u - v, this._els.dhx_cal_navline[0].style.width = u + "px";
      ...
      var D = "left";
      v !== void 0 && (u.style.width = b(v)), l !== void 0 && (u.style.height = b(l)), arguments.length > 3 && (f !== void 0 && (this.config.rtl && (D = "right"), u.style[D] = f + "px"), m !== void 0 && (u.style.top = m + "px"));
    ...
    const x = r._createDomEventScope();
    function g(u, v) {
    ...
    r.unset_actions = function() {
      ...
      x.attach(this._obj, "selectstart", function(u) {
        return u.preventDefault(), !1;
      }), x.attach(this._obj, "mousemove", function(u) {
        r._temp_touch_block || r._on_mouse_move(u);
      }), x.attach(this._obj, "mousedown", function(u) {
        r._ignore_next_click || r._on_mouse_down(u);
      }), x.attach(this._obj, "mouseup", function(u) {
        r._ignore_next_click || r._on_mouse_up(u);
      }), x.attach(this._obj, "dblclick", function(u) {
        r._on_dbl_click(u);
      }), x.attach(this._obj, "contextmenu", function(u) {
      ...
      r._delete_event_confirm({ event: r.getEvent(u), message: v, title: r.locale.labels.title_confirm_deleting, callback: function() {
        r.deleteEvent(u);
      ...
      f = f || {};
      const m = { ...f, text: u };
      v && (m.title = v), l && (m.callback = function(b) {
        b && l();
      }), r.confirm(m);
      ...
      if (!v) {
        ...
        S > b.getHours() && (b.setHours(S), u = b.valueOf()), v = u.valueOf() + m;
      }
      let D = new Date(v);
      b.valueOf() == D.valueOf() && D.setTime(D.valueOf() + m), f.start_date = f.start_date || b, f.end_date = f.end_date || D, f.text = f.text || this.locale.labels.new_event, f.id = this._drag_id = f.id || this.uid(), this._drag_mode = "new-size", this._loading = !0;
      ...
      if (b)
        ...
        for (k = 1; k < this._colsS.heights.length && !(this._colsS.heights[k] > v.y); k++)
          ;
        v.y = Math.ceil(24 * (Math.max(0, D) + 7 * Math.max(0, k - 1)) * 60 / this.config.time_step), (r._drag_mode || this._mode == "month") && (v.y = 24 * (Math.max(0, Math.ceil(D) - 1) + 7 * Math.max(0, k - 1)) * 60 / this.config.time_step), this._drag_mode == "move" && r._ignores_detected && r.config.preserve_length && (v._ignores = !0, this._drag_event._event_length || (this._drag_event._event_length = this._get_real_event_length(this._drag_event.start_date, this._drag_event.end_date, { x_step: 1, x_unit: "day" }))), v.x = 0;
      } else
      ...
      if (this._drag_mode) {
        ...
        if (this._is_pos_changed(this._drag_pos, v)) {
          ...
          if (this._drag_pos && !this._drag_pos.has_moved && ((m = this._drag_pos).has_moved = !0), this._drag_pos = v, this._drag_pos.has_moved = !0, this._drag_mode == "create") {
            ...
            var b = new Date(this._drag_start), D = new Date(f);
            this._mode != "day" && this._mode != "week" || b.getHours() != D.getHours() || b.getMinutes() != D.getMinutes() || (D = new Date(this._drag_start + 1e3)), this._drag_id = this.uid(), this.addEvent(b, D, this.locale.labels.new_event, this._drag_id, v.fields), this.callEvent("onEventCreated", [this._drag_id, u]), this._loading = !1, this._drag_mode = "new-size";
          }
          ...
          if (r.matrix && (k = r.matrix[r._mode]), k = k || { x_step: 1, x_unit: "day" }, this._drag_mode == "move")
            l = this._min_date.valueOf() + 6e4 * (v.y * this.config.time_step + 24 * v.x * 60), !v.custom && this._table_view && (l += 1e3 * this.date.time_part(p.start_date)), !this._table_view && this._dragEventBody && this._drag_event._move_event_shift === void 0 && (this._drag_event._move_event_shift = l - p.start_date), this._drag_event._move_event_shift && (l -= this._drag_event._move_event_shift), l = this._correct_shift(l), v._ignores && this.config.preserve_length && this._table_view && k ? (l = r._correct_drag_start_date(l), f = r._correct_drag_end_date(l, this._drag_event._event_length)) : f = p.end_date.valueOf() - (p.start_date.valueOf() - l);
          else {
            if (l = p.start_date.valueOf(), f = p.end_date.valueOf(), this._table_view) {
              ...
              if (this._mode == "month")
                if (w = this._correct_shift(w, !1), this._drag_from_start) {
                  var E = 864e5;
                  w <= r.date.date_part(new Date(f + E - 1)).valueOf() && (l = w - E);
                } else
                  f = w;
              else if (this.config.preserve_length) {
                if (v.resize_from_start)
                  l = r._correct_drag_start_date(w), k.round_position && k.first_hour && k.last_hour && k.x_unit == "day" && (l = new Date(1 * l + k._start_correction));
                else if (f = r._correct_drag_end_date(w, 0), k.round_position && k.first_hour && k.last_hour && k.x_unit == "day" && (f = r.date.date_part(new Date(f)), f = new Date(1 * f - k._end_correction)), k.round_position && r["ignore_" + r._mode] && k.x_unit == "day") {
                  const W = this["ignore_" + this._mode];
                  let B = r.date.add(new Date(f), -k.x_step, k.x_unit);
                  W(B) && (f = B);
                }
              } else
            ...
            if (this._drag_mode == "new-size")
              ...
              f <= l && (f = k && k.round_position ? k.x_unit == "hour" || k.x_unit == "minute" ? r.date.add(l, k.x_step, k.x_unit) : r.date.add(r.date.date_part(new Date(l)), 1, k.x_unit) : l + 6e4 * S);
          }
          var q = new Date(f - 1), V = new Date(l);
          if (this._drag_mode == "move" && r.config.limit_drag_out && (+V < +r._min_date || +f > +r._max_date)) {
            if (+p.start_date < +r._min_date || +p.end_date > +r._max_date)
              V = new Date(p.start_date), f = new Date(p.end_date);
            else {
              var R = f - V;
              +V < +r._min_date ? (V = new Date(r._min_date), v._ignores && this.config.preserve_length && this._table_view ? (V = new Date(r._correct_drag_start_date(V)), k._start_correction && (V = new Date(V.valueOf() + k._start_correction)), f = new Date(1 * V + this._get_fictional_event_length(V, this._drag_event._event_length, k))) : f = new Date(+V + R)) : (f = new Date(r._max_date), v._ignores && this.config.preserve_length && this._table_view ? (k._end_correction && (f = new Date(f.valueOf() - k._end_correction)), f = new Date(1 * f - this._get_fictional_event_length(f, 0, k, !0)), V = new Date(1 * f - this._get_fictional_event_length(f, this._drag_event._event_length, k, !0)), this._ignores_detected && (V = r.date.add(V, k.x_step, k.x_unit), f = new Date(1 * f - this._get_fictional_event_length(f, 0, k, !0)), f = r.date.add(f, k.x_step, k.x_unit))) : V = new Date(+f - R));
            }
            q = new Date(f - 1);
          }
          if (!this._table_view && this._dragEventBody && !r.config.all_timed && (!r._get_section_view() && v.x != this._get_event_sday({ start_date: new Date(l), end_date: new Date(l) }) || new Date(l).getHours() < this.config.first_hour) && (R = f - V, this._drag_mode == "move" && (E = this._min_date.valueOf() + 24 * v.x * 60 * 6e4, (V = new Date(E)).setHours(this.config.first_hour), +V <= +p.start_date ? f = new Date(+V + R) : V = new Date(+f - R))), this._table_view || r.config.all_timed || !(!r.getView() && v.x != this._get_event_sday({ start_date: new Date(f), end_date: new Date(f) }) || new Date(f).getHours() >= this.config.last_hour) || (R = f - V, E = this._min_date.valueOf() + 24 * v.x * 60 * 6e4, (f = r.date.date_part(new Date(E))).setHours(this.config.last_hour), q = new Date(f - 1), this._drag_mode == "move" && (+V <= +p.start_date ? f = new Date(+V + R) : V = new Date(+f - R))), !this._table_view && r.config.all_timed) {
          ...
          if (this._table_view && r["ignore_" + this._mode] && (this._drag_mode == "resize" || this._drag_mode == "new-size") && +f > +r._max_date) {
            ...
            const W = this["ignore_" + this._mode];
            for (; W(f); )
              f = r.date.add(f, -k.x_step, k.x_unit);
            f = r.date.add(f, k.x_step, k.x_unit);
          }
          if (this._table_view || q.getDate() == V.getDate() && q.getHours() < this.config.last_hour || r._allow_dnd)
            if (p.start_date = V, p.end_date = new Date(f), this.config.update_render) {
      ...
      if (!u || u.button != 2 || !this._mobile) {
        if (this._drag_mode && this._drag_id) {
          ...
          if (f && (this._drag_event._dhx_changed || !this._drag_event.start_date || m.start_date.valueOf() != this._drag_event.start_date.valueOf() || m.end_date.valueOf() != this._drag_event.end_date.valueOf())) {
            ...
            if (this.callEvent("onBeforeEventChanged", [m, u, b, this._drag_event]))
              if (this._drag_id = this._drag_mode = null, b && this.config.edit_on_create) {
                if (this.unselect(), this._new_event = /* @__PURE__ */ new Date(), m.$new = !0, this._table_view || this.config.details_on_create || !this.config.select || !this.isOneDayEvent(this.getEvent(v)))
              ...
              b ? this.deleteEvent(m.id, !0) : (this._drag_event._dhx_changed = !1, this._clear_temporary_properties(m, this._drag_event), r._lame_copy(m, this._drag_event), this.updateEvent(m.id));
          }
      ...
      for (var u = ["dhx_cal_next_button", "dhx_cal_prev_button", "dhx_cal_tab", "dhx_cal_today_button"], v = 0; v < u.length; v++)
        for (var l = this._els[u[v]], f = 0; l && f < l.length; f++) {
          var m = l[f].getAttribute("data-tab") || l[f].getAttribute("name"), b = this.locale.labels[u[v]];
          m && (b = this.locale.labels[m + "_tab"] || this.locale.labels[m] || b), u[v] == "dhx_cal_next_button" ? b = this.locale.labels.next : u[v] == "dhx_cal_prev_button" && (b = this.locale.labels.prev), this._waiAria.headerButtonsAttributes(l[f], b || "");
        }
 ...
 **scheduler.updateView** or **scheduler.setCurrentView** can be called only after **scheduler.init**`);
      ...
      var f = this._obj, m = "dhx_scheduler_" + this._mode, b = "dhx_scheduler_" + v;
      f.classList.remove(m), f.classList.add(b);
      ...
      b.className = "dhx_scale_bar", this.templates[this._mode + "_scalex_class"] && (b.className += " " + this.templates[this._mode + "_scalex_class"](l));
      var D = this._cols[u];
      this._mode == "month" && u === 0 && this.config.left_border && (b.className += " dhx_scale_bar_border", v += 1), this.set_xy(b, D, this.xy.scale_height - 1, v, m);
      var k = this.templates[this._mode + "_scale_date"](l, this._mode);
      b.innerHTML = k, this._waiAria.dayHeaderAttr(b, k), f.appendChild(b);
      ...
      var f = this.config.rtl, m = u, b = this._get_columns_num(v, l);
      this._process_ignores(v, b, "day", 1);
      for (var D = b - this._ignores_detected, k = 0; k < b; k++)
        this._ignores[k] ? (this._cols[k] = 0, D++) : this._cols[k] = Math.floor(m / (D - k)), m -= this._cols[k], this._colsS[k] = (this._cols[k - 1] || 0) + (this._colsS[k - 1] || (this._table_view ? 0 : f ? this.xy.scroll_width : this.xy.scale_width));
      ...
      var l = new Date(r._min_date), f = new Date(r._max_date), m = this.date.date_part(r._currentDate()), b = parseInt(u.style.width, 10) - 1, D = new Date(this._min_date), k = this._get_columns_num(l, f);
      this._calc_scale_sizes(b, l, f);
      var S = 0;
      u.innerHTML = "";
      for (var p = 0; p < k; p++) {
        if (this._ignores[p] || this._render_x_header(p, S, D, u), !this._table_view) {
          var w = document.createElement("div"), E = "dhx_scale_holder";
          D.valueOf() == m.valueOf() && (E += " dhx_scale_holder_now"), w.setAttribute("data-column-index", p), this._ignores_detected && this._ignores[p] && (E += " dhx_scale_ignore");
          ...
          w.className = E + " " + this.templates.week_date_class(D, m), this._waiAria.dayColumnAttr(w, D), this._set_scale_col_size(w, this._cols[p], S), v.appendChild(w), this.callEvent("onScaleAdd", [w, D]);
        }
      ...
      if (this.templates[this._mode + "_date"]) {
        ...
        var f, m, b = (l.readonly || !l.drag_resize ? " dhx_resize_denied" : "") + (l.readonly || !l.drag_move ? " dhx_move_denied" : "");
        v.className = "dhx_cal_data" + b, this._scales = {}, this._cols = [], this._colsS = { height: 0 }, this._dy_shift = 0, this.set_sizes();
        var D = this._get_timeunit_start(), k = r._get_view_end();
        f = m = this._table_view ? r.date.week_start(D) : D, this._min_date = f;
        var S = this.templates[this._mode + "_date"](D, k, this._mode), p = this._getNavDateElement();
        if (p && (p.innerHTML = S, this._waiAria.navBarDateAttr(p, S)), this._max_date = k, r._render_scales(u, v), this._table_view)
          this._reset_month_scale(v, D, m);
        else if (this._reset_hours_scale(v, D, m), l.multi_day) {
          var w = "dhx_multi_day";
          ...
          var A = E.cloneNode(!0);
          A.className = w + "_icon", A.style.visibility = "hidden", A.style.display = "none", this.set_xy(A, this.xy.scale_width + 1, 0, 0), E.appendChild(A), this._els[w] = [E, A], r.event(this._els[w][0], "click", this._click.dhx_cal_data);
        }
      }
    }, r._reset_hours_scale = function(u, v, l) {
      var f = document.createElement("div");
      f.className = "dhx_scale_holder";
      for (var m = new Date(1980, 1, 1, this.config.first_hour, 0, 0), b = 1 * this.config.first_hour; b < this.config.last_hour; b++) {
        var D = document.createElement("div");
        ...
        var S = r.templates.hour_scale(m);
        D.innerHTML = S, this._waiAria.hourScaleAttr(D, S), f.appendChild(D), m = this.date.add(m, 1, "hour");
      }
      ...
      this._reset_ignores();
      var b = r["ignore_" + this._mode];
      if (b)
        for (var D = new Date(u), k = 0; k < v; k++)
          b(D) && (this._ignores_detected += 1, this._ignores[k] = !0, m && v++), D = r.date.add(D, f, l), r.date[l + "_start"] && (D = r.date[l + "_start"](D));
    }, r._render_month_scale = function(u, v, l, f) {
      var m = r.date.add(v, 1, "month"), b = new Date(l), D = r._currentDate();
      D = this.date.date_part(D), l = this.date.date_part(l), f = f || Math.ceil(Math.round((m.valueOf() - l.valueOf()) / 864e5) / 7);
      for (var k = [], S = 0; S <= 7; S++) {
      ...
      function w(V) {
        ...
        return r._colsS.heights[V + 1] !== void 0 && (R = r._colsS.heights[V + 1] - (r._colsS.heights[V] || 0)), R;
      }
      var E = 0;
      ...
      for (M.classList.add("dhx_cal_month_table"), S = 0; S < f; S++) {
        ...
        for (var T = 0; T < 7; T++) {
          ...
          l < v ? C += " dhx_before" : l >= m ? C += " dhx_after" : l.valueOf() == D.valueOf() && (C += " dhx_now"), this._ignores_detected && this._ignores[T] && (C += " dhx_scale_ignore"), A.className = C + " " + this.templates.month_date_class(l, D), A.setAttribute("data-cell-date", r.templates.format_date(l));
        ...
        r._colsS.heights[S] = E, E += w(S);
      }
      return this._min_date = b, this._max_date = l, u.innerHTML = "", u.appendChild(M), this._scales = {}, u.querySelectorAll("[data-cell-date]").forEach((V) => {
        const R = r.templates.parse_date(V.getAttribute("data-cell-date")), F = V.querySelector(".dhx_month_body");
      ...
      return this._colsS.height = b + this.xy.month_head_height, this._colsS.heights = [], r._render_month_scale(u, v, l, f);
      ...
      for (var l = this.config.lightbox.sections, f = 0; f < l.length; f++)
        if (l[f].map_to == u) {
          for (var m = l[f].options, b = 0; b < m.length; b++)
            if (m[b].key == v)
              return m[b].label;
        }
      return "";
      ...
      var f, m = v - u, b = this["ignore_" + this._mode], D = 0;
      l.render ? (D = this._get_date_index(l, u), f = this._get_date_index(l, v), u.valueOf() < r.getState().min_date.valueOf() && (D = -g(u, r.getState().min_date)), v.valueOf() > r.getState().max_date.valueOf() && (f += g(v, r.getState().max_date))) : f = Math.round(m / 60 / 60 / 1e3 / 24);
      for (var k = !0; D < f; ) {
        var S = r.date.add(v, -l.x_step, l.x_unit);
        if (b && b(v) && (!k || k && b(S)))
          m -= v - S;
        else {
          let p = 0;
          ...
          E.valueOf() > A.valueOf() && (p += E - A), E.valueOf() > T.valueOf() ? p += l._start_correction : p += 60 * E.getHours() * 60 * 1e3 + 60 * E.getMinutes() * 1e3, w.valueOf() <= N.valueOf() && (p += l._end_correction), w.valueOf() < M.valueOf() && (p += M.valueOf() - w.valueOf()), m -= p, k = !1;
        }
        v = S, f--;
      }
      return m;
    }, r._get_fictional_event_length = function(u, v, l, f) {
      var m = new Date(u), b = f ? -1 : 1;
      if (l._start_correction || l._end_correction) {
        var D;
        D = f ? 60 * m.getHours() + m.getMinutes() - 60 * (l.first_hour || 0) : 60 * (l.last_hour || 0) - (60 * m.getHours() + m.getMinutes());
        var k = 60 * (l.last_hour - l.first_hour), S = Math.ceil((v / 6e4 - D) / k);
        S < 0 && (S = 0), v += S * (1440 - k) * 60 * 1e3;
      }
      var p, w = new Date(1 * u + v * b), E = this["ignore_" + this._mode], M = 0;
      function N() {
        return l.x_unit === "day" ? M * b < p * b : M * b <= p * b;
      }
      for (l.render ? (M = this._get_date_index(l, m), p = this._get_date_index(l, w)) : p = Math.round(v / 60 / 60 / 1e3 / 24); N(); ) {
        var T = r.date.add(m, l.x_step * b, l.x_unit);
        E && E(m) && (v += (T - m) * b, p += b), m = T, M += b;
      }
      return v;
    ...
    (function() {
      ...
      for (var g in r._waiAria = { getAttributeString: function(u) {
        var v = [" "];
        for (var l in u)
  ...
  i.utils.mixin(i, t), i.env = i.$env = Ca, i.Promise = Promise, function(r) {
    ...
    r.Promise = typeof window < "u" ? window.Promise : Promise, r.ajax = { cache: !0, method: "get", serializeRequestParams: st, parse: function(c) {
      ...
      if (h.status === void 0 || h.status < 400) {
        var x = h.responseXML ? h.responseXML || h : this.parse(h.responseText || h);
        if (x && x.documentElement !== null && !x.getElementsByTagName("parsererror").length)
          return x.getElementsByTagName(c)[0];
      }
      ...
      for (var y, x = [], g = (h.ownerDocument || h).evaluate(c, h, null, XPathResult.ANY_TYPE, null); y = g.iterateNext(); )
        x.push(y);
      return x;
    }, query: function(c) {
      return this._call(c.method || "GET", c.url, c.data || "", c.async || !0, c.callback, c.headers);
    }, get: function(c, h, y) {
      var x = o("GET", arguments);
      return this.query(x);
    }, getSync: function(c, h) {
      var y = o("GET", arguments);
      return y.async = !1, this.query(y);
    }, put: function(c, h, y, x) {
      var g = o("PUT", arguments);
      return this.query(g);
    }, del: function(c, h, y) {
      var x = o("DELETE", arguments);
      return this.query(x);
    }, post: function(c, h, y, x) {
      arguments.length == 1 ? h = "" : arguments.length == 2 && typeof h == "function" && (y = h, h = "");
      var g = o("POST", arguments);
      return this.query(g);
    }, postSync: function(c, h, y) {
      h = h === null ? "" : String(h);
      var x = o("POST", arguments);
      return x.async = !1, this.query(x);
    }, _call: function(c, h, y, x, g, u) {
      return new r.Promise((function(v, l) {
        ...
        if (x && f.addEventListener("readystatechange", function() {
          if (f.readyState == 4 || m && f.readyState == 3) {
            if ((f.status != 200 || f.responseText === "") && !r.callEvent("onAjaxError", [f]))
              return;
            setTimeout(function() {
              typeof g == "function" && g.apply(window, [{ xmlDoc: f, filePath: h }]), v(f), typeof g == "function" && (g = null, f = null);
            }, 0);
          }
        }), c != "GET" || this.cache || (h += (h.indexOf("?") >= 0 ? "&" : "?") + "dhxr" + (/* @__PURE__ */ new Date()).getTime() + "=1"), f.open(c, h, x), u)
          for (var b in u)
            f.setRequestHeader(b, u[b]);
        else
          c.toUpperCase() == "POST" || c == "PUT" || c == "DELETE" ? f.setRequestHeader("Content-Type", "application/x-www-form-urlencoded") : c == "GET" && (y = null);
        if (f.setRequestHeader("X-Requested-With", "XMLHttpRequest"), f.send(y), !x)
    ...
    r.config = { default_date: "%j %M %Y", month_date: "%F %Y", load_date: "%Y-%m-%d", week_date: "%l", day_date: "%D %j", hour_date: "%H:%i", month_day: "%d", date_format: "%Y-%m-%d %H:%i", api_date: "%d-%m-%Y %H:%i", parse_exact_format: !1, preserve_length: !0, time_step: 5, displayed_event_color: "#ff4a4a", displayed_event_text_color: "#ffef80", wide_form: 0, day_column_padding: 8, use_select_menu_space: !0, fix_tab_position: !0, start_on_monday: !0, first_hour: 0, last_hour: 24, readonly: !1, drag_resize: !0, drag_move: !0, drag_create: !0, drag_event_body: !0, dblclick_create: !0, details_on_dblclick: !0, edit_on_create: !0, details_on_create: !0, header: null, hour_size_px: 44, resize_month_events: !1, resize_month_timed: !1, responsive_lightbox: !1, separate_short_events: !0, rtl: !1, cascade_event_display: !1, cascade_event_count: 4, cascade_event_margin: 30, multi_day: !0, multi_day_height_limit: 200, drag_lightbox: !0, preserve_scroll: !0, select: !0, undo_deleted: !0, server_utc: !1, touch: !0, touch_tip: !0, touch_drag: 500, touch_swipe_dates: !1, quick_info_detached: !0, positive_closing: !1, drag_highlight: !0, limit_drag_out: !1, icons_edit: ["icon_save", "icon_cancel"], icons_select: ["icon_details", "icon_edit", "icon_delete"], buttons_right: ["dhx_save_btn", "dhx_cancel_btn"], buttons_left: ["dhx_delete_btn"], lightbox: { sections: [{ name: "description", map_to: "text", type: "textarea", focus: !0 }, { name: "time", height: 72, type: "time", map_to: "auto" }] }, highlight_displayed_event: !0, left_border: !1, ajax_error: "alert", delay_render: 0, timeline_swap_resize: !0, wai_aria_attributes: !0, wai_aria_application_role: !0, csp: "auto", event_attribute: "data-event-id", show_errors: !0 }, r.config.buttons_left.$initial = r.config.buttons_left.join(), r.config.buttons_right.$initial = r.config.buttons_right.join(), r._helpers = { parseDate: function(o) {
      ...
      (function(h, y) {
        ...
        return "";
      }, month_scale_date: o(c.week_date), week_scale_date: o(c.day_date), hour_scale: o(c.hour_date), time_picker: o(c.hour_date), event_date: o(c.hour_date), month_day: o(c.month_day), load_format: o(c.load_date), format_date: o(c.date_format, c.server_utc), parse_date: r.date.str_to_date(c.date_format, c.server_utc), api_date: r.date.str_to_date(c.api_date, !1, !1), event_header: function(h, y, x) {
        return x._mode === "small" || x._mode === "smallest" ? r.templates.event_date(h) : r.templates.event_date(h) + " - " + r.templates.event_date(y);
      }, event_text: function(h, y, x) {
        return x.text;
      }, event_class: function(h, y, x) {
        return "";
      }, month_date_class: function(h) {
        return "";
      }, week_date_class: function(h) {
        return "";
      }, event_bar_date: function(h, y, x) {
        return r.templates.event_date(h);
      }, event_bar_text: function(h, y, x) {
        return x.text;
      }, month_events_link: function(h, y) {
        return "<a>View more(" + y + " events)</a>";
      }, drag_marker_class: function(h, y, x) {
        return "";
      }, drag_marker_content: function(h, y, x) {
        return "";
      }, tooltip_date_format: r.date.date_to_str("%Y-%m-%d %H:%i"), tooltip_text: function(h, y, x) {
        return "<b>Event:</b> " + x.text + "<br/><b>Start date:</b> " + r.templates.tooltip_date_format(h) + "<br/><b>End date:</b> " + r.templates.tooltip_date_format(y);
    ...
    r._events = {}, r.clearAll = function() {
    ...
    }, r.addEvent = function(o, c, h, y, x) {
      if (!arguments.length)
        return this.addEventNow();
      var g = o;
      arguments.length != 1 && ((g = x || {}).start_date = o, g.end_date = c, g.text = h, g.id = y), g.id = g.id || r.uid(), g.text = g.text || "", typeof g.start_date == "string" && (g.start_date = this.templates.api_date(g.start_date)), typeof g.end_date == "string" && (g.end_date = this.templates.api_date(g.end_date));
      var u = 6e4 * (this.config.event_duration || this.config.time_step);
      new Date(g.end_date).valueOf() - new Date(g.start_date).valueOf() <= u && g.end_date.setTime(g.start_date.valueOf() + u), g.start_date.setMilliseconds(0), g.end_date.setMilliseconds(0), g._timed = this.isOneDayEvent(g);
      var v = !this._events[g.id];
      return this._events[g.id] = g, this.event_updated(g), this._loading || this.callEvent(v ? "onEventAdded" : "onEventChanged", [g.id, g]), g.id;
      ...
      for (var o = ["text", "Text", "start_date", "StartDate", "end_date", "EndDate"], c = function(x) {
        return function(g) {
          return r.getEvent(g)[x];
        };
      }, h = function(x) {
        return function(g, u) {
          var v = r.getEvent(g);
          v[x] = u, v._changed = !0, v._timed = this.isOneDayEvent(v), r.event_updated(v, !0);
        };
      }, y = 0; y < o.length; y += 2)
      ...
      if (o.start_date.valueOf() < this._max_date.valueOf() && this._min_date.valueOf() < o.end_date.valueOf()) {
        var c = o.start_date.getHours(), h = o.end_date.getHours() + o.end_date.getMinutes() / 60, y = this.config.last_hour, x = this.config.first_hour;
        return !(!this._table_view && (h > y || h <= x) && (c >= y || c < x) && !((o.end_date.valueOf() - o.start_date.valueOf()) / 36e5 > 24 - (this.config.last_hour - this.config.first_hour) || c < y && h > x));
      }
      return !1;
      ...
      if (this.config.multi_day && !this._table_view) {
        ...
        for (y = 0; y < o.length; y++)
          this._is_main_area_event(o[y]) ? g.push(o[y]) : u.push(o[y]);
        if (!this._els.dhx_multi_day) {
          var v = r._commonErrorMessages.unknownView(this._mode);
          throw new Error(v);
        }
        this._rendered_location = this._els.dhx_multi_day[0], this._table_view = !0, this.render_data(u, c), this._table_view = !1, this._rendered_location = this._els.dhx_cal_data[0], this._table_view = !1, this.render_data(g, c);
      } else {
      ...
      for (var c = this._rendered_location, h = this._lame_clone(o), y = o._sday; y < o._eday; y++) {
        ...
        var x = r.date, g = r._min_date;
        g = x.add(g, h._sweek, "week"), g = x.add(g, h._sday, "day");
        var u = r.getEvents(g, x.add(g, 1, "day")).length, v = this._get_event_bar_pos(h), l = v.x2 - v.x, f = document.createElement("div");
        r.event(f, "click", function(m) {
          r._view_month_day(m);
        }), f.className = "dhx_month_link", f.style.top = v.y + "px", f.style.left = v.x + "px", f.style.width = l + "px", f.innerHTML = r.templates.month_events_link(g, u), this._rendered.push(f), c.appendChild(f);
      }
      ...
      for (var h = {}, y = 0; y < o.length; y++)
        if (this._table_view)
          if (r._mode != "month")
            ...
            var x = r.config.max_month_events;
            x !== 1 * x || o[y]._sorder < x ? this.render_event_bar(o[y]) : x !== void 0 && o[y]._sorder == x && r._render_month_link(o[y]);
          }
        else {
          var g = o[y], u = r.locate_holder(g._sday);
          if (!u)
            continue;
          h[g._sday] || (h[g._sday] = { real: u, buffer: document.createDocumentFragment(), width: u.clientWidth });
          var v = h[g._sday];
          this.render_event(g, v.buffer, v.width);
        }
      for (var y in h)
      ...
      var h = this.xy.bar_height, y = this._colsS.heights, x = this._colsS.heights = [0, 0, 0, 0, 0, 0, 0], g = this._els.dhx_cal_data[0];
      if (o = this._table_view ? this._pre_render_events_table(o, c) : this._pre_render_events_line(o, c), this._table_view)
        if (c)
          ...
          var u = g.querySelectorAll(".dhx_cal_month_row");
          if (u.length) {
            for (var v = 0; v < u.length; v++) {
              ...
              if (x[v] * h > f) {
                var m = f;
                1 * this.config.max_month_events !== this.config.max_month_events || x[v] <= this.config.max_month_events ? m = x[v] * h : (this.config.max_month_events + 1) * h > f && (m = (this.config.max_month_events + 1) * h), u[v].style.height = m + this.xy.month_head_height + "px";
              }
              x[v] = (x[v - 1] || 0) + r._get_first_visible_cell(l).offsetHeight;
            }
            x.unshift(0);
            const N = this.$container.querySelector(".dhx_cal_data");
            if (N.offsetHeight < N.scrollHeight && !r._colsS.scroll_fix && r.xy.scroll_width) {
              var b = r._colsS, D = b[b.col_length], k = b.heights.slice();
              D -= r.xy.scroll_width || 0, this._calc_scale_sizes(D, this._min_date, this._max_date), r._colsS.heights = k, this.set_xy(this._els.dhx_cal_header[0], D), r._render_scales(this._els.dhx_cal_header[0]), r._render_month_scale(this._els.dhx_cal_data[0], this._get_timeunit_start(), this._min_date), b.scroll_fix = !0;
            }
          } else if (o.length || this._els.dhx_multi_day[0].style.visibility != "visible" || (x[0] = -1), o.length || x[0] == -1) {
            var S = (x[0] + 1) * h + 4, p = S, w = S + "px";
            this.config.multi_day_height_limit && (w = (p = Math.min(S, this.config.multi_day_height_limit)) + "px");
            var E = this._els.dhx_multi_day[0];
            E.style.height = w, E.style.visibility = x[0] == -1 ? "hidden" : "visible", E.style.display = x[0] == -1 ? "none" : "";
            var M = this._els.dhx_multi_day[1];
            M.style.height = w, M.style.visibility = x[0] == -1 ? "hidden" : "visible", M.style.display = x[0] == -1 ? "none" : "", M.className = x[0] ? "dhx_multi_day_icon" : "dhx_multi_day_icon_small", this._dy_shift = (x[0] + 1) * h, this.config.multi_day_height_limit && (this._dy_shift = Math.min(this.config.multi_day_height_limit, this._dy_shift)), x[0] = 0, p != S && (E.style.overflowY = "auto", M.style.position = "fixed", M.style.top = "", M.style.left = "");
          }
        }
      return o;
      ...
      for (var x = 0; x < o.length; x++) {
        var g = o[x], u = g.start_date, v = g.end_date, l = u.getHours(), f = v.getHours();
        if (g._sday = this._get_event_sday(g), this._ignores[g._sday])
          o.splice(x, 1), x--;
        else {
          if (h[g._sday] || (h[g._sday] = []), !c) {
            g._inner = !1;
            for (var m = h[g._sday]; m.length; ) {
              var b = m[m.length - 1];
              if (!(this._get_event_mapped_end_date(b).valueOf() <= g.start_date.valueOf()))
                break;
              m.splice(m.length - 1, 1);
            }
            for (var D = m.length, k = !1, S = 0; S < m.length; S++)
              if (b = m[S], this._get_event_mapped_end_date(b).valueOf() <= g.start_date.valueOf()) {
                k = !0, g._sorder = b._sorder, D = S, g._inner = !0;
                break;
              }
            if (m.length && (m[m.length - 1]._inner = !0), !k)
              if (m.length)
                if (m.length <= m[m.length - 1]._sorder) {
                  if (m[m.length - 1]._sorder)
                    for (S = 0; S < m.length; S++) {
                      for (var p = !1, w = 0; w < m.length; w++)
                        if (m[w]._sorder == S) {
                          p = !0;
                          break;
                        }
                  ...
                  for (S = 1; S < m.length; S++)
                    m[S]._sorder > E && (E = m[S]._sorder);
                  g._sorder = E + 1, g._inner = !1;
                }
              else
                g._sorder = 0;
            m.splice(D, D == m.length ? 0 : 1, g), m.length > (m.max_count || 0) ? (m.max_count = m.length, g._count = m.length) : g._count = g._count ? g._count : 1;
          }
          (l < this.config.first_hour || f >= this.config.last_hour) && (y.push(g), o[x] = g = this._copy_event(g), l < this.config.first_hour && (g.start_date.setHours(this.config.first_hour), g.start_date.setMinutes(0)), f >= this.config.last_hour && (g.end_date.setMinutes(0), g.end_date.setHours(this.config.last_hour)), g.start_date > g.end_date || l == this.config.last_hour) && (o.splice(x, 1), x--);
        }
      }
      if (!c) {
        for (x = 0; x < o.length; x++)
          o[x]._count = h[o[x]._sday].max_count;
        for (x = 0; x < y.length; x++)
          y[x]._count = h[y[x]._sday].max_count;
      }
      return o;
      ...
      var y = this._cols.length, x = !1, g = o, u = !0, v = new Date(c);
      for (r.date.day_start(new Date(c)).valueOf() != c.valueOf() && (v = r.date.day_start(v), v = r.date.add(v, 1, "day")); g < v; ) {
        u = !1;
        var l = this.locate_holder_day(g, !1, h) % y;
        if (!this._ignores[l]) {
          x = !0;
          break;
        }
      ...
      this._time_order(o);
      for (var h, y = [], x = [[], [], [], [], [], [], []], g = this._colsS.heights, u = this._cols.length, v = {}, l = 0; l < o.length; l++) {
        var f = o[l], m = f.id;
        v[m] || (v[m] = { first_chunk: !0, last_chunk: !0 });
        var b = v[m], D = h || f.start_date, k = f.end_date;
        D < this._min_date && (b.first_chunk = !1, D = this._min_date), k > this._max_date && (b.last_chunk = !1, k = this._max_date);
        var S = this.locate_holder_day(D, !1, f);
        if (f._sday = S % u, !this._ignores[f._sday] || !f._timed) {
          var p = this.locate_holder_day(k, !0, f) || u;
          if (f._eday = p % u || u, f._length = p - S, f._sweek = Math.floor((this._correct_shift(D.valueOf(), 1) - this._min_date.valueOf()) / (864e5 * u)), r._is_any_multiday_cell_visible(D, k, f)) {
            var w, E = x[f._sweek];
            for (w = 0; w < E.length && !(E[w]._eday <= f._sday); w++)
              ;
            if (f._sorder && c || (f._sorder = w), f._sday + f._length <= u)
              h = null, y.push(f), E[w] = f, g[f._sweek] = E.length - 1, f._first_chunk = b.first_chunk, f._last_chunk = b.last_chunk;
            else {
              var M = this._copy_event(f);
              M.id = f.id, M._length = u - f._sday, M._eday = u, M._sday = f._sday, M._sweek = f._sweek, M._sorder = f._sorder, M.end_date = this.date.add(D, M._length, "day"), M._first_chunk = b.first_chunk, b.first_chunk && (b.first_chunk = !1), y.push(M), E[w] = M, h = M.end_date, g[f._sweek] = E.length - 1, l--;
            }
          } else
            h = null;
        }
      ...
      var y = r.xy.menu_width, x = this.config.use_select_menu_space ? 0 : y;
      if (!(o._sday < 0)) {
        var g = r.locate_holder(o._sday);
        if (g) {
          c = c || g;
          ...
          var b = Math.floor((h - x) / f), D = m * b + 1;
          if (o._inner || (b *= f - m), this.config.cascade_event_display) {
            const A = this.config.cascade_event_count, C = this.config.cascade_event_margin;
            let H, $ = (f - m - 1) % A * C, O = m % A * C;
            f * C < h - this.config.day_column_padding ? H = o._inner ? $ / 2 : 0 : (H = o._inner ? $ / 3 : 0, D = O / 3, f * C / 2 > h - this.config.day_column_padding && (H = o._inner ? $ / A : 0, D = O / A)), b = Math.floor(h - x - D - H);
          }
          o._mode = l < 30 ? "smallest" : l < 42 ? "small" : null;
          var k = this._render_v_bar(o, x + D, v, b, l, o._text_style, r.templates.event_header(o.start_date, o.end_date, o), r.templates.event_text(o.start_date, o.end_date, o));
          if (o._mode === "smallest" ? k.classList.add("dhx_cal_event--xsmall") : o._mode === "small" && k.classList.add("dhx_cal_event--small"), this._waiAria.eventAttr(o, k), this._rendered.push(k), c.appendChild(k), D = D + parseInt(this.config.rtl ? g.style.right : g.style.left, 10) + x, this._edit_id == o.id) {
            k.style.zIndex = 1, b = Math.max(b, r.xy.editor_width), (k = document.createElement("div")).setAttribute("event_id", o.id), k.setAttribute(this.config.event_attribute, o.id), this._waiAria.eventAttr(o, k), k.className = "dhx_cal_event dhx_cal_editor", this.config.rtl && D++, this.set_xy(k, b, l, D, v), o.color && k.style.setProperty("--dhx-scheduler-event-background", o.color);
            var S = r.templates.event_class(o.start_date, o.end_date, o);
            S && (k.className += " " + S);
            var p = document.createElement("div");
            p.style.cssText += "overflow:hidden;height:100%", k.appendChild(p), this._els.dhx_cal_data[0].appendChild(k), this._rendered.push(k), p.innerHTML = "<textarea class='dhx_cal_editor'>" + o.text + "</textarea>", this._editor = p.querySelector("textarea"), r.event(this._editor, "keydown", function(A) {
              if (A.shiftKey)
                return !0;
              var C = A.keyCode;
    ...
    }, r._render_v_bar = function(o, c, h, y, x, g, u, v, l) {
      var f = document.createElement("div"), m = o.id, b = l ? "dhx_cal_event dhx_cal_select_menu" : "dhx_cal_event", D = r.getState();
      D.drag_id == o.id && (b += " dhx_cal_event_drag"), D.select_id == o.id && (b += " dhx_cal_event_selected");
      var k = r.templates.event_class(o.start_date, o.end_date, o);
      k && (b = b + " " + k), this.config.cascade_event_display && (b += " dhx_cal_event_cascade");
      var S = y - 1, p = `<div event_id="${m}" ${this.config.event_attribute}="${m}" class="${b}"
				style="position:absolute; top:${h}px; ${this.config.rtl ? "right:" : "left:"}${c}px; width:${S}px; height:${x}px; ${g || ""}" 
				data-bar-start="${o.start_date.valueOf()}" data-bar-end="${o.end_date.valueOf()}">
				</div>`;
      f.innerHTML = p;
      var w = f.cloneNode(!0).firstChild;
      if (!l && r.renderEvent(w, o, y, x, u, v))
      ...
      var c = this.config.rtl, h = this._colsS, y = h[o._sday], x = h[o._eday];
      c && (y = h[h.col_length] - h[o._eday] + h[0], x = h[h.col_length] - h[o._sday] + h[0]), x == y && (x = h[o._eday + 1]);
      var g = this.xy.bar_height, u = o._sorder;
      if (o.id == this._drag_id) {
        var v = h.heights[o._sweek + 1] - h.heights[o._sweek] - this.xy.month_head_height;
        u = r._get_dnd_order(u, g, v);
      }
      var l = u * g;
      return { x: y, x2: x, y: h.heights[o._sweek] + (h.height ? this.xy.month_scale_height + 2 : 2) + l };
    }, r.render_event_bar = function(o) {
      var c = this._rendered_location, h = this._get_event_bar_pos(o), y = h.y, x = h.x, g = h.x2, u = "";
      if (g) {
        var v = r.config.resize_month_events && this._mode == "month" && (!o._timed || r.config.resize_month_timed), l = document.createElement("div"), f = o.hasOwnProperty("_first_chunk") && o._first_chunk, m = o.hasOwnProperty("_last_chunk") && o._last_chunk, b = v && (o._timed || f), D = v && (o._timed || m), k = !0, S = "dhx_cal_event_clear";
        o._timed && !v || (k = !1, S = "dhx_cal_event_line"), f && (S += " dhx_cal_event_line_start"), m && (S += " dhx_cal_event_line_end"), b && (u += "<div class='dhx_event_resize dhx_event_resize_start'></div>"), D && (u += "<div class='dhx_event_resize dhx_event_resize_end'></div>");
        var p = r.templates.event_class(o.start_date, o.end_date, o);
        p && (S += " " + p);
        var w = o.color ? "--dhx-scheduler-event-background:" + o.color + ";" : "", E = o.textColor ? "--dhx-scheduler-event-color:" + o.textColor + ";" : "", M = ["position:absolute", "top:" + y + "px", "left:" + x + "px", "width:" + (g - x - (k ? 1 : 0)) + "px", "height:" + (this.xy.bar_height - 2) + "px", E, w, o._text_style || ""].join(";"), N = "<div event_id='" + o.id + "' " + this.config.event_attribute + "='" + o.id + "' class='" + S + "' style='" + M + "'" + this._waiAria.eventBarAttrString(o) + ">";
      ...
      for (var y in this._events) {
        ...
        x && (!o && !c || x.start_date < c && x.end_date > o) && h.push(x);
      }
      return h;
      ...
      if (c = c || r._mode, h && (!this.checkEvent("onBeforeEventDisplay") || this.callEvent("onBeforeEventDisplay", [h, c]))) {
        ...
        var x = r.config.preserve_scroll;
        r.config.preserve_scroll = !1;
        var g = h.color, u = h.textColor;
        if (r.config.highlight_displayed_event && (h.color = r.config.displayed_event_color, h.textColor = r.config.displayed_event_text_color), r.setCurrentView(new Date(h.start_date), c), r.config.scroll_hour = y, r.config.preserve_scroll = x, r.matrix && r.matrix[c]) {
          ...
          if (f) {
            ...
            var b = v.getSectionTop(m), D = v.posFromDate(f.start_date), k = r.$container.querySelector(".dhx_timeline_data_wrapper");
            if (D -= (k.offsetWidth - v.dx) / 2, b = b - k.offsetHeight / 2 + v.dy / 2, v._smartRenderingEnabled())
              var S = v.attachEvent("onScroll", function() {
                p(), v.detachEvent(S);
              });
            v.scrollTo({ left: D, top: b }), v._smartRenderingEnabled() || p();
          }
        } else
          p();
    ...
    (function() {
      var o = r.setCurrentView, c = r.updateView, h = null, y = null, x = function(v, l) {
        var f = this;
        I.clearTimeout(y), I.clearTimeout(h);
        var m = f._date, b = f._mode;
        u(this, v, l), y = setTimeout(function() {
          r.$destroyed || (f.callEvent("onBeforeViewChange", [b, m, l || f._mode, v || f._date]) ? (c.call(f, v, l), f.callEvent("onViewChange", [f._mode, f._date]), I.clearTimeout(h), y = 0) : u(f, m, b));
      ...
      r.attachEvent("onSchedulerReady", function() {
        r.config.delay_render ? (r.setCurrentView = x, r.updateView = g) : (r.setCurrentView = o, r.updateView = c);
      });
    })();
  }(i), function(r) {
  ...
  }, getLocale: _.getLocale }, i.i18n.setLocale("en"), i.ext = {}, xa(i);
  const d = {};
  return i.plugins = function(r) {
    return function(c, h, y) {
      ...
      return x.sort(function(g, u) {
        const v = y[g] || 0, l = y[u] || 0;
  ...
  e.attachEvent("onSchedulerReady", function() {
    (function(i) {
      i.event(document.body, "mousemove", function(t) {
        ...
        var a = Qe, s = a.from_scheduler, n = a.to_scheduler;
        if (s)
          if (n && s == n)
  ...
  e.$keyboardNavigation.attachSchedulerHandlers = function() {
    ...
    function _(r) {
      ...
      if (e.getState().mode === "month")
        ...
        const x = e.$container.querySelectorAll(".dhx_scale_holder");
        c = Array.from(x).some((g) => g === r.target.parentNode);
      }
      ...
      if (e.config.key_nav && t.isEnabled() && e.getState().select_id == r) {
        ...
        e.getState().lightbox_id || function(h) {
          if (e.config.key_nav && t.isEnabled()) {
            var y = h, x = new e.$keyboardNavigation.Event(y.eventId);
            if (!x.isValid()) {
              var g = x.start || y.start, u = x.end || y.end, v = x.section || y.section;
              (x = new e.$keyboardNavigation.TimeSlot(g, u, v)).isValid() || (x = new e.$keyboardNavigation.TimeSlot());
            }
            t.setActiveNode(x);
...
}, qe = function(e, i, t, a, s, n) {
  return a === void 0 && (a = 0), s === void 0 && (s = 0), n === void 0 && (n = 0), new Date(Date.UTC(e, i - 1, t, a, s, n));
}, en = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], ra = 864e5, ia = qe(1970, 1, 1), tn = [6, 0, 1, 2, 3, 4, 5], Je = function(e) {
  return e % 4 == 0 && e % 100 != 0 || e % 400 == 0;
}, oa = function(e) {
  return e instanceof Date;
}, Xe = function(e) {
  return oa(e) && !isNaN(e.getTime());
}, pt = function(e) {
  return i = ia, t = e.getTime() - i.getTime(), Math.round(t / ra);
  var i, t;
}, sa = function(e) {
  return new Date(ia.getTime() + e * ra);
}, an = function(e) {
  var i = e.getUTCMonth();
  return i === 1 && Je(e.getUTCFullYear()) ? 29 : en[i];
}, Ye = function(e) {
  return tn[e.getUTCDay()];
}, Ht = function(e, i) {
  var t = qe(e, i + 1, 1);
  return [Ye(t), an(t)];
}, _a = function(e, i) {
...
var X, Pt = function(e) {
  ...
  function e(i, t, a, s) {
    if (t === void 0 && (t = nn), a === void 0 && (a = et), s === void 0 && (s = rn), this.text = [], this.language = a || et, this.gettext = t, this.dateFormatter = s, this.rrule = i, this.options = i.options, this.origOptions = i.origOptions, this.origOptions.bymonthday) {
    ...
    switch (a.symbol) {
      ...
      case "sunday":
        ...
        n(), function() {
          ...
          var g = r();
          if (g)
            for (t.bymonthday = [g], a.nextSymbol(); a.accept("comma"); ) {
              if (!(g = r()))
                throw new Error("Unexpected symbol " + a.symbol + "; expected monthday");
              t.bymonthday.push(g), a.nextSymbol();
            }
        }(), o();
        break;
      case "january":
  ...
  function s() {
    ...
    if (c || h)
      do {
        var y = r(), x = d(), g = _();
        if (y)
          x ? (a.nextSymbol(), t.byweekday || (t.byweekday = []), t.byweekday.push(P[x].nth(y))) : (t.bymonthday || (t.bymonthday = []), t.bymonthday.push(y), a.accept("day(s)"));
        else if (x)
          a.nextSymbol(), t.byweekday || (t.byweekday = []), t.byweekday.push(P[x]);
          ...
          if (!g)
            return;
          a.nextSymbol(), t.bymonth || (t.bymonth = []), t.bymonth.push(g);
        }
...
var sn = function(e, i) {
  return i === void 0 && (i = et), new P(da(e, i) || void 0);
}, je = ["count", "until", "interval", "byweekday", "bymonthday", "bymonth"];
Me.IMPLEMENTED = [], Me.IMPLEMENTED[X.HOURLY] = je, Me.IMPLEMENTED[X.MINUTELY] = je, Me.IMPLEMENTED[X.DAILY] = ["byhour"].concat(je), Me.IMPLEMENTED[X.WEEKLY] = je, Me.IMPLEMENTED[X.MONTHLY] = je, Me.IMPLEMENTED[X.YEARLY] = ["byweekno", "byyearday"].concat(je);
var _n = Me.isFullyConvertible, tt = function() {
  function e(i, t, a, s) {
  ...
  return kt(i, e), i.fromDate = function(t) {
    ...
    for (a && (this.hour += Math.floor((23 - this.hour) / t) * t); ; ) {
      this.hour += t;
      var n = _t(this.hour, 24), _ = n.div, d = n.mod;
    ...
    for (a && (this.minute += Math.floor((1439 - (60 * this.hour + this.minute)) / t) * t); ; ) {
      this.minute += t;
      var _ = _t(this.minute, 60), d = _.div, r = _.mod;
      if (d && (this.minute = r, this.addHours(d, !1, s)), (ke(s) || K(s, this.hour)) && (ke(n) || K(n, this.minute)))
        break;
    }
    ...
    for (a && (this.second += Math.floor((86399 - (3600 * this.hour + 60 * this.minute + this.second)) / t) * t); ; ) {
      this.second += t;
      var d = _t(this.second, 60), r = d.div, o = d.mod;
      if (r && (this.second = o, this.addMinutes(r, !1, s, n)), (ke(s) || K(s, this.hour)) && (ke(n) || K(n, this.minute)) && (ke(_) || K(_, this.second)))
        break;
    }
...
function la(e) {
  for (var i = [], t = 0, a = Object.keys(e); t < a.length; t++) {
    var s = a[t];
    K(On, s) || i.push(s), oa(e[s]) && !Xe(e[s]) && i.push(s);
  }
  if (i.length)
...
function ln(e) {
  ...
  if (i.dtstart || (i.dtstart = new Date((/* @__PURE__ */ new Date()).setMilliseconds(0))), Q(i.wkst) ? we(i.wkst) || (i.wkst = i.wkst.weekday) : i.wkst = P.MO.weekday, Q(i.bysetpos)) {
  ...
  if (Q(i.byweekno) && !ce(i.byweekno) && (i.byweekno = [i.byweekno]), Q(i.byweekday))
    if (we(i.byweekday))
      ...
      for (t = 0; t < i.byweekday.length; t++) {
        var r = i.byweekday[t];
        we(r) ? _.push(r) : $t(r) ? _.push(se.fromStr(r).weekday) : !r.n || i.freq > P.MONTHLY ? _.push(r.weekday) : d.push([r.weekday, r.n]);
      }
      i.byweekday = te(_) ? _ : null, i.bynweekday = te(d) ? d : null;
    }
  else
    i.bynweekday = null;
  return Q(i.byhour) ? we(i.byhour) && (i.byhour = [i.byhour]) : i.byhour = i.freq < P.HOURLY ? [i.dtstart.getUTCHours()] : null, Q(i.byminute) ? we(i.byminute) && (i.byminute = [i.byminute]) : i.byminute = i.freq < P.MINUTELY ? [i.dtstart.getUTCMinutes()] : null, Q(i.bysecond) ? we(i.bysecond) && (i.bysecond = [i.bysecond]) : i.bysecond = i.freq < P.SECONDLY ? [i.dtstart.getUTCSeconds()] : null, { parsedOptions: i };
}
function vt(e) {
  var i = e.split(`
`).map(cn).filter(function(t) {
    return t !== null;
  });
      ...
      case "BYDAY":
        i.byweekday = function(o) {
          ...
          return c.map(function(h) {
            ...
            var x = Number(y[1]), g = y[2], u = me[g].weekday;
            return new se(u, x);
          });
        }(n);
        break;
...
function yt(e) {
  for (var i = [], t = "", a = Object.keys(e), s = Object.keys(Et), n = 0; n < a.length; n++)
    if (a[n] !== "tzid" && K(s, a[n])) {
      var _ = a[n].toUpperCase(), d = e[a[n]], r = "";
      if (Q(d) && (!ce(d) || d.length)) {
        switch (_) {
          case "FREQ":
            r = P.FREQUENCIES[e.freq];
            break;
          case "WKST":
            r = we(d) ? new se(d).toString() : d.toString();
            break;
          case "BYWEEKDAY":
            _ = "BYDAY", r = Qa(d).map(function(x) {
              return x instanceof se ? x : ce(x) ? new se(x[0], x[1]) : new se(x);
            }).toString();
            break;
          case "DTSTART":
            t = hn(d, e.tzid);
  ...
  var h = i.map(function(x) {
    var g = x[0], u = x[1];
    return "".concat(g, "=").concat(u.toString());
  }).join(";"), y = "";
  return h !== "" && (y = "RRULE:".concat(h)), [t, y].filter(function(x) {
    return !!x;
  }).join(`
`);
}
...
}(), pn = j(j(j(j(j(j(j(j(j(j(j(j(j([], J(1, 31), !0), J(2, 28), !0), J(3, 31), !0), J(4, 30), !0), J(5, 31), !0), J(6, 30), !0), J(7, 31), !0), J(8, 31), !0), J(9, 30), !0), J(10, 31), !0), J(11, 30), !0), J(12, 31), !0), J(1, 7), !0), gn = j(j(j(j(j(j(j(j(j(j(j(j(j([], J(1, 31), !0), J(2, 29), !0), J(3, 31), !0), J(4, 30), !0), J(5, 31), !0), J(6, 30), !0), J(7, 31), !0), J(8, 31), !0), J(9, 30), !0), J(10, 31), !0), J(11, 30), !0), J(12, 31), !0), J(1, 7), !0), mn = Ee(1, 29), vn = Ee(1, 30), Oe = Ee(1, 31), ie = Ee(1, 32), yn = j(j(j(j(j(j(j(j(j(j(j(j(j([], ie, !0), vn, !0), ie, !0), Oe, !0), ie, !0), Oe, !0), ie, !0), ie, !0), Oe, !0), ie, !0), Oe, !0), ie, !0), ie.slice(0, 7), !0), bn = j(j(j(j(j(j(j(j(j(j(j(j(j([], ie, !0), mn, !0), ie, !0), Oe, !0), ie, !0), Oe, !0), ie, !0), ie, !0), Oe, !0), ie, !0), Oe, !0), ie, !0), ie.slice(0, 7), !0), xn = Ee(-28, 0), wn = Ee(-29, 0), Le = Ee(-30, 0), oe = Ee(-31, 0), kn = j(j(j(j(j(j(j(j(j(j(j(j(j([], oe, !0), wn, !0), oe, !0), Le, !0), oe, !0), Le, !0), oe, !0), oe, !0), Le, !0), oe, !0), Le, !0), oe, !0), oe.slice(0, 7), !0), En = j(j(j(j(j(j(j(j(j(j(j(j(j([], oe, !0), xn, !0), oe, !0), Le, !0), oe, !0), Le, !0), oe, !0), oe, !0), Le, !0), oe, !0), Le, !0), oe, !0), oe.slice(0, 7), !0), Dn = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335, 366], Sn = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334, 365], Vt = function() {
  for (var e = [], i = 0; i < 55; i++)
    e = e.concat(Ee(7));
  return e;
}();
function Mn(e, i) {
  var t, a, s = qe(e, 1, 1), n = Je(e) ? 366 : 365, _ = Je(e + 1) ? 366 : 365, d = pt(s), r = Ye(s), o = he(he({ yearlen: n, nextyearlen: _, yearordinal: d, yearweekday: r }, function(S) {
    var p = Je(S) ? 366 : 365, w = qe(S, 1, 1), E = Ye(w);
    return p === 365 ? { mmask: pn, mdaymask: bn, nmdaymask: En, wdaymask: Vt.slice(E), mrange: Sn } : { mmask: gn, mdaymask: yn, nmdaymask: kn, wdaymask: Vt.slice(E), mrange: Dn };
  }(e)), { wnomask: null });
  if (ke(i.byweekno))
    return o;
  o.wnomask = J(0, n + 7);
  var c = t = fe(7 - r + i.wkst, 7);
  c >= 4 ? (c = 0, a = o.yearlen + fe(r - i.wkst, 7)) : a = n - c;
  for (var h = Math.floor(a / 7), y = fe(a, 7), x = Math.floor(h + y / 4), g = 0; g < i.byweekno.length; g++) {
    var u = i.byweekno[g];
    if (u < 0 && (u += x + 1), u > 0 && u <= x) {
      var v = void 0;
  ...
  if (K(i.byweekno, 1) && (v = c + 7 * x, c !== t && (v -= 7 - t), v < n))
    for (g = 0; g < 7 && (o.wnomask[v] = 1, v += 1, o.wdaymask[v] !== i.wkst); g++)
      ;
  if (c) {
    var f = void 0;
    if (K(i.byweekno, -1))
      ...
      var m = Ye(qe(e - 1, 1, 1)), b = fe(7 - m.valueOf() + i.wkst, 7), D = Je(e - 1) ? 366 : 365, k = void 0;
      b >= 4 ? (b = 0, k = D + fe(m - i.wkst, 7)) : k = n - c, f = Math.floor(52 + fe(k, 7) / 4);
    }
    if (K(i.byweekno, f))
      for (v = 0; v < c; v++)
        o.wnomask[v] = 1;
...
var Nn = function() {
  ...
  return e.prototype.rebuild = function(i, t) {
    var a = this.options;
    if (i !== this.lastyear && (this.yearinfo = Mn(i, a)), te(a.bynweekday) && (t !== this.lastmonth || i !== this.lastyear)) {
      var s = this.yearinfo, n = s.yearlen, _ = s.mrange, d = s.wdaymask;
      this.monthinfo = function(r, o, c, h, y, x) {
        var g = { lastyear: r, lastmonth: o, nwdaymask: [] }, u = [];
        if (x.freq === P.YEARLY)
          if (ke(x.bymonth))
            u = [[0, c]];
          else
            for (var v = 0; v < x.bymonth.length; v++)
              o = x.bymonth[v], u.push(h.slice(o - 1, o + 1));
        else
          x.freq === P.MONTHLY && (u = [h.slice(o - 1, o + 1)]);
        if (ke(u))
          return g;
        for (g.nwdaymask = J(0, c), v = 0; v < u.length; v++)
          for (var l = u[v], f = l[0], m = l[1] - 1, b = 0; b < x.bynweekday.length; b++) {
            var D = void 0, k = x.bynweekday[b], S = k[0], p = k[1];
            p < 0 ? (D = m + 7 * (p + 1), D -= fe(y[D] - S, 7)) : (D = f + 7 * (p - 1), D += fe(7 - y[D] + S, 7)), f <= D && D <= m && (g.nwdaymask[D] = 1);
          }
        return g;
      }(i, t, n, _, d, a);
    }
    Q(a.byeaster) && (this.eastermask = function(r, o) {
      o === void 0 && (o = 0);
      var c = r % 19, h = Math.floor(r / 100), y = r % 100, x = Math.floor(h / 4), g = h % 4, u = Math.floor((h + 8) / 25), v = Math.floor((h - u + 1) / 3), l = Math.floor(19 * c + h - x - v + 15) % 30, f = Math.floor(y / 4), m = y % 4, b = Math.floor(32 + 2 * g + 2 * f - l - m) % 7, D = Math.floor((c + 11 * l + 22 * b) / 451), k = Math.floor((l + b - 7 * D + 114) / 31), S = (l + b - 7 * D + 114) % 31 + 1, p = Date.UTC(r, k - 1, S + o), w = Date.UTC(r, 0, 1);
    ...
    for (var s = J(null, this.yearlen + 7), n = pt(qe(i, t, a)) - this.yearordinal, _ = n, d = 0; d < 7 && (s[n] = n, ++n, this.wdaymask[n] !== this.options.wkst); d++)
      ;
    return [s, _, n];
  }, e.prototype.ddayset = function(i, t, a) {
    var s = J(null, this.yearlen), n = pt(qe(i, t, a)) - this.yearordinal;
...
function Tn(e, i, t, a, s, n) {
  for (var _ = [], d = 0; d < e.length; d++) {
    var r = void 0, o = void 0, c = e[d];
    c < 0 ? (r = Math.floor(c / i.length), o = fe(c, i.length)) : (r = Math.floor((c - 1) / i.length), o = fe(c - 1, i.length));
    for (var h = [], y = t; y < a; y++) {
      var x = n[y];
      Q(x) && h.push(x);
    }
    ...
    var u = i[o], v = sa(s.yearordinal + g), l = _a(v, u);
    K(_, l) || _.push(l);
  }
  return Ke(_), _;
}
function ca(e, i) {
  ...
  if (d === 0 || s === 0)
    return Se(e);
  var r = dn.fromDate(t), o = new Nn(i);
  ...
  for (var c = function(p, w, E) {
    ...
    }(E) : M >= P.HOURLY && te(N) && !K(N, w.hour) || M >= P.MINUTELY && te(T) && !K(T, w.minute) || M >= P.SECONDLY && te(A) && !K(A, w.second) ? [] : p.gettimeset(M)(w.hour, w.minute, w.second, w.millisecond);
  }(o, r, i); ; ) {
    var h = o.getdayset(a)(r.year, r.month, r.day), y = h[0], x = h[1], g = h[2], u = Cn(y, x, g, o, i);
    if (te(_))
      for (var v = Tn(_, c, x, g, o, y), l = 0; l < v.length; l++) {
        var f = v[l];
        if (n && f > n)
          return Se(e);
        if (f >= t) {
      ...
      for (l = x; l < g; l++) {
        var b = y[l];
        if (Q(b))
          for (var D = sa(o.yearordinal + b), k = 0; k < c.length; k++) {
            var S = c[k];
            if (f = _a(D, S), n && f > n || f >= t && (m = Yt(f, i), !e.accept(m) || d && !--d))
              return Se(e);
          }
      }
    if (i.interval === 0 || (r.add(i, u), r.year > 9999))
      return Se(e);
    dt(a) || (c = o.gettimeset(a)(r.hour, r.minute, r.second, 0)), o.rebuild(r.year, r.month);
  }
}
function An(e, i, t) {
  var a = t.bymonth, s = t.byweekno, n = t.byweekday, _ = t.byeaster, d = t.bymonthday, r = t.bynmonthday, o = t.byyearday;
  return te(a) && !K(a, e.mmask[i]) || te(s) && !e.wnomask[i] || te(n) && !K(n, e.wdaymask[i]) || te(e.nwdaymask) && !e.nwdaymask[i] || _ !== null && !K(e.eastermask, i) || (te(d) || te(r)) && !K(d, e.mdaymask[i]) && !K(r, e.nmdaymask[i]) || te(o) && (i < e.yearlen && !K(o, i + 1) && !K(o, -e.yearlen + i) || i >= e.yearlen && !K(o, i + 1 - e.yearlen) && !K(o, -e.nextyearlen + i - e.yearlen));
}
function Yt(e, i) {
...
var me = { MO: new se(0), TU: new se(1), WE: new se(2), TH: new se(3), FR: new se(4), SA: new se(5), SU: new se(6) }, Et = { freq: X.YEARLY, dtstart: null, interval: 1, wkst: me.MO, count: null, until: null, tzid: null, bysetpos: null, bymonth: null, bymonthday: null, bynmonthday: null, byyearday: null, byweekno: null, byweekday: null, bynweekday: null, byhour: null, byminute: null, bysecond: null, byeaster: null }, On = Object.keys(Et), P = function() {
  function e(i, t) {
    i === void 0 && (i = {}), t === void 0 && (t = !1), this._cache = t ? null : new fn(), this.origOptions = la(i);
  ...
  return e.parseText = function(i, t) {
    ...
    return function(s, n, _, d) {
      return new Me(s, n, _, d).toString();
    }(this, i, t, a);
...
function Ln(e, i) {
  var t = [], a = [], s = [], n = [], _ = at(e), d = _.dtstart, r = _.tzid, o = function(c, h) {
    ...
    for (var y = c.split(`
`), x = 0; x < y.length; ) {
      var g = y[x] = y[x].replace(/\s+$/g, "");
      g ? x > 0 && g[0] === " " ? (y[x - 1] += g.slice(1), y.splice(x, 1)) : x += 1 : y.splice(x, 1);
    }
    return y;
  }(e, i.unfold);
  return o.forEach(function(c) {
    ...
    if (c) {
      var y = function(l) {
        ...
        }(l), m = f.name, b = f.value, D = m.split(";");
        if (!D)
          throw new Error("empty property name");
        return { name: D[0].toUpperCase(), parms: D.slice(1), value: b };
      }(c), x = y.name, g = y.parms, u = y.value;
      switch (x.toUpperCase()) {
        ...
        case "DTSTART":
          break;
        default:
          throw new Error("unsupported property: " + x);
      }
    }
...
function Ve(e, i) {
  return i === void 0 && (i = {}), function(t, a) {
    var s = Ln(t, a), n = s.rrulevals, _ = s.rdatevals, d = s.exrulevals, r = s.exdatevals, o = s.dtstart, c = s.tzid, h = a.cache === !1;
    if (a.compatible && (a.forceset = !0, a.unfold = !0), a.forceset || n.length > 1 || _.length || d.length || r.length) {
      var y = new $n(h);
      return y.dtstart(o), y.tzid(c || void 0), n.forEach(function(g) {
        y.rrule(new P(lt(g, o, c), h));
      }), _.forEach(function(g) {
        y.rdate(g);
      }), d.forEach(function(g) {
        y.exrule(new P(lt(g, o, c), h));
      }), r.forEach(function(g) {
        y.exdate(g);
      }), a.compatible && a.dtstart && y.rdate(o), y;
    }
    var x = n[0] || {};
    return new P(lt(x, x.dtstart || a.dtstart || o, x.tzid || a.tzid || c), h);
  }(e, function(t) {
  ...
  return kt(i, e), i.prototype._iter = function(t) {
    return function(a, s, n, _, d, r) {
      ...
      for (var y = 0; y < _.length; y++) {
        var x = new nt(_[y], r).rezonedDate();
        if (!a.accept(new Date(x.getTime())))
          break;
      }
  ...
  function a(_) {
    ...
    i = setInterval(function() {
      (function(o) {
        ...
        if (!c)
          return;
        const h = e._schedulerOuter, y = function(b, D) {
          const k = e.matrix[e._mode], S = {}, p = {};
          let w = D;
          for (S.x = b.touches ? b.touches[0].pageX : b.pageX, S.y = b.touches ? b.touches[0].pageY : b.pageY, p.left = w.offsetLeft + k.dx, p.top = w.offsetTop; w; )
            p.left += w.offsetLeft, p.top += w.offsetTop, w = w.offsetParent;
          return { x: S.x - p.left, y: S.y - p.top };
        }(o, h), x = h.offsetWidth - c.dx, g = h.offsetHeight, u = y.x, v = y.y;
        let l = c.autoscroll || {};
        l === !0 && (l = {}), e._merge(l, { range_x: 200, range_y: 100, speed_x: 20, speed_y: 10 });
        let f = s(u, x, t ? t.x : 0, l.range_x);
        c.scrollable || (f = 0);
        let m = s(v, g, t ? t.y : 0, l.range_y);
        !m && !f || t || (t = { x: u, y: v }, f = 0, m = 0), f *= l.speed_x, m *= l.speed_y, f && m && (Math.abs(f / 5) > Math.abs(m) ? m = 0 : Math.abs(m / 5) > Math.abs(f) && (f = 0)), f || m ? (t.started = !0, function(b, D) {
          const k = e._schedulerOuter;
          D && (k.scrollTop += D), b && (k.scrollLeft += b);
        }(f, m)) : clearInterval(i);
      })(r);
    }, 10);
  }
...
class Pn {
  constructor(i) {
    this._listeners = {}, this.tooltip = new qn(i), this._scheduler = i, this._domEvents = i._createDomEventScope(), this._initDelayedFunctions();
  }
  destructor() {
...
const Rn = { active_links: function(e) {
    ...
    function d() {
      ...
      if (o.forEach((v) => {
        ...
        for (; l.valueOf() < v.end_date.valueOf(); )
          c[l.valueOf()] && (c[l.valueOf()].push(v), x = !0), l = e.date.day_start(e.date.add(l, 1, "day"));
      }), x) {
        let v = "";
        for (let l in c)
...
`;
      return c.forEach((y) => {
        h += function(x, g) {
          const u = e.templates.agenda_time(g.start_date, g.end_date, g), v = e.getState().select_id, l = e.templates.event_class(g.start_date, g.end_date, g), f = e.templates.agenda_text(g.start_date, g.end_date, g);
          let m = "";
          return (g.color || g.textColor) && (m = ` style="${g.color ? "--dhx-scheduler-event-background:" + g.color + ";" : ""}${g.textColor ? "--dhx-scheduler-event-color:" + g.textColor + ";" : ""}" `), `<div class="dhx_cal_agenda_event_line ${l || ""} ${g.id == v ? "dhx_cal_agenda_event_line_selected" : ""}" ${m} ${e.config.event_attribute}="${g.id}">
  ...
  e._pre_render_events_line = e._pre_render_events_table = function(d, r) {
    ...
    for (var o = 0; o < d.length; o++) {
      ...
      if (!c._timed)
        if (this.config.all_timed != "short" || i(c)) {
          ...
          var x = this._safe_copy(c);
          if (x._virtual = !0, x.end_date = new Date(x.end_date), x.start_date < this._min_date ? x.start_date = l(this._min_date, this.config.first_hour) : x.start_date = l(v(c.start_date), this.config.first_hour), x.start_date < this._max_date && x.start_date < x.end_date) {
            if (!y) {
              d[o--] = x;
              continue;
            }
            d.splice(o + 1, 0, x), x._last_chunk = !1;
          } else
    ...
    function l(f, m) {
      var b = e.date.date_part(new Date(f));
      return b.setHours(m), b;
    }
  };
  var n = e.get_visible_events;
    ...
    if (s.rec_type) {
      ...
      for (let h = 0; h < c.length; h++) {
        ...
        for (let x = 0; x < y.length; x++)
          (y[x].event_pid || y[x].id) != s.id && n.push(y[x]);
      }
    } else if (s.rrule) {
      let c = e.getRecDates(s);
      for (let h = 0; h < c.length; h++) {
        let y = e.getEvents(c[h].start_date, c[h].end_date);
        for (let x = 0; x < y.length; x++)
          (String(y[x].id).split("#")[0] || y[x].id) != s.id && n.push(y[x]);
      }
    } else {
  ...
  e._pre_render_events = function(h, y) {
    if (!e.config.container_autoresize || !t)
      return i.apply(this, arguments);
    var x = this.xy.bar_height, g = this._colsS.heights, u = this._colsS.heights = [0, 0, 0, 0, 0, 0, 0], v = this._els.dhx_cal_data[0];
      ...
      if (y)
        ...
        if (p && p.length) {
          for (var f = 0; f < p.length; f++) {
            if (u[f]++, u[f] * x > this._colsS.height - this.xy.month_head_height) {
              var m = p[f].querySelectorAll(".dhx_cal_month_cell"), b = this._colsS.height - this.xy.month_head_height;
              1 * this.config.max_month_events !== this.config.max_month_events || u[f] <= this.config.max_month_events ? b = u[f] * x : (this.config.max_month_events + 1) * x > this._colsS.height - this.xy.month_head_height && (b = (this.config.max_month_events + 1) * x), p[f].style.height = b + this.xy.month_head_height + "px";
              for (var D = 0; D < m.length; D++)
                m[D].childNodes[1].style.height = b + "px";
              u[f] = (u[f - 1] || 0) + m[0].offsetHeight;
            }
          ...
          S.style.height = k, S.style.visibility = u[0] == -1 ? "hidden" : "visible", S.style.display = u[0] == -1 ? "none" : "", (S = this._els.dhx_multi_day[1]).style.height = k, S.style.visibility = u[0] == -1 ? "hidden" : "visible", S.style.display = u[0] == -1 ? "none" : "", S.className = u[0] ? "dhx_multi_day_icon" : "dhx_multi_day_icon_small", this._dy_shift = (u[0] + 1) * x, u[0] = 0;
        }
      }
    return h;
  };
  var n = ["dhx_cal_navline", "dhx_cal_header", "dhx_multi_day", "dhx_cal_data"], _ = function(h) {
    a = 0;
    for (var y = 0; y < n.length; y++) {
      var x = n[y], g = e._els[x] ? e._els[x][0] : null, u = 0;
      switch (x) {
        ...
        case "dhx_cal_header":
          ...
          break;
        case "dhx_multi_day":
          u = g ? g.offsetHeight - 1 : 0, s = u;
          break;
        case "dhx_cal_data":
          var v = e.getState().mode;
          if (g.childNodes[1] && v != "month") {
            let k = 0;
            for (let S = 0; S < g.childNodes.length; S++)
              g.childNodes[S].offsetHeight > k && (k = g.childNodes[S].offsetHeight);
            u = k;
          } else
            u = Math.max(g.offsetHeight - 1, g.scrollHeight);
          if (v == "month")
            e.config.month_day_min_height && !h && (u = g.querySelectorAll(".dhx_cal_month_row").length * e.config.month_day_min_height), h && (g.style.height = u + "px");
          else if (v == "year")
            u = 190 * e.config.year_y;
          else if (v == "agenda") {
            if (u = 0, g.children && g.children.length)
              if (g.children.length === 1 && g.children[0].classList.contains("dhx_cal_agenda_no_events"))
                u = 300;
              else
                for (var l = 0; l < g.children.length; l++)
                  u += g.children[l].offsetHeight;
            u + 2 < e.config.min_grid_size ? u = e.config.min_grid_size : u += 2;
          } else if (v == "week_agenda") {
            let k = c(), S = g.querySelector(".dhx_wa_ev_body") || 0, p = window.getComputedStyle(g.querySelector(".dhx_wa_scale_bar")).getPropertyValue("--dhx-scheduler-week-agenda-scale-height") || 35;
            u = k * (1.1 * S.offsetHeight) + 4 * (parseInt(p) + 10);
          } else if (v == "map") {
            u = 0;
            var f = g.querySelectorAll(".dhx_map_line");
            for (l = 0; l < f.length; l++)
              u += f[l].offsetHeight;
            u + 2 < e.config.min_map_size ? u = e.config.min_map_size : u += 2;
          } else if (e._gridView)
            if (u = 0, g.childNodes[1].childNodes[0].childNodes && g.childNodes[1].childNodes[0].childNodes.length) {
              for (f = g.childNodes[1].childNodes[0].childNodes[0].childNodes, l = 0; l < f.length; l++)
                u += f[l].offsetHeight;
          ...
          if (e.matrix && e.matrix[v]) {
            if (h)
              u += 0, g.style.height = u + "px";
            else {
              u = 0;
              for (var m = e.matrix[v], b = m.y_unit, D = 0; D < b.length; D++)
                u += m.getSectionHeight(b[D].key);
  ...
  var r = function() {
    ...
    if (!h)
      return !0;
    var y = window.requestAnimationFrame || window.setTimeout, x = document.documentElement.scrollTop;
    y(function() {
      !e.$destroyed && e.$initialized && _();
    }), e.matrix && e.matrix[h] || h == "month" ? y(function() {
      !e.$destroyed && e.$initialized && (_(!0), document.documentElement.scrollTop = x, d());
    }, 1) : d();
  };
  function o() {
  ...
  function c() {
    ...
    return h.forEach((x) => {
      let g = 0;
      x.querySelectorAll(".dhx_wa_day_cont").forEach((u) => {
  ...
  e.attachEvent("onBeforeViewChange", function() {
    ...
    if (e.xy.$original_scroll_width || (e.xy.$original_scroll_width = e.xy.scroll_width), e.xy.scroll_width = h ? 0 : e.xy.$original_scroll_width, e.matrix)
      for (var y in e.matrix) {
        var x = e.matrix[y];
        x.$original_section_autoheight || (x.$original_section_autoheight = x.section_autoheight), x.section_autoheight = !h && x.$original_section_autoheight;
      }
    return !0;
    ...
    if (t) {
      ...
      var c = function(y) {
        ...
        if (document.cookie.length > 0) {
          var g = document.cookie.indexOf(x);
          if (g != -1) {
            g += x.length;
            var u = document.cookie.indexOf(";", g);
            return u == -1 && (u = document.cookie.length), document.cookie.substring(g, u);
          }
        }
        return "";
      }(o);
  ...
  e.createTimelineView = function(t) {
    if (t.render == "days") {
      ...
      }, e.templates[a + "_scale_label"] = function(b, D, k) {
        return e.templates.day_date(D);
      }, e.date[a + "_start"] = function(b) {
        return b = e.date.week_start(b), b = e.date.add(b, t.x_step * t.x_start, t.x_unit);
      }, e.date["add_" + a] = function(b, D) {
        return e.date.add(b, D * t.days, "day");
      };
      var n = e._renderMatrix;
      e._renderMatrix = function(b, D) {
        b && function() {
      ...
      e.checkCollision = function(b) {
        return b[s] && delete (b = function(D) {
          var k = {};
          for (var S in D)
            k[S] = D[S];
          return k;
        }(b))[s], _.apply(e, [b]);
      }, e.attachEvent("onBeforeDrag", function(b, D, k) {
      ...
      var d = e["mouse_" + a];
      e["mouse_" + a] = function(b) {
        var D;
        this._drag_event && (D = this._drag_event._move_delta);
        var k = e.matrix[this._mode];
        if (k.scrollable && !b.converted && (b.converted = 1, b.x -= -k._x_scroll, b.y += k._y_scroll), D === void 0 && e._drag_mode == "move") {
          var S = { y: b.y };
          e._resolve_timeline_section(k, S);
          var p = b.x - k.dx, w = new Date(S.section);
          f(e._timeline_drag_date(k, p), w);
          var E = e._drag_event, M = this.getEvent(this._drag_id);
          M && (E._move_delta = (M.start_date - w) / 6e4, this.config.preserve_length && b._ignores && (E._move_delta = this._get_real_event_length(M.start_date, w, k), E._event_length = this._get_real_event_length(M.start_date, M.end_date, k)));
        }
        if (b = d.apply(e, arguments), e._drag_mode && e._drag_mode != "move") {
          var N = null;
          N = e._drag_event && e._drag_event["timeline-week" + a] ? new Date(e._drag_event["timeline-week" + a]) : new Date(b.section), b.y += Math.round((N - e.date.date_part(new Date(e._min_date))) / (6e4 * this.config.time_step)), e._drag_mode == "resize" && (b.resize_from_start = e._w_line_drag_from_start);
        ...
        return b;
      }, e.attachEvent("onEventCreated", function(b, D) {
        return e._events[b] && delete e._events[b][s], !0;
      }), e.attachEvent("onBeforeEventChanged", function(b, D, k, S) {
        return e._events[b.id] && delete e._events[b.id][s], !0;
      });
      var r = e._update_timeline_section;
      e._update_timeline_section = function(b) {
        var D, k;
        this._mode == a && (D = b.event) && (k = e._get_copied_event(D.id, e.date.day_start(new Date(D.start_date.valueOf())))) && (b.event._sorder = k._sorder, b.event._count = k._count), r.apply(this, arguments), D && k && (k._count = D._count, k._sorder = D._sorder);
      };
      var o = e.render_view_data;
      e.render_view_data = function(b, D) {
        return this._mode == a && b && (b = g(b), e._restore_render_flags(b)), o.apply(e, [b, D]);
      };
      ...
      e.get_visible_events = function() {
        if (this._mode == a) {
          ...
          var b = c.apply(e, arguments);
          return b = g(b), e._register_copies_array(b), b;
        }
      ...
      e.addEventNow = function(b) {
        if (e.getState().mode == a)
          if (b[s]) {
            var D = new Date(b[s]);
            x(D, b.start_date), x(D, b.end_date);
          } else {
    ...
    function x(b, D) {
      D.setDate(1), D.setFullYear(b.getFullYear()), D.setMonth(b.getMonth()), D.setDate(b.getDate());
    }
    function g(b) {
      for (var D = [], k = 0; k < b.length; k++) {
        ...
        if (e.isOneDayEvent(S))
          ...
          for (var p = new Date(Math.min(+S.end_date, +e._max_date)), w = new Date(Math.max(+S.start_date, +e._min_date)), E = []; +w < +p; ) {
            var M = v(S);
            M.start_date = w, M.end_date = new Date(Math.min(+m(M.start_date), +p)), w = m(w), l(M), D.push(M), E.push(M);
          }
          u(E, S);
        }
      }
    ...
    function u(b, D) {
      for (var k = !1, S = !1, p = 0, w = b.length; p < w; p++) {
        var E = b[p];
    ...
    function v(b) {
      var D = e.getEvent(b.event_pid);
      return D && D.isPrototypeOf(b) ? (delete (b = e._copy_event(b)).event_length, delete b.event_pid, delete b.rec_pattern, delete b.rec_type) : b = e._lame_clone(b), b;
    }
    function l(b) {
      if (!b._w_start_date || !b._w_end_date) {
        var D = e.date, k = b._w_start_date = new Date(b.start_date), S = b._w_end_date = new Date(b.end_date);
        b[s] = +D.date_part(b.start_date), b._count || (b._count = 1), b._sorder || (b._sorder = 0);
        var p = S - k;
        b.start_date = new Date(e._min_date), f(k, b.start_date), b.end_date = new Date(+b.start_date + p), k.getTimezoneOffset() != S.getTimezoneOffset() && (b.end_date = new Date(b.end_date.valueOf() + 6e4 * (k.getTimezoneOffset() - S.getTimezoneOffset())));
      }
    }
    function f(b, D) {
      D.setMinutes(b.getMinutes()), D.setHours(b.getHours());
    }
    function m(b) {
      var D = e.date.add(b, 1, "day");
      return D = e.date.date_part(D);
    }
  };
}, drag_between: function(e) {
  window.Scheduler && window.Scheduler.plugin && (window.Scheduler._outer_drag = Qe), aa.push(e), ht || na(e), e.config.drag_in = !0, e.config.drag_out = !0, e.templates.event_outside = function(t, a, s) {
  };
  var i = Qe;
  e.attachEvent("onTemplatesReady", function() {
  ...
  e.form_blocks.combo = { render: function(i) {
    ...
    if (n.enableFilteringMode(s.filtering, s.script_path || null, !!s.cache), s.script_path) {
      ...
      _ ? s.cached_options[_] ? (n.addOption(_, s.cached_options[_]), n.disable(1), n.selectOption(0), n.disable(0)) : e.ajax.get(s.script_path + "?id=" + _ + "&uid=" + e.uid(), function(y) {
        var x, g = y.xmlDoc.responseText;
        try {
          x = JSON.parse(g).options[0].text;
        } catch {
          x = e.ajax.xpath("//option", y.xmlDoc)[0].childNodes[0].nodeValue;
        }
        s.cached_options[_] = x, n.addOption(_, x), n.disable(1), n.selectOption(0), n.disable(0);
      }) : n.setComboValue("");
    } else {
  ...
  (function() {
    ...
    window.dhtmlxAjax || (window.dhtmlxAjax = { post: function(a, s, n) {
      ...
      a.exportToPDF = function(n) {
        ...
        r = parseInt(r) / 25.4 || 4;
        var y = { A5: { x: 148, y: 210 }, A4: { x: 210, y: 297 }, A3: { x: 297, y: 420 }, A2: { x: 420, y: 594 }, A1: { x: 594, y: 841 }, A0: { x: 841, y: 1189 } }, x = t("dhx_cal_data", this).x, g = { y: t("dhx_cal_data", this).y + t("dhx_cal_header", this).y + t("dhx_multi_day", this).y };
        return g.x = n === "full" ? x : Math.floor((_ === "landscape" ? y[n].y : y[n].x) * r), h && (g.x *= parseFloat(h.x) || 1, g.y *= parseFloat(h.y) || 1), g;
  ...
  e._grid = { names: {}, sort_rules: { int: function(i, t, a) {
    ...
    for (var d = "<tr " + e._waiAria.gridRowAttrString(i) + " class='dhx_grid_event" + (_ ? " " + _ : "") + "' event_id='" + i.id + "' " + e.config.event_attribute + "='" + i.id + "' " + s + ">", r = ["text-align", "vertical-align", "padding-left", "padding-right"], o = 0; o < n.length; o++) {
      var c = e._grid._getCellContent(i, n[o]), h = e._waiAria.gridCellAttrString(i, n[o], c), y = e._grid._getStyles(n[o], r), x = n[o].css ? ' class="' + n[o].css + '"' : "";
      d += "<td " + h + " style='width:" + n[o].width + "px;" + y.join(";") + "' " + x + ">" + c + "</td>";
    }
    ...
    for (var o = Math.floor(_ / n), c = ["text-align", "padding-left", "padding-right"], h = 0; h < a.length; h++) {
      var y = s[h] ? s[h] : o;
      a[h].width = y;
      var x = e._grid._getStyles(a[h], c);
      t += "<div class='dhx_grid_column_label' style='line-height: " + e.xy.scale_height + "px;width:" + a[h].width + "px;" + x.join(";") + "'>" + (a[h].label === void 0 ? a[h].id : a[h].label) + "</div>";
    }
    return t += "</div>";
  };
  ...
  e.config.key_nav = !0, e.config.key_nav_step = 30, e.addShortcut = function(t, a, s) {
    ...
    t.$keyboardNavigation.marker = { clear: function() {
      ...
      if (t.getView().days) {
        ...
        v(t._min_date, D);
        const k = new Date(s);
        v(t._min_date, k), g = t._timeline_getX({ start_date: D }, !1, _), u = t._timeline_getX({ start_date: k }, !1, _);
      } else
        g = t._timeline_getX({ start_date: a }, !1, _), u = t._timeline_getX({ start_date: s }, !1, _);
      var l = _._section_height[n] - 1 || _.dy - 1, f = 0;
      t._isRender("cell") && (f = y.offsetTop, g += _.dx, u += _.dx, y = t.$container.querySelector(".dhx_cal_data"));
      var m = Math.max(1, u - g - 1);
      let b = "left";
      return t.config.rtl && (b = "right"), x.style.cssText = `height:${l}px; ${b}:${g}px; width:${m}px; top:${f}px;`, y && (y.appendChild(x), r.push(x)), r;
      ...
      if (d == -1)
        return [];
      var y = t._colsS[o], x = t._colsS.heights[r], g = this.createElement();
      g.style.top = x + "px", g.style.left = y + "px", g.style.width = t._cols[o] + "px", g.style.height = (t._colsS.heights[r + 1] - x || t._colsS.height) + "px";
      var u = t.$container.querySelector(".dhx_cal_data"), v = u.querySelector(".dhx_cal_month_table");
      return v.nextSibling ? u.insertBefore(g, v.nextSibling) : u.appendChild(g), g;
      ...
      var y = Math.max(60 * a.getHours() + a.getMinutes(), 60 * o.first_hour), x = Math.min(60 * s.getHours() + s.getMinutes(), 60 * o.last_hour);
      if (!x && t.date.day_start(new Date(s)).valueOf() > t.date.day_start(new Date(a)).valueOf() && (x = 60 * o.last_hour), x <= y)
        return [];
      var g = this.createElement(), u = t.config.hour_size_px * o.last_hour + 1, v = 36e5;
      return g.style.top = Math.round((60 * y * 1e3 - t.config.first_hour * v) * t.config.hour_size_px / v) % u + "px", g.style.lineHeight = g.style.height = Math.max(Math.round(60 * (x - y) * 1e3 * t.config.hour_size_px / v) % u, 1) + "px", g.style.width = "100%", r.appendChild(g), d.push(g), d[0];
    } };
  }(e), function(t) {
    ...
    Xa(e), function(d) {
      d.$keyboardNavigation._minicalendars = [], d.$keyboardNavigation.isMinical = function(r) {
        ...
        function c(x) {
          var g = x.target || x.srcElement, u = d.utils.dom.locateCss(x, "dhx_cal_prev_button", !1), v = d.utils.dom.locateCss(x, "dhx_cal_next_button", !1), l = d.utils.dom.locateCss(x, "dhx_year_body", !1), f = 0, m = 0;
          if (l) {
            for (var b, D, k = g; k && k.tagName.toLowerCase() != "td"; )
              k = k.parentNode;
            if (k && (b = (D = k).parentNode), b && D) {
              for (var S = b.parentNode.querySelectorAll("tr"), p = 0; p < S.length; p++)
                if (S[p] == b) {
                  f = p;
                  break;
                }
              var w = b.querySelectorAll("td");
          ...
          r.delay(function() {
            var M;
            (u || v || l) && (u ? (M = new d.$keyboardNavigation.MinicalButton(E, 0), r.setActiveNode(new d.$keyboardNavigation.MinicalButton(E, 0))) : v ? M = new d.$keyboardNavigation.MinicalButton(E, 1) : l && (M = new d.$keyboardNavigation.MinicalCell(E, f, m)), M && (r.enable(), M.isValid() && (r.activeNode = null, r.setActiveNode(M))));
          });
        }
        if (d.renderCalendar) {
          var h = d.renderCalendar;
          d.renderCalendar = function() {
            var x = h.apply(this, arguments), g = d.$keyboardNavigation._minicalendars;
            d.eventRemove(x, "click", c), d.event(x, "click", c), d.eventRemove(x, "focus", o), d.event(x, "focus", o);
            for (var u = !1, v = 0; v < g.length; v++)
              if (g[v] == x) {
                u = !0;
                break;
              }
            if (u || g.push(x), r.isEnabled()) {
              var l = r.getActiveNode();
              l && l.container == x ? r.focusNode(l) : x.setAttribute("tabindex", "0");
            } else
        ...
        if (d.destroyCalendar) {
          ...
          d.destroyCalendar = function(x, g) {
            x = x || (d._def_count ? d._def_count.firstChild : null);
            var u = y.apply(this, arguments);
            if (!x || !x.parentNode)
              for (var v = d.$keyboardNavigation._minicalendars, l = 0; l < v.length; l++)
                v[l] == x && (d.eventRemove(v[l], "focus", o), v.splice(l, 1), l--);
            return u;
          };
        }
      };
  ...
  e.attachEvent("onTemplatesReady", function() {
    ...
    e.addEventNow = function(t, a, s) {
      ...
      var y = document.createElement("div"), x = "dhx_cal_event", g = e.templates["event_class_" + t.layer] ? e.templates["event_class_" + t.layer](t.start_date, t.end_date, t) : e.templates.event_class(t.start_date, t.end_date, t);
      g && (x = x + " " + g);
      var u = e._border_box_events(), v = n - 2, l = u ? v : n - 4, f = u ? v : n - 6, m = u ? v : n - 14, b = u ? v - 2 : n - 8, D = u ? _ - this.xy.event_header_height : _ - 30 + 1, k = '<div event_id="' + h + '" ' + e.config.event_attribute + '="' + h + '" class="' + x + '" style="position:absolute; top:' + s + "px; left:" + a + "px; width:" + l + "px; height:" + _ + "px;" + (d || "") + '">';
      return k += '<div class="dhx_header" style=" width:' + f + 'px;" >&nbsp;</div>', k += '<div class="dhx_title">' + r + "</div>", k += '<div class="dhx_body" style=" width:' + m + "px; height:" + D + 'px;">' + o + "</div>", k += '<div class="dhx_footer" style=" width:' + b + "px;" + (c ? " margin-top:-1px;" : "") + '" ></div></div>', y.innerHTML = k, y.style.zIndex = 100, y.firstChild;
      ...
      if (e.getLayer(t.layer).noMenu && (a = 0), !(t._sday < 0)) {
        ...
        if (s) {
          ...
          if (this._rendered.push(h), s.appendChild(h), c = c + parseInt(s.style.left, 10) + a, d += this._dy_shift, h.style.zIndex = this._layers_zindex[t.layer], this._edit_id == t.id) {
            ...
            this.set_xy(x, o - 6, r - 26), x.style.cssText += ";margin:2px 2px 2px 2px;overflow:hidden;", x.style.zIndex = y, h.appendChild(x), this._els.dhx_cal_data[0].appendChild(h), this._rendered.push(h), x.innerHTML = "<textarea class='dhx_cal_editor'>" + t.text + "</textarea>", this._editor = x.firstChild, this._editor.addEventListener("keypress", function(f) {
              if (f.shiftKey)
                return !0;
              var m = f.keyCode;
            ...
            }), x.firstChild.focus(), this._els.dhx_cal_data[0].scrollLeft = 0, x.firstChild.select();
          }
          if (this._select_id == t.id) {
            h.style.zIndex = parseInt(h.style.zIndex) + 1;
            for (var g = this.config["icons_" + (this._edit_id == t.id ? "edit" : "select")], u = "", v = 0; v < g.length; v++)
              u += "<div class='dhx_menu_icon " + g[v] + "' title='" + this.locale.labels[g[v]] + "'></div>";
            var l = this._render_v_bar(t.id, c - a + 1, d, a, 20 * g.length + 26, "", "<div class='dhx_menu_head'></div>", u, !0);
  ...
  (function() {
    ...
    i.extend_api = function(r, o, c) {
      ...
      h && (I[r] = function(y) {
        ...
        if (y && typeof y == "object" && !y.tagName) {
          for (var g in x = h.apply(this, o._init ? o._init(y) : arguments), i)
            o[g] && this[o[g]](i[g]);
          for (var g in y)
            o[g] ? this[o[g]](y[g]) : g.indexOf("on") === 0 && this.attachEvent(g, y[g]);
        } else
          x = h.apply(this, arguments);
        return o._patch && o._patch(this), x || this;
      }, I[r].prototype = h.prototype, c && function(y, x) {
        for (var g in x)
          typeof x[g] == "function" && (y[g] = x[g]);
      }(I[r].prototype, c));
      ...
      if (!((/* @__PURE__ */ new Date()).valueOf() - o.downtime < 100)) {
        ...
        var x;
        o.dragNode.style.left = r.clientX + 15 + (o.fx ? -1 * o.fx : 0) + (document.body.scrollLeft || document.documentElement.scrollLeft) + "px", o.dragNode.style.top = r.clientY + 3 + (o.fy ? -1 * o.fy : 0) + (document.body.scrollTop || document.documentElement.scrollTop) + "px", x = r.srcElement ? r.srcElement : r.target, o.checkLanding(x, r);
      }
    ...
    navigator.userAgent.indexOf("Macintosh"), navigator.userAgent.toLowerCase().indexOf("chrome"), navigator.userAgent.indexOf("Safari") != -1 || navigator.userAgent.indexOf("Konqueror") != -1 ? parseFloat(navigator.userAgent.substr(navigator.userAgent.indexOf("Safari") + 7, 5)) > 525 ? (s = !0, d = 1.9) : _ = !0 : navigator.userAgent.indexOf("Opera") != -1 ? parseFloat(navigator.userAgent.substr(navigator.userAgent.indexOf("Opera") + 6, 3)) : navigator.appName.indexOf("Microsoft") != -1 ? (n = !0, navigator.appVersion.indexOf("MSIE 8.0") == -1 && navigator.appVersion.indexOf("MSIE 9.0") == -1 && navigator.appVersion.indexOf("MSIE 10.0") == -1 || document.compatMode == "BackCompat" || (n = 8)) : navigator.appName == "Netscape" && navigator.userAgent.indexOf("Trident") != -1 ? n = 8 : (s = !0, d = parseFloat(navigator.userAgent.split("rv:")[1])), t.prototype.doXPath = function(r, o, c, h) {
      ...
      var x = XPathResult.ANY_TYPE;
      h == "single" && (x = XPathResult.FIRST_ORDERED_NODE_TYPE);
      var g = [], u = o.evaluate(r, y, function(l) {
        return c;
      }, x, null);
      if (x == XPathResult.FIRST_ORDERED_NODE_TYPE)
        return u.singleNodeValue;
      for (var v = u.iterateNext(); v; )
        g[g.length] = v, v = u.iterateNext();
      return g;
  ...
  e.ext || (e.ext = {}), e.ext.mapView = { createAdapter: function() {
    ...
    function r() {
      ...
      c.sort(function(g, u) {
        return g.start_date.valueOf() == u.start_date.valueOf() ? g.id > u.id ? 1 : -1 : g.start_date > u.start_date ? 1 : -1;
      });
      let h = "<div " + e._waiAria.mapAttrString() + " class='dhx_map_area'>";
      for (let g = 0; g < c.length; g++) {
        let u = c[g], v = u.id == e._selected_event_id ? "dhx_map_line highlight" : "dhx_map_line", l = u.color ? "--dhx-scheduler-event-background:" + u.color + ";" : "", f = u.textColor ? "--dhx-scheduler-event-color:" + u.textColor + ";" : "", m = e._waiAria.mapRowAttrString(u), b = e._waiAria.mapDetailsBtnString();
        h += "<div " + m + " class='" + v + "' event_id='" + u.id + "' " + e.config.event_attribute + "='" + u.id + "' style='" + l + f + (u._text_style || "") + " width: " + (e.xy.map_date_width + e.xy.map_description_width + 2) + "px;'><div class='dhx_map_event_time' style='width: " + e.xy.map_date_width + "px;' >" + e.templates.map_time(u.start_date, u.end_date, u) + "</div>", h += `<div ${b} class='dhx_event_icon icon_details'><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path d="M15.4444 16.4H4.55556V7.6H15.4444V16.4ZM13.1111 2V3.6H6.88889V2H5.33333V3.6H4.55556C3.69222 3.6 3 4.312 3 5.2V16.4C3 16.8243 3.16389 17.2313 3.45561 17.5314C3.74733 17.8314 4.143 18 4.55556 18H15.4444C15.857 18 16.2527 17.8314 16.5444 17.5314C16.8361 17.2313 17 16.8243 17 16.4V5.2C17 4.312 16.3 3.6 15.4444 3.6H14.6667V2H13.1111ZM13.8889 10.8H10V14.8H13.8889V10.8Z" fill="#A1A4A6"/>
      ...
      let y = e._els.dhx_cal_data[0].firstChild.childNodes, x = e._getNavDateElement();
      x && (x.innerHTML = e.templates[e._mode + "_date"](e._min_date, e._max_date, e._mode)), e._rendered = [];
      for (let g = 0; g < y.length - 2; g++)
        e._rendered[g] = y[g];
    }
    e.render_data = function(c, h) {
        ...
        return d.apply(this, arguments);
      {
        ...
        i && (i.clearEventMarkers(), y.forEach((x) => i == null ? void 0 : i.addEventMarker(x)));
      }
      ...
      var y, x;
      (function(g) {
        let u = document.getElementById(g);
        if (u) {
      ...
      })("mapContainer"), c && h ? (_.style.display = "block", r(), e.config.map_view_provider == e.ext.mapView.currentAdapter ? (i == null || i.destroy(h), s(e), i == null || i.initialize(h, e.config.map_settings)) : (i == null || i.destroy(h), s(e), i == null || i.initialize(h, e.config.map_settings), e.ext.mapView.currentAdapter = e.config.map_view_provider), i && (y = e.config.map_settings, x = i, y.resolve_user_location ? navigator.geolocation && navigator.geolocation.getCurrentPosition(function(g) {
        x.setView(g.coords.latitude, g.coords.longitude, y.zoom_after_resolve || y.initial_zoom);
      }) : x.setView(y.initial_position.lat, y.initial_position.lng, y.initial_zoom))) : (_.style.display = "none", e._els.dhx_cal_data[0].style.width = "100%", i && h && (i.destroy(h), i = null, e.ext.mapView.currentAdapter = e.config.map_view_provider), t.forEach((g) => e.detachEvent(g)), t = []);
    ...
    e._event_resolve_delay = 1500, e.attachEvent("onEventLoading", function(c) {
      return c.lat && c.lng && (c.lat = +c.lat, c.lng = +c.lng), e.config.map_settings.resolve_event_location && c.event_location && !c.lat && !c.lng && (e._event_resolve_delay += 1500, function(h, y, x, g) {
        setTimeout(function() {
          if (e.$destroyed)
            return !0;
          let u = h.apply(y, x);
  ...
  e.config.minicalendar = { mark_events: !0 }, e._synced_minicalendars = [], e.renderCalendar = function(t, a, s) {
    ...
    if (typeof _ == "string" && (_ = this.templates.api_date(_)), a)
      ...
      d || (d = e._get_def_cont(r)), (n = this._render_calendar(d, _, t)).$_eventAttached || (n.$_eventAttached = !0, i.attach(n, "click", (function(f) {
        var m = f.target || f.srcElement, b = e.$domHelpers;
        if (b.closest(m, ".dhx_month_head") && !b.closest(m, ".dhx_after") && !b.closest(m, ".dhx_before")) {
          var D = b.closest(m, "[data-cell-date]").getAttribute("data-cell-date"), k = e.templates.parse_date(D);
        ...
        if (m.classList.contains("dhx_cal_month_cell")) {
          var b = m.getAttribute("data-cell-date"), D = e.templates.parse_date(b);
    ...
    if (e.config.minicalendar.mark_events)
      for (var c = e.date.month_start(_), h = e.date.add(c, 1, "month"), y = this.getEvents(c, h), x = this["filter_" + this._mode], g = {}, u = 0; u < y.length; u++) {
        var v = y[u];
        if (!x || x(v.id, v)) {
          var l = v.start_date;
          for (l.valueOf() < c.valueOf() && (l = c), l = e.date.date_part(new Date(l.valueOf())); l < v.end_date && (g[+l] || (g[+l] = !0, this.markCalendar(n, l, "dhx_year_event")), !((l = this.date.add(l, 1, "day")).valueOf() >= h.valueOf())); )
            ;
        }
      }
    ...
    var c = new Date(this._min_date), h = new Date(this._max_date), y = new Date(e._date), x = _.month_day, g = this._ignores_detected;
    ...
    return e._waiAria.minicalHeader(l, T), this._cols = d, this._mode = r, this._colsS = o, this._min_date = c, this._max_date = h, e._date = y, _.month_day = x, this._ignores_detected = g, u;
    ...
    var _, d, r = t.getElementsByTagName("input"), o = t.getElementsByTagName("select"), c = function(l, f, m) {
      e.event(l, "click", function() {
        e.destroyCalendar(null, !0), e.renderCalendar({ position: l, date: new Date(this._date), navigation: !0, handler: function(b) {
          l.value = e.templates.calendar_time(b), l._date = new Date(b), e.destroyCalendar(), e.config.event_duration && e.config.auto_end_date && m === 0 && g();
        } });
      });
    };
    if (e.config.full_day) {
      ...
      var y = t.previousSibling.getElementsByTagName("input")[0], x = e.date.time_part(s.start_date) === 0 && e.date.time_part(s.end_date) === 0;
      y.checked = x, o[0].disabled = y.checked, o[1].disabled = y.checked, y.$_eventAttached || (y.$_eventAttached = !0, e.event(y, "click", function() {
        if (y.checked === !0) {
          var l = {};
    ...
    if (e.config.event_duration && e.config.auto_end_date) {
      ...
      o[0].$_eventAttached || o[0].addEventListener("change", g);
    }
    function u(l, f, m) {
      c(l, f, m), l.value = e.templates.calendar_time(f), l._date = e.date.date_part(new Date(f));
    }
    function v(l) {
      for (var f = n._time_values, m = 60 * l.getHours() + l.getMinutes(), b = m, D = !1, k = 0; k < f.length; k++) {
        var S = f[k];
        if (S === m) {
          D = !0;
          break;
    ...
    e.render_view_data = function(d, r) {
      ...
      if (e.isMultisectionEvent(c)) {
        if (e._drag_event._orig_section || (e._drag_event._orig_section = h.section), e._drag_event._orig_section != h.section) {
          ...
          if (y) {
            var x = this._get_event_sections(c), g = [], u = !0;
            if (e.config.multisection_shift_all)
              for (var v = 0; v < x.length; v++) {
                if ((l = e._shift_sections(o, x[v], y)) === null) {
                  g = x, u = !1;
                  break;
                }
                g[v] = l;
              ...
              for (v = 0; v < x.length; v++) {
                ...
                if (x[v] == e._drag_event._orig_section) {
                  var l;
                  if ((l = e._shift_sections(o, x[v], y)) === null) {
                    g = x, u = !1;
                    break;
            ...
            u && (e._drag_event._orig_section = h.section), c[e._get_section_property()] = g.join(e.config.section_delimiter);
          }
        }
      } else
        r.apply(e, [d]);
    ...
    e._get_blocked_zones = function(d, r, o, c, h) {
      if (r && this.config.multisection) {
        ...
        for (var y = [], x = 0; x < r.length; x++)
          y = y.concat(n.apply(this, [d, r[x], o, c, h]));
        return y;
      }
      return n.apply(this, arguments);
    };
  ...
  e.form_blocks.multiselect = { render: function(i) {
    ...
    for (var n = i.getElementsByTagName("input"), _ = 0; _ < n.length; _++)
      n[_].checked = !1;
    function d(y) {
      for (var x = i.getElementsByTagName("input"), g = 0; g < x.length; g++)
        x[g].checked = !!y[x[g].value];
    }
    var r = {};
    if (a[s.map_to]) {
      ...
      e.ajax.get(h, function(y) {
        var x = function(g) {
          try {
            for (var u = JSON.parse(g.xmlDoc.responseText), v = {}, l = 0; l < u.length; l++) {
              var f = u[l];
        ...
        x || (x = function(g, u) {
          for (var v = e.ajax.xpath("//data/item", g.xmlDoc), l = {}, f = 0; f < v.length; f++)
            l[v[f].getAttribute(u.map_to)] = !0;
          return l;
        }(y, s)), d(x), i.removeChild(c);
      });
    }
  }, get_value: function(i, t, a) {
  ...
  e.backbone = function(_, d) {
    d && (t = d), _.bind("change", function(c, h) {
      var y = n(c), x = e._events[y] = c.toJSON();
      x.id = y, e._init_event(x), clearTimeout(i), i = setTimeout(function() {
        if (e.$destroyed)
          return !0;
        e.updateView();
      }, 1);
    ...
    _.bind("add", function(c, h) {
      ...
      if (!e._events[y]) {
        var x = c.toJSON();
        x.id = y, e._init_event(x), r.push(x), r.length == 1 && setTimeout(o, 1);
      }
      ...
      if (!_.get(c)) {
        var h = a(e.getEvent(c)), y = new _.model(h), x = n(y);
        x != c && this.changeEventId(c, x), _.add(y), _.trigger("scheduler:add", y);
      }
      return !0;
  ...
  e.attachEvent("onTemplatesReady", function() {
    ...
    function s(n, _, d, r) {
      if (!e.checkEvent("onBeforeExternalDragIn") || e.callEvent("onBeforeExternalDragIn", [n, _, d, r, i])) {
        var o = e.attachEvent("onEventCreated", function(g) {
          e.callEvent("onExternalDragIn", [g, n, i]) || (this._drag_mode = this._drag_id = null, this.deleteEvent(g));
        ...
        if (e.matrix && e.matrix[e._mode]) {
          ...
          var x = e._locate_cell_timeline(i);
          h.start_date = y._trace_x[x.x], h.end_date = e.date.add(h.start_date, y.x_step, y.x_unit);
        }
  ...
  function v() {
    ...
    if (e.matrix && e.matrix[e._mode] && (S = e.matrix[e._mode].render == "cell" ? "matrix" : "timeline"), k += "<scale mode='" + S + "' today='" + e._els.dhx_cal_date[0].innerHTML + "'>", e._mode == "week_agenda")
      for (var p = e._els.dhx_cal_data[0].getElementsByTagName("DIV"), w = 0; w < p.length; w++)
        p[w].className == "dhx_wa_scale_bar" && (k += "<column>" + n(p[w].innerHTML) + "</column>");
    else if (e._mode == "agenda" || e._mode == "map")
      k += "<column>" + n((p = e._els.dhx_cal_header[0].childNodes[0].childNodes)[0].innerHTML) + "</column><column>" + n(p[1].innerHTML) + "</column>";
    else if (e._mode == "year")
      for (p = e._els.dhx_cal_data[0].childNodes, w = 0; w < p.length; w++)
        k += "<month label='" + n(p[w].querySelector(".dhx_year_month").innerHTML) + "'>", k += f(p[w].querySelector(".dhx_year_week").childNodes), k += l(p[w].querySelector(".dhx_year_body")), k += "</month>";
    else {
      k += "<x>", k += f(p = e._els.dhx_cal_header[0].childNodes), k += "</x>";
      var E = e._els.dhx_cal_data[0];
      if (e.matrix && e.matrix[e._mode]) {
        for (k += "<y>", w = 0; w < E.firstChild.rows.length; w++)
          k += "<row><![CDATA[" + n(E.firstChild.rows[w].cells[0].innerHTML) + "]]></row>";
...
<row><![CDATA[` + n(E[w].innerHTML) + "]]></row>";
  ...
  function l(k) {
    for (var S = "", p = k.querySelectorAll("tr"), w = 0; w < p.length; w++) {
      ...
      S += `
<row height='` + M[0].offsetHeight + "'><![CDATA[" + n(E.join("|")) + "]]></row>", t = M[0].offsetHeight;
    }
    return S;
  }
  function f(k) {
    ...
    for (var w = 0; w < k.length; w++)
      p += `
<column><![CDATA[` + n(k[w].innerHTML) + "]]></column>";
    if (i = k[0].offsetWidth, S) {
      var E = 0, M = k[0].offsetWidth, N = 1;
      for (w = 0; w < S.length; w++)
        p += `
<column second_scale='` + N + "'><![CDATA[" + n(S[w].innerHTML) + "]]></column>", (E += S[w].offsetWidth) >= M && (M += k[N] ? k[N].offsetWidth : 0, N++), i = S[0].offsetWidth;
    }
    return p;
  }
  function m(k) {
    ...
    if (e._mode == "agenda" || e._mode == "map")
      for (var E = 0; E < p.length; E++)
        S += "<event><head><![CDATA[" + n(p[E].childNodes[0].innerHTML) + "]]></head><body><![CDATA[" + n(p[E].childNodes[2].innerHTML) + "]]></body></event>";
    else if (e._mode == "week_agenda")
      for (E = 0; E < p.length; E++)
        S += "<event day='" + p[E].parentNode.getAttribute("day") + "'><body>" + n(p[E].innerHTML) + "</body></event>";
    else if (e._mode == "year")
      ...
      for (p = e._els.dhx_cal_data[0].getElementsByTagName("TD"), E = 0; E < p.length; E++)
        A = k ? c(p[E], "color") : "", S += `
<event><body backgroundColor='` + (C = k ? c(p[E], "backgroundColor") : "") + "' color='" + A + "'><![CDATA[" + n(p[E].innerHTML) + "]]></body></event>";
    else
      for (E = 0; E < p.length; E++) {
        var H, $;
        if (e.matrix && e.matrix[e._mode])
        ...
        if (!isNaN(1 * $)) {
          var z = o(p[E].style.top), q = o(p[E].style.height), V = p[E].className.split(" ")[0].replace("dhx_cal_", "");
          if (V !== "dhx_tooltip_line") {
            var R = e.getEvent(p[E].getAttribute(e.config.event_attribute));
            if (R) {
              T = R._sday;
              var F = R._sweek, U = R._length || 0;
              if (e._mode == "month")
                q = parseInt(p[E].offsetHeight, 10), z = parseInt(p[E].style.top, 10) - e.xy.month_head_height, T = h(p[E], T), F = y(p[E], F);
              else if (e.matrix && e.matrix[e._mode]) {
                T = 0, F = p[E].parentNode.parentNode.parentNode.rowIndex;
                var W = t;
                t = p[E].parentNode.offsetHeight, z = o(p[E].style.top), z -= 0.2 * z, t = W;
              } else {
                if (p[E].parentNode == e._els.dhx_cal_data[0])
                  continue;
                var B = e._els.dhx_cal_data[0].childNodes[0], re = parseFloat(B.className.indexOf("dhx_scale_holder") != -1 ? B.style.left : 0);
                H += _(p[E].parentNode.style.left, re);
              }
              S += `
<event week='` + F + "' day='" + T + "' type='" + V + "' x='" + H + "' y='" + z + "' width='" + $ + "' height='" + q + "' len='" + U + "'>", V == "event" ? (S += "<header><![CDATA[" + n(p[E].childNodes[1].innerHTML) + "]]></header>", A = k ? c(p[E].childNodes[2], "color") : "", S += "<body backgroundColor='" + (C = k ? c(p[E].childNodes[2], "backgroundColor") : "") + "' color='" + A + "'><![CDATA[" + n(p[E].childNodes[2].innerHTML) + "]]></body>") : (A = k ? c(p[E], "color") : "", S += "<body backgroundColor='" + (C = k ? c(p[E], "backgroundColor") : "") + "' color='" + A + "'><![CDATA[" + n(p[E].innerHTML) + "]]></body>"), S += "</event>";
            }
          }
        }
      }
  ...
  function b(k, S, p, w, E, M) {
    ...
    if (k) {
      ...
      for (var H = new Date(k); +H < +S; H = this.date.add(H, 1, p))
        this.setCurrentView(H, p), T += x("page") + v().replace("–", "-") + m(N) + g("page");
      T += g("pages"), this.setCurrentView(A, C);
    } else
      T = u("data", w, E, M) + v().replace("–", "-") + m(N) + g("data");
    return T;
  }
  function D(k, S, p, w, E, M, N) {
    (function(T, A) {
      ...
      return A += "</data>", A;
    }(E) : b.apply(this, [k, S, p, E, M, N]), w);
  }
  e.getPDFData = b, e.toPDF = function(k, S, p, w) {
  ...
  e.attachEvent("onTemplatesReady", function() {
    ...
    function s(d, r, o, c) {
      for (var h = r.getElementsByTagName(d), y = o.getElementsByTagName(d), x = y.length - 1; x >= 0; x--)
        if (o = y[x], c) {
          var g = document.createElement("span");
          g.className = "dhx_text_disabled", g.innerHTML = c(h[x]), o.parentNode.insertBefore(g, o), o.parentNode.removeChild(o);
        } else
      ...
      if (this.config.readonly_form || this.getEvent(d).readonly ? this.config.readonly_active = !0 : (this.config.readonly_active = !1, e.config.buttons_left = t.slice(), e.config.buttons_right = a.slice(), e.form_blocks.recurring && (e.form_blocks.recurring.set_value = i)), this.config.readonly_active)
        for (var r = ["dhx_delete_btn", "dhx_save_btn"], o = [e.config.buttons_left, e.config.buttons_right], c = 0; c < r.length; c++)
          for (var h = r[c], y = 0; y < o.length; y++) {
            for (var x = o[y], g = -1, u = 0; u < x.length; u++)
              if (x[u] == h) {
                g = u;
                break;
              }
  ...
  function n(p) {
    p.rrule.includes(";UNTIL=") && (p.rrule = p.rrule.split(";UNTIL=")[0]);
    let w = Ve(`RRULE:${p.rrule};UNTIL=${u(s(p._end_date || p.end_date))}`, { dtstart: p.start_date }), E = new P(w.origOptions).toString().replace("RRULE:", "");
    E = E.split(`
`)[1], p.rrule = E;
  }
  function _(p, w) {
    w || (w = e.getEvent(p));
    let E = w.rrule.split(";"), M = [];
    for (let N = 0; N < E.length; N++) {
      let T = E[N].split("="), A = T[0], C = T[1];
      (A !== "BYDAY" || w.rrule.includes("WEEKLY") && C.length > 3) && (A === "UNTIL" && Ve(w.rrule).options.until.valueOf() < w.start_date.valueOf() && (w._end_date = w.end_date), M.push(A), M.push("="), M.push(C), M.push(";"));
    }
  ...
  function c(p, w) {
    for (let E in e._events) {
      let M = e._events[E];
      (M.recurring_event_id == p || e._is_virtual_event(M.id) && M.id.split("#")[0] == p) && (M.text = w.text, e.updateEvent(M.id));
    }
  }
  function h(p, w) {
  ...
  function x(p, w) {
    const E = e.locale;
    p.find((N) => N.checked) || (p[0].checked = !0);
    const M = p.reduce((N, T) => (N[T.value] = T.callback, N), {});
    e.modalbox({ text: `<div class="dhx_edit_recurrence_options">
				${p.map((N) => `<label class="dhx_styled_radio">
					<input type="radio" value="${N.value}" name="option" ${N.checked ? "checked" : ""}>
					${N.label}
				</label>`).join("")}
			</div>`, type: "recurring_mode", title: E.labels.confirm_recurring, width: "auto", position: "middle", buttons: [{ label: E.labels.message_ok, value: "ok", css: "rec_ok" }, { label: E.labels.message_cancel, value: "cancel" }], callback: function(N, T) {
      if (w && w(N, T), N === "cancel")
        return;
  ...
  e._isFollowing = function(p) {
    ...
    if (this._is_virtual_event(p))
      ...
      E.start_date && (E.start_date = i(E.start_date)), E.end_date && (E.end_date = i(E.end_date)), t(E) && this._lightbox_id && (E._removeFollowing || this._isFollowing(p) ? E._removeFollowing = null : this._roll_back_dates(E));
    ...
    let M = this.getEvent(p), N = e._lame_clone(M), T = w.rrule;
    if (M && t(M) && !E && this._isFollowing(p)) {
      if (M._removeFollowing) {
        ...
        if (M.end_date = new Date(M.start_date.valueOf() - 1e3), M._end_date = M._shorten_end_date, M.start_date = M._start_date, M._shorten = !0, n(M), e.callEvent("onEventChanged", [M.id, M]), e.getEvent(M._thisAndFollowing))
          for (const A in e._events) {
            let C = e._events[A];
            C.recurring_event_id === p && C.start_date.valueOf() > N.start_date.valueOf() && h(C.id, C);
          }
      ...
      }
      {
        ...
        if (A && M._firstOccurrence)
          ...
          for (const C in e._events) {
            let H = e._events[C];
            H.recurring_event_id == p && H.id == N._thisAndFollowing && r(C, w, M, N);
          }
        else {
          e._is_modified_occurrence(A) && o(A), M.end_date = M._shorten_end_date, M._end_date = M._shorten_end_date, M.start_date = M._start_date, M._shorten = !0, n(M), e.callEvent("onEventChanged", [M.id, M]);
          let C = { ...N };
        ...
        return E || c(p, w), e.hideLightbox(), !1;
      }
    }
    return E || c(p, w), N._ocr && N._beforeEventChangedFlag ? (M.start_date = N.start_date, M.end_date = N.end_date, M._start_date = N._start_date, M._end_date = N._end_date, e.updateEvent(M.id), !0) : (this._select_id = null, y(), !0);
    ...
    if (E === "ask") {
      const C = e.locale;
      x([{ value: "Occurrence", label: C.labels.button_edit_occurrence, checked: !0, callback: () => A(p, "Occurrence") }, { value: "Following", label: C.labels.button_edit_occurrence_and_following, callback: () => A(p, "Following") }, { value: "AllEvents", label: C.labels.button_edit_series, callback: () => A(p, "AllEvents") }]);
    }
    ...
    const z = { value: "AllEvents", label: M.labels.button_edit_series, callback: () => function(R) {
      ...
      if ($ && H && (R._start_date = R.start_date, R.start_date = H, R.end_date = $), e._isFirstOccurrence(F) || e._isExceptionFirstOccurrence(F)) {
        if (e._isExceptionFirstOccurrence(F) && o(F), O._start_date = A.start_date, O.start_date = R.start_date, O.duration = (+R.end_date - +R.start_date) / 1e3, O._beforeEventChangedFlag = R._beforeEventChangedFlag, O.rrule && _(O.id, O), !e.config.collision_limit || e.checkCollision(O))
          for (const U in e._events)
            e._events[U].id == O.id && (e._events[U] = { ...O }, e.callEvent("onEventChanged", [e._events[U].id, e._events[U]]));
      } else {
        O._end_date = A.end_date;
        const U = R.original_start || e.date.date_part(new Date(R._start_date));
        O._shorten_end_date = new Date(U.valueOf() - 1e3), O.end_date = R.end_date, O._start_date = A.start_date, O.start_date = R.start_date, O._thisAndFollowing = R.id, O.rrule && _(O.id, O);
        let W = O.end_date;
        if (O.end_date = O._end_date, !e.config.collision_limit || e.checkCollision(O)) {
          O.end_date = W;
          for (const B in e._events)
            e._events[B].id == O.id && (e._events[B] = { ...O }, e.callEvent("onRecurringEventSave", [e._events[B].id, e._events[B], e._new_event]), e.callEvent("onEventChanged", [e._events[B].id, e._events[B]]));
        }
      }
    }(N) }, V = { value: "Occurrence", label: M.labels.button_edit_occurrence, callback: () => function(R) {
    ...
    for (let N = 0; N < E.length; N++)
      E[N].deleted || E[N].recurring_event_id || (t(E[N]) ? this.repeat_date(E[N], M, void 0, void 0, void 0, void 0, w) : M.push(E[N]));
    return function(N) {
      const T = {};
      return N.forEach((A) => {
        const C = T[A.id];
    ...
    e.isOneDayEvent = function(E) {
      return !!t(E) || p.call(this, E);
    };
    const w = e.updateEvent;
    e.updateEvent = function(E) {
      const M = e.getEvent(E);
      M && t(M) && !this._is_virtual_event(E) ? e.update_view() : w.call(this, E);
    };
  }();
  ...
  e.repeat_date = function(p, w, E, M, N, T, A) {
    if (!p.rrule)
      return;
    let C = A ? A[p.id] : g()[p.id];
    C || (C = {}), M = a(M || new Date(e._min_date.valueOf() - 6048e5)), N = a(N || new Date(e._max_date.valueOf() - 1e3));
    const H = a(p.start_date);
    let $;
    $ = Ve(T ? `RRULE:${p.rrule};UNTIL=${u(p.end_date)};COUNT=${T}` : `RRULE:${p.rrule};UNTIL=${u(p.end_date)}`, { dtstart: H });
    const O = $.between(M, N, !0).map((V) => {
      const R = s(V);
      return R.setHours(p.start_date.getHours()), R.setMinutes(p.start_date.getMinutes()), R.setSeconds(p.start_date.getSeconds()), R;
    });
    let z = 0;
    const q = p.duration;
    for (let V = 0; V < O.length && !(T && z >= T); V++) {
      const R = O[V];
      let F = C[R.valueOf()];
      if (F) {
        ...
        const U = e._copy_event(p);
        if (U.text = p.text, U.start_date = R, U.id = p.id + "#" + Math.ceil(R.valueOf()), U.end_date = new Date(R.valueOf() + 1e3 * q), U.end_date.valueOf() <= e._min_date.valueOf() || (U.end_date = e._fix_daylight_saving_date(U.start_date, U.end_date, p, R, U.end_date), U._timed = e.isOneDayEvent(U), !U._timed && !e._table_view && !e.config.multi_day))
          continue;
        w.push(U), E || (e._events[U.id] = U, e._rec_temp.push(U)), z++;
      }
    }
    if (C && O.length == 0)
      for (let V in C) {
  ...
  const D = { MONTHLY: function(p) {
    ...
    return { rrule: { freq: P.YEARLY, bymonth: p.start.getMonth() + 1, interval: 1, bymonthday: p.start.getDate() }, until: new Date(9999, 1, 1) };
  }, WORKDAYS: function(p) {
    ...
    switch (E.interval = N, M) {
      case "DAILY":
        ...
        break;
      case "WEEKLY":
        E.freq = P.WEEKLY, C = [], w.querySelectorAll('.dhx_form_repeat_custom_week [name="week_day"]').forEach((q) => {
        ...
        break;
      case "MONTHLY":
        E.freq = P.MONTHLY, T === "month_date" ? E.bymonthday = p.start.getDate() : (H = p.start.getDay() - 1, H == -1 && (H = 6), E.byweekday = [H], E.bysetpos = v(p.start).dayNumber);
        break;
      case "YEARLY":
        E.freq = P.YEARLY, E.bymonth = p.start.getMonth() + 1, A == "month_date" ? E.bymonthday = p.start.getDate() : (H = p.start.getDay() - 1, H == -1 && (H = 6), E.byweekday = [H], E.bysetpos = v(p.start).dayNumber);
    }
...
`));
  ...
  e.config.occurrence_timestamp_in_utc = !1, e.config.recurring_workdays = [1, 2, 3, 4, 5], e.form_blocks.recurring = { _get_node: function(n) {
    ...
    var h = e.date.str_to_date(e.config.repeat_date, !1, !0), y = e.date.date_to_str(e.config.repeat_date), x = n.getElementsByTagName("FORM")[0], g = {};
    function u(p) {
      for (var w = 0; w < p.length; w++) {
        var E = p[w];
        if (E.name)
          if (g[E.name])
            if (g[E.name].nodeType) {
              var M = g[E.name];
              g[E.name] = [M, E];
            } else
              g[E.name].push(E);
    ...
    if (u(x.getElementsByTagName("INPUT")), u(x.getElementsByTagName("SELECT")), !e.config.repeat_date_of_end) {
      var v = e.date.date_to_str(e.config.repeat_date);
      e.config.repeat_date_of_end = v(e.date.add(e._currentDate(), 30, "day"));
    }
    c(g, "date_of_end", e.config.repeat_date_of_end);
    var l = function(p) {
    ...
    e.form_blocks.recurring._get_repeat_code = function(p) {
      ...
      }(o(g, "date_of_end")) : (e.transpose_type(w.join("_")), E = Math.max(1, o(g, "occurences_count")), p.end = e.date["add_" + w.join("_")](new Date(p.start), E + 0, { start_date: p.start }) || p.start), w.join("_") + "#" + E;
    };
    var b = { month: function(p, w) {
      var E = e.form_blocks.recurring._get_node_value, M = e.form_blocks.recurring._get_node_numeric_value;
      E(g, "month_type") == "d" ? (p.push(Math.max(1, M(g, "month_count"))), w.start.setDate(E(g, "month_day"))) : (p.push(Math.max(1, M(g, "month_count2"))), p.push(E(g, "month_day2")), p.push(Math.max(1, M(g, "month_week2"))), e.config.repeat_precise || w.start.setDate(1)), w._start = !0;
    }, week: function(p, w) {
      var E = e.form_blocks.recurring._get_node_value, M = e.form_blocks.recurring._get_node_numeric_value;
      p.push(Math.max(1, M(g, "week_count"))), p.push(""), p.push("");
      for (var N = [], T = E(g, "week_day", !0), A = w.start.getDay(), C = !1, H = 0; H < T.length; H++)
      ...
      w(g, "day_type") == "d" ? p.push(Math.max(1, E(g, "day_count"))) : (p.push("week"), p.push(1), p.push(""), p.push(""), p.push(e.config.recurring_workdays.join(",")), p.splice(0, 1));
    }, year: function(p, w) {
      var E = e.form_blocks.recurring._get_node_value;
      E(g, "year_type") == "d" ? (p.push("1"), w.start.setMonth(0), w.start.setDate(E(g, "year_day")), w.start.setMonth(E(g, "year_month"))) : (p.push("1"), p.push(E(g, "year_day2")), p.push(E(g, "year_week2")), w.start.setDate(1), w.start.setMonth(E(g, "year_month2"))), w._start = !0;
    } }, D = { week: function(p, w) {
      ...
      var E = e.form_blocks.recurring._set_node_value;
      p[2] === "" ? (E(g, "month_type", "d"), E(g, "month_count", p[1]), E(g, "month_day", w.start.getDate())) : (E(g, "month_type", "w"), E(g, "month_count2", p[1]), E(g, "month_week2", p[3]), E(g, "month_day2", p[2]));
    }, day: function(p, w) {
      var E = e.form_blocks.recurring._set_node_value;
      E(g, "day_type", "d"), E(g, "day_count", p[1]);
    }, year: function(p, w) {
      var E = e.form_blocks.recurring._set_node_value;
      p[2] === "" ? (E(g, "year_type", "d"), E(g, "year_day", w.start.getDate()), E(g, "year_month", w.start.getMonth())) : (E(g, "year_type", "w"), E(g, "year_week2", p[3]), E(g, "year_day2", p[2]), E(g, "year_month2", w.start.getMonth()));
    } };
    e.form_blocks.recurring._set_repeat_code = function(p, w) {
      ...
      switch (p = M[0].split("_"), D[p[0]](p, w), M[1]) {
        ...
        case "":
          m(g, "date_of_end");
          var N = w.end;
          e.config.include_end_by && (N = e.date.add(N, -1, "day")), E(g, "date_of_end", y(N));
          break;
        default:
          m(g, "occurences_count"), E(g, "occurences_count", M[1]);
      }
      E(g, "repeat", p[0]);
      var T = e.form_blocks.recurring._get_form_node(g, "repeat", p[0]);
    ...
    for (var k = 0; k < x.elements.length; k++) {
      var S = x.elements[k];
...
`));
    ...
    if (this._is_virtual_event(n)) {
      ...
      for (var x = !1, g = 0; g < this._rendered.length; g++)
        this._rendered[g].getAttribute(this.config.event_attribute) == n && (x = !0);
      x || (this._select_id = null);
    }
    return !0;
    ...
    var h = function(x) {
      var g = e.getEvent(x);
      return g._end_date = g.end_date, g.end_date = new Date(g.start_date.valueOf() + 1e3 * g.event_length), e.showLightbox_rec(x);
    };
    ...
    if (d == "ask") {
      var y = this;
      e.modalbox({ text: _.labels.confirm_recurring, title: _.labels.title_confirm_recurring, width: "500px", position: "middle", buttons: [_.labels.button_edit_series, _.labels.button_edit_occurrence, _.labels.icon_cancel], callback: function(x) {
        switch (+x) {
          case 0:
            return h(o);
          case 1:
    ...
    if (!this.date[_]) {
      ...
      if (d[0] == "day" || d[0] == "week") {
        ...
        this.date[_] = function(y, x) {
          var g = Math.floor((x.valueOf() - y.valueOf()) / (864e5 * o));
          return g > 0 && y.setDate(y.getDate() + g * o), c && e.transpose_day_week(y, c, 1, o), y;
        }, this.date[r] = function(y, x) {
          var g = new Date(y.valueOf());
          if (c)
            for (var u = 0; u < x; u++)
              e.transpose_day_week(g, c, 0, o);
          else
            g.setDate(g.getDate() + x * o);
          return g;
        };
      } else
        d[0] != "month" && d[0] != "year" || (this.date[_] = function(y, x, g) {
          var u = Math.ceil((12 * x.getFullYear() + 1 * x.getMonth() + 1 - (12 * y.getFullYear() + 1 * y.getMonth() + 1)) / o - 1);
          return u >= 0 && (y.setDate(1), y.setMonth(y.getMonth() + u * o)), e.date[r](y, 0, g);
        }, this.date[r] = function(y, x, g, u) {
          if (u ? u++ : u = 1, u > 12)
            return null;
          var v = new Date(y.valueOf());
          v.setDate(1), v.setMonth(v.getMonth() + x * o);
          var l = v.getMonth(), f = v.getFullYear();
          v.setDate(g.start_date.getDate()), d[3] && e.date.day_week(v, d[2], d[3]);
          var m = e.config.recurring_overflow_instances;
          return v.getMonth() != l && m != "none" && (v = m === "lastDay" ? new Date(f, l + 1, 0, v.getHours(), v.getMinutes(), v.getSeconds(), v.getMilliseconds()) : e.date[r](new Date(f, l + 1, 0), x || 1, g, u)), v;
        });
    }
  }, e.repeat_date = function(n, _, d, r, o, c) {
    r = r || this._min_date, o = o || this._max_date;
    var h = c || -1, y = new Date(n.start_date.valueOf()), x = y.getHours(), g = 0;
    ...
    for (; y && y < o && y < n.end_date && (h < 0 || g < h); ) {
      y.setHours(x);
      ...
      if (v)
        ...
        if (f.text = n.text, f.start_date = y, f.event_pid = n.id, f.id = n.id + "#" + Math.round(u / 1e3), f.end_date = l, f.end_date = e._fix_daylight_saving_date(f.start_date, f.end_date, n, y, f.end_date), f._timed = this.isOneDayEvent(f), !f._timed && !this._table_view && !this.config.multi_day)
          return;
        _.push(f), d || (this._events[f.id] = f, this._rec_temp.push(f)), g++;
      }
      y = this.date["add_" + n.rec_pattern](y, 1, n);
    }
...
END:VCALENDAR`;
  ...
  e.ext.timeline = { renderCells: function(t, a, s) {
    ...
    function n(l, f) {
      for (var m, b = [], D = 0; D < f.y_unit.length; D++)
        b[D] = [];
      b[m] || (b[m] = []);
      var k = function($) {
      ...
      for (D = 0; D < l.length; D++) {
        ...
        E.end_date.valueOf() == f._trace_x[T].valueOf() && (T -= 1), b[m] || (b[m] = []), p(b, m, N, T);
        var A = k[M];
        if (S && A && A.$parent)
          for (var C = {}; A.$parent; ) {
            if (C[A.key])
    ...
    e.matrix = {}, e._merge = function(l, f) {
      ...
      let m = l.x_date || e.config.hour_date, b = null;
      e.templates[l.name + "_scale_date"] = function(S) {
        return m === (l.x_date || e.config.hour_date) && b || (m = l.x_date || e.config.hour_date, b = e.date.date_to_str(m)), b(S);
      };
      ...
      if (l.render == "cell")
        ...
        for (var m = e.get_visible_events(), b = l.order, D = 0; D < m.length; D++) {
          var k = m[D], S = k[l.y_property], p = l.order[S];
      ...
      e._timeline_smart_render && e._timeline_smart_render._rendered_events_cache && (e._timeline_smart_render._rendered_events_cache = []), m.forEach(function(b) {
        const D = Number(b.getAttribute("data-section-index"));
      ...
      if (!m)
        return "";
      var b = l._sorder, D = e._timeline_getX(l, !1, this), k = e._timeline_getX(l, !0, this), S = e._get_timeline_event_height ? e._get_timeline_event_height(l, this) : this.getEventHeight(l), p = S - 2;
      ...
      if (e.config.drag_resize && !e.config.readonly) {
        var O = "dhx_event_resize", z = p + 1, q = "<div class='" + O + " " + O + "_start' style='height: " + z + "px;'></div>", V = "<div class='" + O + " " + O + "_end' style='height: " + z + "px;'></div>";
        $ += (l._no_resize_start ? "" : q) + (l._no_resize_end ? "" : V);
      }
      if ($ += C + "</div>", !f)
        return $;
      var R = document.createElement("div");
    ...
    e._timeline_trace_events = function() {
      ...
      var b = 0, D = m._step, k = m.round_position, S = 0, p = f ? l.end_date : l.start_date;
      m.x_unit == "month" && (D = 24 * new Date(new Date(p).getFullYear(), new Date(p).getMonth() + 1, 0).getDate() * 60 * 60 * 1e3 / e._cols[0]), p.valueOf() > e._max_date.valueOf() && (p = e._max_date);
      var w = p - e._min_date_timeline;
      if (w > 0) {
        var E = e._get_date_index(m, p);
        e._ignores[E] && (k = !0);
        for (var M = 0; M < E; M++)
          b += e._cols[M];
        var N = e._timeline_get_rounded_date.apply(m, [p, !1]);
        k ? +p > +N && f && (S = e._cols[E]) : (w = p - N, m.first_hour || m.last_hour ? ((w -= m._start_correction) < 0 && (w = 0), (S = Math.round(w / D)) > e._cols[E] && (S = e._cols[E])) : S = Math.round(w / D));
      }
      return b += f && (w === 0 || k) ? S - 1 : S;
    }, e._timeline_get_rounded_date = function(l, f) {
      var m = e._get_date_index(this, l), b = this._trace_x[m];
      return f && +l != +this._trace_x[m] && (b = this._trace_x[m + 1] ? this._trace_x[m + 1] : e.date.add(this._trace_x[m], this.x_step, this.x_unit)), new Date(b);
    }, e._timeline_skip_ignored = function(l) {
      if (e._ignores_detected)
        for (var f, m, b, D, k = 0; k < l.length; k++) {
          for (D = l[k], b = !1, f = e._get_date_index(this, D.start_date), m = e._get_date_index(this, D.end_date); f < m; ) {
            if (!e._ignores[f]) {
              b = !0;
              break;
            }
          ...
          b || f != m || e._ignores[m] || +D.end_date > +this._trace_x[m] && (b = !0), b || (l.splice(k, 1), k--);
        }
      ...
      if (l && this.render != "cell") {
        ...
        for (var f = [], m = l.length, b = -1, D = null, k = 0; k < m; k++) {
          var S = l[k];
          S._inner = !1;
          ...
          if (f.length && (f[f.length - 1]._inner = !0), !w)
            if (f.length)
              if (f.length <= f[f.length - 1]._sorder) {
                ...
                S._sorder = C + 1, b < S._sorder && (b = S._sorder, D = S), S._inner = !1;
              }
            else
              S._sorder = 0;
      ...
      if (l && this.render != "cell") {
        ...
        l.forEach(function(k) {
          var S, p;
          b[S = k.id, p = k[m.y_property], S + "_" + p] = !0;
        });
      ...
      var m = l.y_unit[f], b = l._logic(l.render, m, l);
      if (e._merge(b, { height: l.dy }), l.section_autoheight && !d(m)) {
        var D = function(p, w) {
        ...
        }(l, b.height), k = l.scrollable ? l._sch_height - e.xy.scroll_width : l._sch_height;
        D.totalHeight < k && D.rowsWithDefaultHeight > 0 && (b.height = Math.max(b.height, Math.floor((k - 1 - D.totalCustomHeight) / D.rowsWithDefaultHeight)));
      }
      if (d(m) && (b.height = Number(m.height)), l._section_height[m.key] = b.height, !b.td_className) {
        b.td_className = "dhx_matrix_scell";
        var S = e.templates[l.name + "_scaley_class"](l.y_unit[f].key, l.y_unit[f].label, l.y_unit[f]);
        S && (b.td_className += " " + S), l.columns && (b.td_className += " dhx_matrix_scell_columns");
      }
      return b.td_content || (b.td_content = e.templates[l.name + "_scale_label"](l.y_unit[f].key, l.y_unit[f].label, l.y_unit[f])), e._merge(b, { tr_className: "", style_height: "height:" + b.height + "px;", style_width: "width:" + l.dx + "px;", summ_width: "width:" + l._summ + "px;", table_className: "" }), b;
    }, e._timeline_get_fit_events_stats = function(l, f, m) {
      if (l.fit_events) {
        var b = l._events_height[l.y_unit[f].key] || 0;
        l.fit_events_offset && (b += l.fit_events_offset), m.height = b > m.height ? b : m.height, m.style_height = "height:" + m.height + "px;", m.style_line_height = "line-height:" + (m.height - 1) + "px;", l._section_height[l.y_unit[f].key] = m.height;
      }
    ...
    }, e._timeline_save_scroll_pos = function(l, f, m, b) {
      l._y_scroll = f || 0, l._x_scroll = m || 0;
    }, e._timeline_get_html_for_cell_data_row = function(l, f, m, b, D) {
      var k = "";
      return D.template && (k += " " + (D.template(D.section, D.view) || "")), "<div class='dhx_timeline_data_row" + k + "' data-section-id='" + _(b) + "' data-section-index='" + l + "' style='" + f.summ_width + f.style_height + " position:absolute; top:" + m + "px;'>";
    ...
    }, e._timeline_get_html_for_cell = function(l, f, m, b, D, k) {
      var S = m._trace_x[l], p = m.y_unit[f], w = e._cols[l], E = r(S), M = e.templates[m.name + "_cell_value"](b, S, p);
      return "<div data-col-id='" + l + "' data-col-date='" + E + "' class='dhx_matrix_cell dhx_timeline_data_cell " + e.templates[m.name + "_cell_class"](b, S, p) + "' style='width:" + w + "px;" + D.style_height + D.style_line_height + (e.config.rtl ? " right:" : "  left:") + k + "px;'><div style='width:auto'>" + M + "</div></div>";
    }, e._timeline_get_html_for_bar_matrix_line = function(l, f, m, b) {
      return "<div style='" + f.summ_width + " " + f.style_height + " position:absolute; top:" + m + "px;' data-section-id='" + _(b) + "' data-section-index='" + l + "' class='dhx_matrix_line'>";
      ...
      return "";
    }, e._timeline_get_html_for_bar = function(l, f, m, b, D, k) {
      var S = r(m._trace_x[l]), p = m.y_unit[f], w = "";
      m.cell_template && (w = e.templates[m.name + "_cell_value"](b, m._trace_x[l], p, k));
      var E = "line-height:" + m._section_height[p.key] + "px;";
      let M = "";
      return w && (M = "<div style='width:auto; height:100%;position:relative;" + E + "'>" + w + "</div>"), "<div class='dhx_matrix_cell dhx_timeline_data_cell " + e.templates[m.name + "_cell_class"](b, m._trace_x[l], p, k) + "' style='width:" + e._cols[l] + "px; " + (e.config.rtl ? "right:" : "left:") + D + "px;'  data-col-id='" + l + "' data-col-date='" + S + "' >" + M + "</div>";
      ...
      l.second_scale && (b += " dhx_timeline_second_scale");
      var D = e.xy.scale_height;
      m.className = b, m.style.cssText = ["width:" + l.dx + "px", "height:" + D + "px", "line-height:" + D + "px", "top:0px", e.config.rtl ? "right:0px" : "left:0px"].join(";"), m.innerHTML = e.templates[l.name + "_scale_header"](l);
      const k = e.$container.querySelector(".dhx_cal_header");
      m.style.top = `${k.offsetTop}px`, m.style.height = `${k.offsetHeight}px`, e.$container.appendChild(m);
    }, e._timeline_y_scale = function(l) {
      var f = e._timeline_get_block_stats(l, this), m = this.scrollable ? " dhx_timeline_scrollable_data" : "", b = "<div class='dhx_timeline_table_wrapper'>", D = "<div class='dhx_timeline_label_wrapper' style='" + f.style_label_wrapper + "'><div class='dhx_timeline_label_col'>", k = "<div class='dhx_timeline_data_wrapper" + m + "' style='" + f.style_data_wrapper + "'><div class='dhx_timeline_data_col'>";
      ...
      var H = !!C, $ = this._smartRenderingEnabled(), O = function(_e, Y) {
        for (var be = [], G = {}, xe = 0, de = 0; de < _e.y_unit.length; de++) {
          e._timeline_calculate_event_positions.call(_e, Y[de]);
      ...
      for (var z = 0; z < this.y_unit.length; z++) {
        var q = O.rowStats[z], V = this.y_unit[z], R = q.top, F = "<div class='dhx_timeline_label_row " + q.tr_className + "' style='top:" + R + "px;" + q.style_height + q.style_line_height + "'data-row-index='" + z + "' data-row-id='" + _(V.key) + "'><div class='" + q.td_className + "' style='" + q.style_width + " height:" + q.height + "px;' " + e._waiAria.label(q.td_content) + ">" + q.td_content + "</div></div>";
        if ($ && this._label_rows.push({ div: F, top: R, section: V }), $ && (e._timeline_smart_render.isInYViewPort({ top: R, bottom: R + q.height }, C) || (A = !0)), A)
          A = !1;
        else {
          D += F, $ && e._timeline_smart_render._rendered_labels_cache.push(z);
          var U = { view: this, section: V, template: e.templates[this.name + "_row_class"] }, W = 0;
          if (this.render == "cell") {
            k += e._timeline_get_html_for_cell_data_row(z, q, q.top, V.key, U);
            for (var B = 0; B < e._cols.length; B++)
              e._ignores[B] && !$ ? k += e._timeline_get_html_for_cell_ignores(q) : $ && H ? e._timeline_smart_render.isInXViewPort({ left: W, right: W + e._cols[B] }, C) && (k += e._timeline_get_html_for_cell(B, z, this, S[z][B], q, W)) : k += e._timeline_get_html_for_cell(B, z, this, S[z][B], q, W), W += e._cols[B];
            k += "</div>";
          } else {
            k += e._timeline_get_html_for_bar_matrix_line(z, q, q.top, V.key);
            var re = S[z];
            for ($ && H && (re = e._timeline_smart_render.getVisibleEventsForRow(this, C, S, z)), k += e._timeline_get_events_html.call(this, re), k += e._timeline_get_html_for_bar_data_row(q, U), B = 0; B < e._cols.length; B++)
              e._ignores[B] ? k += e._timeline_get_html_for_bar_ignores() : $ && H ? e._timeline_smart_render.isInXViewPort({ left: W, right: W + e._cols[B] }, C) && (k += e._timeline_get_html_for_bar(B, z, this, S[z], W)) : k += e._timeline_get_html_for_bar(B, z, this, S[z], W), W += e._cols[B];
            k += "</div></div>";
          }
        }
        q.sectionKey = V.key, T.push(q);
      }
      b += D + "</div></div>", b += k + "</div></div>", b += "</div>", this._matrix = S, l.innerHTML = b, $ && e._timeline_smart_render && (e._timeline_smart_render._rendered_events_cache = []), e._populate_timeline_rendered(l);
      ...
      ($ || this.scrollable) && function(_e, Y, be) {
        Y._is_ev_creating = !1;
        var G = o(_e, Y), xe = e._els.dhx_cal_header[0], de = _e.querySelector(".dhx_timeline_label_wrapper");
        ...
        if (!G.$eventsAttached || !G.$eventsAttached[Y.name]) {
          let Ue = function(Z) {
            ...
            if (Be && Math.abs(Be) > Math.abs(We)) {
              var Pe = Be / -40;
              G.scrollLeft += 30 * Pe, G.scrollLeft === le && (ae = !1);
            } else
              Pe = We / -40, We === void 0 && (Pe = Z.detail), G.scrollTop += 30 * Pe, G.scrollTop === pe && (ae = !1);
            if (ae)
              return Z.preventDefault(), Z.cancelBubble = !0, !1;
          }, le, pe;
          G.$eventsAttached = G.$eventsAttached || {}, G.$eventsAttached[Y.name] = !0, be.attach(G, "mousewheel", Ue, { passive: !1 }), be.attach(de, "mousewheel", Ue, { passive: !1 });
          const ua = function(Z) {
            ...
            var ue = o(_e, Y);
            Z.preventDefault();
            var ne = ue.scrollTop, ee = Y.scrollHelper.getScrollValue(ue);
            le = ee, pe = ne;
            var ze = Y._summ - e.$container.querySelector(".dhx_cal_data").offsetWidth + Y.dx + Y.custom_scroll_width, ge = e._timeline_smart_render.getViewPort(Y.scrollHelper, 0, ee, ne), Ne = c();
            if (Y.scrollable)
              if (Ne.style.top = -ne + "px", e.config.rtl) {
                var Be = +e.$container.querySelector(".dhx_timeline_label_wrapper").style.height.replace("px", ""), We = Y._section_height[Y.y_unit.length] + Y._label_rows[Y._label_rows.length - 1].top;
                Y.scrollHelper.getMode() == Y.scrollHelper.modes.minMax && (We > Be || Y.render == "tree") ? xe.style.right = -1 - ee - i() + "px" : xe.style.right = -1 - ee + "px", xe.style.left = "unset";
              } else
                xe.style.left = -1 - ee + "px";
            if (Y._smartRenderingEnabled()) {
              (ee !== Y._x_scroll || Y._is_ev_creating) && (Y.second_scale ? e._timeline_smart_render.updateHeader(Y, ge, xe.children[1]) : e._timeline_smart_render.updateHeader(Y, ge, xe.children[0])), (Y._options_changed || ne !== Y._y_scroll || Y._is_ev_creating) && e._timeline_smart_render.updateLabels(Y, ge, Ne), Y._is_ev_creating = !1, e._timeline_smart_render.updateGridCols(Y, ge), e._timeline_smart_render.updateGridRows(Y, ge);
              var Pe = !1;
              if (Y.render != "cell") {
                if (cancelAnimationFrame(void 0), Y.name !== e.getState().mode)
                  return;
                e._timeline_smart_render.updateEvents(Y, ge);
              }
              var Ze, Dt = 0;
              Y._scales = {}, Ze = Y.render === "cell" ? ue.querySelectorAll(".dhx_timeline_data_col .dhx_timeline_data_row") : ue.querySelectorAll(".dhx_timeline_data_col .dhx_matrix_line");
              for (var fa = Y._render_stats, Te = 0, it = Ze.length; Te < it; Te++) {
                var St = Ze[Te].getAttribute("data-section-id"), Mt = Y.order[St];
                ae[Mt] = fa[Mt].height, Y._scales[St] = Ze[Te];
              }
            ...
            var Nt = ne, Tt = ee;
            e._timeline_save_scroll_pos(Y, Nt, Tt, ze), Pe || Y.callEvent("onScroll", [Tt, Nt]), Y._is_new_view = !1;
          };
          be.attach(G, "scroll", ua, { passive: !1 });
          ...
          be.attach(G, "touchstart", function(Z) {
            ...
            if (Ge = { pageX: ae.pageX, pageY: ae.pageY }, (ne || ee) && !e.getState().drag_id) {
              ...
              ze / Ne < 0.42 ? ne = 0 : ge / Ne < 0.42 && (ee = 0), e.config.rtl && (ne = -ne), Y.scrollHelper.setScrollValue(G, Y.scrollHelper.getScrollValue(G) + ne), G.scrollTop += ee, Y.scrollable && ee && (ue.style.top = -G.scrollTop + "px");
            }
            return Z && Z.preventDefault && Z.preventDefault(), !1;
          }, { passive: !1 });
        }
        Y.scroll_position && Y._is_new_view ? Y.scrollTo(Y.scroll_position) : e._timeline_set_scroll_pos(_e, Y), Y._is_ev_creating = !0;
      }(l, this, this._eventListeners);
    }, e._timeline_finalize_section_add = function(l, f, m) {
      m && (l._scales[f] = m, e.callEvent("onScaleAdd", [m, f]));
    }, e.attachEvent("onBeforeViewChange", function(l, f, m, b) {
      if (e.matrix[m]) {
        var D = e.matrix[m];
        if (D.scrollable || D.smart_rendering) {
          if (D.render == "tree" && l === m && f === b)
            return !0;
          l === m && +f == +b || !e.$container.querySelector(".dhx_timeline_scrollable_data") || (D._x_scroll = D._y_scroll = 0, e.$container.querySelector(".dhx_timeline_scrollable_data") && e._timeline_set_scroll_pos(e._els.dhx_cal_data[0], D));
        }
      }
      return !0;
      ...
      for (var b = 0, D = 0; +f < +m; )
        if (this._trace_x[D] = new Date(f), this.x_unit == "month" && e.date[this.x_unit + "_start"] && (f = e.date[this.x_unit + "_start"](new Date(f))), f = e.date.add(f, this.x_step, this.x_unit), e.date[this.x_unit + "_start"] && (f = e.date[this.x_unit + "_start"](f)), e._ignores[D] || b++, D++, l) {
          if (b < this.x_size && !(+f < +m))
      ...
      return { total: D, displayed: b };
    }, e._timeline_x_scale = function(l) {
      var f = e._x - this.dx - e.xy.scroll_width, m = e._min_date, b = e.xy.scale_height, D = this._header_resized || e.xy.scale_height;
      ...
      if (l.innerHTML = "<div></div>", this.second_scale) {
        ...
        for (var F = 0; F < A.length; F++) {
          ...
          B.className = "dhx_scale_bar dhx_second_scale_bar" + (W ? " " + W : ""), e.set_xy(B, C[F], D, H[F], 0), B.innerHTML = e.templates[this.name + "_second_scale_date"](U), V.appendChild(B);
        }
      }
      e.xy.scale_height = D, l = l.lastChild, this._h_cols = {};
      for (var re = 0; re < this._trace_x.length; re++)
        if (!e._ignores[re]) {
          m = this._trace_x[re], e._render_x_header(re, w[re], m, l), l.lastChild.setAttribute("data-col-id", re), l.lastChild.setAttribute("data-col-date", r(m));
      ...
      if (e._timeline_reset_scale_height.call(this, l), l) {
        ...
        if (e._timeline_x_scale.call(this, e._els.dhx_cal_header[0]), e.$container.querySelector(".dhx_timeline_scrollable_data") && this._smartRenderingEnabled()) {
          var m = e._timeline_smart_render.getViewPort(this.scrollHelper), b = e._timeline_smart_render.getVisibleHeader(this, m);
      ...
      if (l.render == "cell") {
        var b = f.x + "_" + f.y, D = l._matrix[f.y][f.x];
        if (!D)
      ...
      for (var f = l.parentNode.childNodes, m = -1, b = 0; b < f.length; b++)
        if (f[b] == l) {
          m = b;
          break;
        }
      ...
      for (var f = l.target ? l.target : l.srcElement, m = {}, b = e.matrix[e._mode], D = e.getActionData(l), k = e._ignores, S = 0, p = 0; p < b._trace_x.length - 1 && !(+D.date < b._trace_x[p + 1]); p++)
        k[p] || S++;
      m.x = S === 0 ? 0 : p, m.y = b.order[D.section];
      var w = 0;
      if (b.scrollable && b.render === "cell") {
        if (!b._scales[D.section] || !b._scales[D.section].querySelector(".dhx_matrix_cell"))
          return;
        var E = b._scales[D.section].querySelector(".dhx_matrix_cell");
        if (!E)
          return;
        var M = E.offsetLeft;
        if (M > 0) {
      ...
      m.src = b._scales[D.section] ? b._scales[D.section].querySelectorAll(".dhx_matrix_cell")[p - w] : null;
      var A, C, H = !1, $ = (A = f, C = ".dhx_matrix_scell", e.$domHelpers.closest(A, C));
      return $ && (f = $, H = !0), H ? (m.x = -1, m.src = f, m.scale = !0) : m.x = p, m;
    };
    ...
    e._click.dhx_marked_timespan = e._click.dhx_cal_data = function(l) {
      ...
      if (m) {
        var b = e._locate_cell_timeline(l);
        b && (b.scale ? e.callEvent("onYScaleClick", [b.y, m.y_unit[b.y], l]) : (e.callEvent("onCellClick", [b.x, b.y, m._trace_x[b.x], (m._matrix[b.y] || {})[b.x] || [], l]), e._timeline_set_scroll_pos(e._els.dhx_cal_data[0], m)));
      }
      return f;
    ...
    }, e.attachEvent("onCellDblClick", function(l, f, m, b, D) {
    ...
    }), e.attachEvent("onBeforeEventChanged", function(l, f, m, b) {
      return l && (l._move_delta = void 0), b && (b._move_delta = void 0), !0;
    }), e._is_column_visible = function(l) {
      var f = e.matrix[e._mode], m = e._get_date_index(f, l);
      return !e._ignores[m];
    };
    var x = e._render_marked_timespan;
    e._render_marked_timespan = function(l, f, m, b, D) {
      ...
      if (e.matrix && e.matrix[e._mode]) {
        ...
        if (b = b ? new Date(b) : e._min_date, D = D ? new Date(D) : e._max_date, b.valueOf() < e._min_date.valueOf() && (b = new Date(e._min_date)), D.valueOf() > e._max_date.valueOf() && (D = new Date(e._max_date)), !k._trace_x)
          return;
        ...
        if (l.days > 6) {
          ...
          e.date.date_part(new Date(b)) <= +C && +D >= +C && A.push(C);
        } else
          A.push.apply(A, e._get_dates_by_index(l.days));
        for (var H = l.zones, $ = e._get_css_classes_by_config(l), O = 0; O < p.length; O++)
          for (f = w[O], m = p[O], T = 0; T < A.length; T++)
            for (var z = A[T], q = 0; q < H.length; q += 2) {
              var V = H[q], R = H[q + 1], F = new Date(+z + 60 * V * 1e3), U = new Date(+z + 60 * R * 1e3);
              if (F = new Date(F.valueOf() + 1e3 * (F.getTimezoneOffset() - z.getTimezoneOffset()) * 60), b < (U = new Date(U.valueOf() + 1e3 * (U.getTimezoneOffset() - z.getTimezoneOffset()) * 60)) && D > F) {
                var W = e._get_block_by_config(l);
                W.className = $;
                var B = e._timeline_getX({ start_date: F }, !1, k) - 1, re = e._timeline_getX({ start_date: U }, !1, k) - 1, Fe = Math.max(1, re - B - 1), $e = k._section_height[m] - 1 || k.dy - 1;
                W.style.cssText = "height: " + $e + "px; " + (e.config.rtl ? "right: " : "left: ") + B + "px; width: " + Fe + "px; top: 0;", f.insertBefore(W, f.firstChild), S.push(W);
              }
            }
        return S;
      }
      return x.apply(e, [l, f, m]);
    };
    var g = e._append_mark_now;
    e._append_mark_now = function(l, f) {
      if (e.matrix && e.matrix[e._mode]) {
        var m = e._currentDate(), b = e._get_zone_minutes(m), D = { days: +e.date.date_part(m), zones: [b, b + 1], css: "dhx_matrix_now_time", type: "dhx_now_time" };
        return e._render_marked_timespan(D);
      }
      return g.apply(e, [l, f]);
    };
    var u = e._mark_timespans;
    e._mark_timespans = function() {
      if (e.matrix && e.matrix[e.getState().mode]) {
        for (var l = [], f = e.matrix[e.getState().mode], m = f.y_unit, b = 0; b < m.length; b++) {
          var D = m[b].key, k = f._scales[D], S = e._on_scale_add_marker(k, D);
          l.push.apply(l, S);
        }
        return l;
      }
    ...
    e._on_scale_add_marker = function(l, f) {
      if (e.matrix && e.matrix[e._mode]) {
        var m = [], b = e._marked_timespans;
        if (b && e.matrix && e.matrix[e._mode])
          for (var D = e._mode, k = e._min_date, S = e._max_date, p = b.global, w = e.date.date_part(new Date(k)); w < S; w = e.date.add(w, 1, "day")) {
            ...
            if (b[D] && b[D][f]) {
              var A = [], C = e._get_types_to_render(b[D][f][M], b[D][f][E]);
              A.push.apply(A, e._get_configs_to_render(C)), e.config.overwrite_marked_timespans ? A.length && (N = A) : N = N.concat(A);
            }
            for (var H = 0; H < N.length; H++) {
              var $ = N[H], O = $.days;
              O < 7 ? (O = E, m.push.apply(m, e._render_marked_timespan($, l, f, w, e.date.add(w, 1, "day"))), O = M) : m.push.apply(m, e._render_marked_timespan($, l, f, w, e.date.add(w, 1, "day")));
            }
          }
        return m;
      }
      ...
      for (var m = 0, b = 0; m < this._colsS.heights.length && !((b += this._colsS.heights[m]) > f.y); m++)
        ;
      ...
      var f = l.view, m = l.event, b = l.pos;
      if (m) {
        if (m[f.y_property] != b.section) {
          var D = this._get_timeline_event_height ? this._get_timeline_event_height(m, f) : f.getEventHeight(m);
          m._sorder = this._get_dnd_order(m._sorder, D, f.getSectionHeight(b.section));
        }
        m[f.y_property] = b.section;
      }
    }, e._get_date_index = function(l, f) {
      for (var m = l._trace_x, b = 0, D = m.length - 1, k = f.valueOf(); D - b > 3; ) {
        var S = b + Math.floor((D - b) / 2);
        m[S].valueOf() > k ? D = S : b = S;
      }
      for (var p = b; p <= D && +f >= +m[p + 1]; )
        p++;
      return p;
      ...
      if (w >= m._trace_x.length)
        S = e.date.add(m._trace_x[m._trace_x.length - 1], m.x_step, m.x_unit), m._end_correction && (S = new Date(S - m._end_correction));
      else {
        let N;
        m.x_unit == "month" ? N = D * k * (24 * new Date((/* @__PURE__ */ new Date(+m._trace_x[w])).getFullYear(), (/* @__PURE__ */ new Date(+m._trace_x[w])).getMonth() + 1, 0).getDate() * 60 * 60 * 1e3 / e._cols[0]) + m._start_correction : N = D * k * m._step + m._start_correction, S = new Date(+m._trace_x[w] + N);
      }
      return S;
      ...
      l._timeline_smart_render = { _prepared_events_cache: null, _rendered_events_cache: [], _rendered_header_cache: [], _rendered_labels_cache: [], _rows_to_delete: [], _rows_to_add: [], _cols_to_delete: [], _cols_to_add: [], getViewPort: function(m, b, D, k) {
        ...
        w && D === void 0 && (D = m.getScrollValue(w)), k === void 0 && (k = w ? w.scrollTop : S.scrollTop);
        var E = {};
        for (var M in p)
          E[M] = p[M];
        return E.scrollLeft = D || 0, E.scrollTop = k || 0, b && (p.height = b), E;
      }, isInXViewPort: function(m, b) {
        var D = b.scrollLeft, k = b.width + b.scrollLeft;
        return m.left < k + 100 && m.right > D - 100;
      }, isInYViewPort: function(m, b) {
        var D = b.scrollTop, k = b.height + b.scrollTop;
        return m.top < k + 80 && m.bottom > D - 80;
      }, getVisibleHeader: function(m, b) {
        var D = "";
        for (var k in this._rendered_header_cache = [], m._h_cols) {
          var S = m._h_cols[k];
          this.isInXViewPort({ left: S.left, right: S.left + l._cols[k] }, b) && (D += S.div.outerHTML, this._rendered_header_cache.push(S.div.getAttribute("data-col-id")));
        }
        return D;
      }, updateHeader: function(m, b, D) {
        ...
        if (this.getVisibleHeader(m, b)) {
          for (var E = this._rendered_header_cache.slice(), M = [], N = (w = 0, p.length); w < N; w++) {
            var T = E.indexOf(p[w]);
            T > -1 ? E.splice(T, 1) : M.push(p[w]);
          }
          M.length && (this._cols_to_delete = M.slice(), this._deleteHeaderCells(M, m, D)), E.length && (this._cols_to_add = E.slice(), this._addHeaderCells(E, m, D));
        }
      }, _deleteHeaderCells: function(m, b, D) {
        for (var k = 0; k < m.length; k++) {
          var S = D.querySelector('[data-col-id="' + m[k] + '"]');
          S && D.removeChild(S);
        }
      }, _addHeaderCells: function(m, b, D) {
        for (var k = "", S = 0; S < m.length; S++)
          k += b._h_cols[m[S]].div.outerHTML;
        const p = document.createElement("template");
        p.innerHTML = k, D.appendChild(p.content);
      }, getVisibleLabels: function(m, b) {
        if (m._label_rows.length) {
          var D = "";
          this._rendered_labels_cache = [];
          for (var k = 0; k < m._label_rows.length; k++)
            this.isInYViewPort({ top: m._label_rows[k].top, bottom: m._label_rows[k].top + m._section_height[m.y_unit[k].key] }, b) && (D += m._label_rows[k].div, this._rendered_labels_cache.push(k));
          return D;
        }
      }, updateLabels: function(m, b, D) {
        ...
        }), k.length || (this.getVisibleLabels(m, b), k = this._rendered_labels_cache.slice()), this.getVisibleLabels(m, b)) {
          for (var S = this._rendered_labels_cache.slice(), p = [], w = 0, E = k.length; w < E; w++) {
            var M = S.indexOf(k[w]);
            M > -1 ? S.splice(M, 1) : p.push(k[w]);
          }
          p.length && (this._rows_to_delete = p.slice(), this._deleteLabelCells(p, m, D)), S.length && (this._rows_to_add = S.slice(), this._addLabelCells(S, m, D));
        }
      }, _deleteLabelCells: function(m, b, D) {
        for (var k = 0; k < m.length; k++) {
          var S = D.querySelector('[data-row-index="' + m[k] + '"]');
          S && D.removeChild(S);
        }
      }, _addLabelCells: function(m, b, D) {
        for (var k = "", S = 0; S < m.length; S++)
          k += b._label_rows[m[S]].div;
        const p = document.createElement("template");
        p.innerHTML = k, D.appendChild(p.content);
        ...
        if (this._prepared_events_cache) {
          if (b = this._prepared_events_cache, l.getState().drag_id) {
            ...
            b.forEach((p, w) => {
              ...
              for (let M = 0; M < p.length; M++) {
                const N = p[M];
                if (N.id == D && N[m.y_property] !== E) {
                  S = !0, p.splice(M, 1), M--;
                  const T = m.order[N[m.y_property]];
                  b[T] != p && b[T] && !f(b[T], N.id) && b[T].push(N);
                }
              }
              S && (k = !0);
            });
          ...
          (b = l._prepare_timeline_events(m)).$coordinates = {}, this.cachePreparedEvents(b);
        return b;
      }, updateEvents: function(m, b) {
        var D = this.getPreparedEvents(m), k = this._rendered_events_cache.slice();
        ...
        for (var p = 0; p < this._rendered_labels_cache.length; p++) {
          ...
          var M = k[w] ? k[w].slice() : [];
          l._timeline_calculate_event_positions.call(m, D[w]);
          for (var N = l._timeline_smart_render.getVisibleEventsForRow(m, b, D, w), T = 0, A = N.length; T < A; T++) {
          ...
          if (l.getState().drag_id) {
            ...
            if (l._split_one_event && q) {
              const V = [];
              q[m.y_property] == $ && E.push(q), l._split_one_event(q, m, V), V.forEach((R) => {
                R[m.y_property] == $ && E.push(R);
              });
            } else
              q && q[m.y_property] == $ && E.push(q);
          }
          ...
          S.push(O), E.length && this._addEvents(E, m, O.buffer, w);
        }
        S.forEach(function($) {
          $.DOMParent.appendChild($.buffer.content);
        }), l._populate_timeline_rendered(l.$container), m._matrix = D;
      }, _deleteEvents: function(m, b, D) {
        for (var k = 0; k < m.length; k++) {
          const p = "[" + l.config.event_attribute + '="' + m[k] + '"]';
      ...
      }, _addEvents: function(m, b, D, k) {
        var S = l._timeline_update_events_html.call(b, m);
        D.innerHTML = S;
      }, getVisibleEventsForRow: function(m, b, D, k) {
        var S = [];
        if (m.render == "cell")
          S = D;
        else {
          ...
          if (p)
            for (var w = 0, E = p.length; w < E; w++) {
              ...
              D.$coordinates && D.$coordinates[A] ? (M = D.$coordinates[A].xStart, N = D.$coordinates[A].xEnd) : (M = l._timeline_getX(T, !1, m), N = l._timeline_getX(T, !0, m), D.$coordinates && (D.$coordinates[A] = { xStart: M, xEnd: N })), l._timeline_smart_render.isInXViewPort({ left: M, right: N }, b) && (S.push(T), this._rendered_events_cache[k] || (this._rendered_events_cache[k] = []), this._rendered_events_cache[k].push(String(T.id)));
            }
        }
        return S;
      }, getVisibleRowCellsHTML: function(m, b, D, k, S) {
        for (var p, w = "", E = this._rendered_header_cache, M = 0; M < E.length; M++) {
          var N = E[M];
          p = m._h_cols[N].left - m.dx, l._ignores[N] ? m.render == "cell" ? w += l._timeline_get_html_for_cell_ignores(D) : w += l._timeline_get_html_for_bar_ignores() : m.render == "cell" ? w += l._timeline_get_html_for_cell(N, S, m, k[S][N], D, p) : w += l._timeline_get_html_for_bar(N, S, m, k[S], p);
        }
        return w;
      }, getVisibleTimelineRowsHTML: function(m, b, D, k) {
        var S = "", p = l._timeline_get_cur_row_stats(m, k);
        p = l._timeline_get_fit_events_stats(m, k, p);
        var w = m._label_rows[k], E = l.templates[m.name + "_row_class"], M = { view: m, section: w.section, template: E };
        return m.render == "cell" ? (S += l._timeline_get_html_for_cell_data_row(k, p, w.top, w.section.key, M), S += this.getVisibleRowCellsHTML(m, b, p, D, k), S += "</div>") : (S += l._timeline_get_html_for_bar_matrix_line(k, p, w.top, w.section.key, M), S += l._timeline_get_html_for_bar_data_row(p, M), S += this.getVisibleRowCellsHTML(m, b, p, D, k), S += "</div></div>"), S;
      }, updateGridRows: function(m, b) {
        this._rows_to_delete.length && this._deleteGridRows(this._rows_to_delete, m), this._rows_to_add.length && this._addGridRows(this._rows_to_add, m, b);
      }, _deleteGridRows: function(m, b) {
        if (l.$container.querySelector(".dhx_cal_data .dhx_timeline_data_col")) {
          for (var D = 0; D < m.length; D++) {
            const k = b.y_unit[m[D]] ? b.y_unit[m[D]].key : null;
            b._divBySectionId[k] && (b._divBySectionId[k].remove(), delete b._divBySectionId[k]);
          }
          this._rows_to_delete = [];
        }
      }, _addGridRows: function(m, b, D) {
        if (!(E = l.$container.querySelector(".dhx_cal_data .dhx_timeline_data_col")))
          return;
        for (var k = this.getPreparedEvents(b), S = "", p = 0; p < m.length; p++)
          S += this.getVisibleTimelineRowsHTML(b, D, k, m[p]);
        ...
        for (p = 0; p < m.length; p++) {
          const N = b.y_unit[m[p]] ? b.y_unit[m[p]].key : null;
          l._timeline_finalize_section_add(b, b.y_unit[m[p]].key, b._divBySectionId[N]);
        }
        l._mark_now && l._mark_now(), this._rows_to_add = [];
      }, updateGridCols: function(m, b) {
        ...
        l.$container.querySelectorAll(".dhx_timeline_data_row").forEach((function(p) {
          ...
          M.forEach(function(A) {
            A.remove();
          }), N.length && this._addGridCols(p, N, m, b);
        }).bind(this));
      }, _addGridCols: function(m, b, D, k) {
        if (!l.$container.querySelector(".dhx_cal_data .dhx_timeline_data_col"))
          return;
        var S = this.getPreparedEvents(D);
        const p = m.closest("[data-section-id]").getAttribute("data-section-id"), w = D.order[p];
        ...
        if (N) {
          for (var T = 0; T < b.length; T++)
            if (!N.querySelector('[data-col-id="' + b[T] + '"]')) {
              var A = this.getVisibleGridCell(D, k, M, S, w, b[T]);
              A && (E += A);
            }
          const C = document.createElement("template");
          C.innerHTML = E, N.appendChild(C.content);
        }
      }, getVisibleGridCell: function(m, b, D, k, S, p) {
        if (m._h_cols[p]) {
          var w = "", E = m._h_cols[p].left - m.dx;
          return m.render == "cell" ? l._ignores[p] || (w += l._timeline_get_html_for_cell(p, S, m, k[S][p], D, E)) : l._ignores[p] || (w += l._timeline_get_html_for_bar(p, S, m, k[S], E)), w;
        }
  ...
  e.attachEvent("onTimelineCreated", function(t) {
    ...
    if (t == "tree") {
      ...
      const g = `var(--dhx-scheduler-treetimeline-level-padding) * ${a.level}`;
      x = a.level < 2 ? `calc(${g} + 4px)` : `calc(${g})`;
      const u = `style='--dhx-scheduler-treetimeline-level-padding-value: ${x}'`;
  ...
  e._props = {}, e.createUnitsView = function(i, t, a, s, n, _, d) {
    ...
    typeof i == "object" && (a = i.list, t = i.property, s = i.size || 0, n = i.step || 1, _ = i.skip_incorrect, d = i.days || 1, i = i.name), e._props[i] = { map_to: t, options: a, step: n, position: 0, days: d, layout: "units" }, s > e._props[i].options.length && (e._props[i]._original_size = s, s = 0), e._props[i].size = s, e._props[i].skip_incorrect = _ || !1, e.date[i + "_start"] = e.date.day_start, e.templates[i + "_date"] = function(h, y) {
      ...
      var x = h.position || 0, g = r(y), u = h.size || h.options.length;
      return g >= u && (g %= u), x + g;
    }, e.templates[i + "_scale_text"] = function(h, y, x) {
      return x.css ? "<span class='" + x.css + "'>" + y + "</span>" : y;
    }, e.templates[i + "_scale_date"] = function(h) {
      var y = e._props[i], x = y.options;
      if (!x.length)
        return "";
      var g = x[e._get_unit_index(y, h)], u = r(h), v = y.size || y.options.length, l = e.date.add(e.getState().min_date, Math.floor(u / v), "day");
      return e.templates[i + "_scale_text"](g.key, g.label, g, l);
      ...
      const y = e._props[i], x = y.size || y.options.length, g = Math.min(x, y.options.length);
      return e.date.add(h, g * e._props[i].days, "day");
    }, e.attachEvent("onOptionsLoad", function() {
      for (var h = e._props[i], y = h.order = {}, x = h.options, g = 0; g < x.length; g++)
        y[x[g].key] = g;
      h._original_size && h.size === 0 && (h.size = h._original_size, delete h._original_size), h.size > x.length ? (h._original_size = h.size, h.position = 0, h.size = 0) : h.size = h._original_size || h.size, e._date && e._mode == i && e.setCurrentView(e._date, e._mode);
      ...
      if (y) {
        if (h = this._week_indexes_from_pos(h), this._drag_event || (this._drag_event = {}), this._drag_id && this._drag_mode && (this._drag_event._dhx_changed = !0), this._drag_mode && this._drag_mode == "new-size" && y.days && y.days > 1) {
          var x = e._get_event_sday(e._events[e._drag_id]);
          Math.floor(h.x / y.options.length) != Math.floor(x / y.options.length) && (h.x = x);
        }
        var g = y.size || y.options.length, u = h.x % g, v = Math.min(u + y.position, y.options.length - 1);
        h.section = (y.options[v] || {}).key, h.x = Math.floor(h.x / g);
    ...
    var i = function(g) {
      ...
      if (u && u.order && u.skip_incorrect) {
        for (var v = [], l = 0; l < g.length; l++)
          u.order[g[l][u.map_to]] !== void 0 && v.push(g[l]);
        g.splice(0, g.length), g.push.apply(g, v);
      }
      return g;
    }, t = e._pre_render_events_table;
    e._pre_render_events_table = function(g, u) {
      return g = i(g), t.apply(this, [g, u]);
    };
    var a = e._pre_render_events_line;
    e._pre_render_events_line = function(g, u) {
      return g = i(g), a.apply(this, [g, u]);
    };
    var s = function(g, u) {
      if (g && g.order[u[g.map_to]] === void 0)
        return g.options.length && (u[g.map_to] = g.options[0].key), !0;
    }, n = e.is_visible_events;
    e.is_visible_events = function(g) {
      var u = n.apply(this, arguments);
      if (u) {
        var v = e._props[this._mode];
        if (v && v.size) {
          var l = v.order[g[v.map_to]];
    ...
    e._process_ignores = function(g, u, v, l, f) {
      if (e._props[this._mode]) {
        ...
        if (m) {
          ...
          u /= b;
          for (var D = new Date(g), k = 0; k < u; k++) {
            if (m(D))
              for (var S = (k + 1) * b, p = k * b; p < S; p++)
                this._ignores_detected += 1, this._ignores[p] = !0, f && u++;
            D = e.date.add(D, l, v), e.date[v + "_start"] && (D = e.date[v + "_start"](D));
          }
        }
      } else
        _.call(this, g, u, v, l, f);
    };
    var d = e._reset_scale;
    e._reset_scale = function() {
      var g = e._props[this._mode];
      g && (g.size && g.position && g.size + g.position > g.options.length ? g.position = Math.max(0, g.options.length - g.size) : g.size || (g.position = 0), g.size && g.size > g.options.length && (g.size = g.options.length));
      var u = d.apply(this, arguments);
      if (g) {
        this._max_date = this.date.add(this._min_date, g.days, "day");
        ...
        if (f.valueOf() >= this._min_date && f.valueOf() < this._max_date) {
          var m = Math.floor((f - e._min_date) / 864e5), b = g.size || g.options.length, D = m * b, k = D + b;
          for (l = D; l < k; l++)
            v[l] && v[l].classList.add("dhx_scale_holder_now");
        }
        if (g.size && g.size < g.options.length) {
          var S = this._els.dhx_cal_header[0], p = document.createElement("div");
          g.position && (this._waiAria.headerButtonsAttributes(p, ""), e.config.rtl ? (p.className = "dhx_cal_next_button", p.style.cssText = "left:auto;margin-top:-8px;right:0px;position:absolute;") : (p.className = "dhx_cal_prev_button", p.style.cssText = "left:1px;margin-top:-8px;position:absolute;"), S.firstChild.appendChild(p), p.addEventListener("click", function(w) {
            e.scrollUnit(-1 * g.step), w.preventDefault();
    ...
    e._get_view_end = function() {
      ...
      if (g && g.days > 1) {
        ...
        return e.date.add(u, g.days, "day");
      }
      return r.apply(this, arguments);
    };
    var o = e._render_x_header;
    e._render_x_header = function(g, u, v, l) {
      ...
      if (f.days > 1) {
        ...
        e.xy.scale_height = Math.ceil(b / 2), o.call(this, g, u, v, m, Math.ceil(e.xy.scale_height));
        var D = f.size || f.options.length;
        if ((g + 1) % D === 0) {
          var k = document.createElement("div");
          k.className = "dhx_scale_bar dhx_second_scale_bar";
          var S = this.date.add(this._min_date, Math.floor(g / D), "day");
          this.templates[this._mode + "_second_scalex_class"] && (k.className += " " + this.templates[this._mode + "_second_scalex_class"](new Date(S)));
          var p, w = this._cols[g] * D;
          p = D > 1 && this.config.rtl ? this._colsS[g - (D - 1)] - this.xy.scroll_width : D > 1 ? this._colsS[g - (D - 1)] - this.xy.scale_width : u, this.set_xy(k, w, this.xy.scale_height, p, 0), k.innerHTML = this.templates[this._mode + "_second_scale_date"](new Date(S), this._mode), m.appendChild(k);
        }
        e.xy.scale_height = b;
      }
    };
    var c = e._get_event_sday;
    e._get_event_sday = function(g) {
      var u = e._props[this._mode];
      return u ? u.days <= 1 ? (s(u, g), this._get_section_sday(g[u.map_to])) : Math.floor((g.end_date.valueOf() - 1 - 60 * g.end_date.getTimezoneOffset() * 1e3 - (e._min_date.valueOf() - 60 * e._min_date.getTimezoneOffset() * 1e3)) / 864e5) * (u.size || u.options.length) + u.order[g[u.map_to]] - u.position : c.call(this, g);
    }, e._get_section_sday = function(g) {
      var u = e._props[this._mode];
      return u.order[g] - u.position;
    };
    var h = e.locate_holder_day;
    e.locate_holder_day = function(g, u, v) {
      var l, f = e._props[this._mode];
      return f ? (v ? s(f, v) : (v = { start_date: g, end_date: g }, l = 0), f.days <= 1 ? 1 * (l === void 0 ? f.order[v[f.map_to]] : l) + (u ? 1 : 0) - f.position : Math.floor((v.start_date.valueOf() - e._min_date.valueOf()) / 864e5) * (f.size || f.options.length) + 1 * (l === void 0 ? f.order[v[f.map_to]] : l) + (u ? 1 : 0) - f.position) : h.apply(this, arguments);
    };
    var y = e._time_order;
    e._time_order = function(g) {
      var u = e._props[this._mode];
      u ? g.sort(function(v, l) {
        return u.order[v[u.map_to]] > u.order[l[u.map_to]] ? 1 : -1;
      }) : y.apply(this, arguments);
    };
    var x = e._pre_render_events_table;
    e._pre_render_events_table = function(g, u) {
      var v = e._props[this._mode];
      if (v && v.days > 1) {
        for (var l, f = {}, m = 0; m < g.length; m++) {
          var b = g[m];
          if (e.isOneDayEvent(g[m]))
            f[S = +e.date.date_part(new Date(b.start_date))] || (f[S] = []), f[S].push(b);
          else {
            var D = new Date(Math.min(+b.end_date, +this._max_date)), k = new Date(Math.max(+b.start_date, +this._min_date));
            for (k = e.date.day_start(k), g.splice(m, 1), m--; +k < +D; ) {
              var S, p = this._copy_event(b);
        ...
        g = [];
        for (var m in f) {
          var w = x.apply(this, [f[m], u]), E = this._colsS.heights;
          (!l || E[0] > l[0]) && (l = E.slice()), g.push.apply(g, w);
        }
        var M = this._colsS.heights;
        for (M.splice(0, M.length), M.push.apply(M, l), m = 0; m < g.length; m++)
          if (this._ignores[g[m]._sday])
            g.splice(m, 1), m--;
          else {
            var N = g[m];
      ...
      return g;
    }, e.attachEvent("onEventAdded", function(g, u) {
      if (this._loading)
        return !0;
      ...
      return !0;
    }), e.attachEvent("onEventCreated", function(g, u) {
      var v = e._props[this._mode];
      if (v && u) {
        var l = this.getEvent(g);
        s(v, l);
  ...
  e._get_url_nav = function() {
    ...
    e.attachEvent("onAfterEventDisplay", function(_) {
      ...
      s && y.push("event=" + s);
      var x = "#" + y.join(",");
      return document.location.hash = x, !0;
    });
  });
  ...
  e._wa = {}, e.xy.week_agenda_scale_height = 20, e.templates.week_agenda_event_text = function(t, a, s, n) {
    ...
    e.render_data = function(s) {
      ...
      e._min_date = e.date.week_start(e._date), e._max_date = e.date.add(e._min_date, 1, "week"), e.set_sizes(), s ? (e._table_view = e._allow_dnd = !0, e.$container.querySelector(".dhx_cal_header").style.display = "none", e._els.dhx_cal_date[0].innerHTML = "", function() {
        let n;
        e._els.dhx_cal_data[0].innerHTML = "", e._rendered = [], n = e.config.container_autoresize ? "dhx_wa_row_autoresize" : "dhx_wa_row";
        ...
        const r = e.$container.querySelectorAll(".dhx_wa_day_cont");
        e._wa._selected_divs = [];
        var o = e.get_visible_events(), c = e.date.week_start(e._date), h = e.date.add(c, 1, "day");
        const y = { 3: 1, 1: 2, 4: 3, 2: 4 };
        for (var x = 0; x < 7; x++) {
          let p = x;
          y.hasOwnProperty(x) && (p = y[x]), r[p]._date = c, r[p].setAttribute("data-date", e.templates.format_date(c)), e._waiAria.weekAgendaDayCell(r[p], c);
          var g = r[p].querySelector(".dhx_wa_scale_bar"), u = r[p].querySelector(".dhx_wa_day_data");
          g.innerHTML = e.templates.week_agenda_scale_date(c);
          ...
          for (var m = 0; m < v.length; m++) {
            var b = v[m], D = document.createElement("div");
            e._rendered.push(D);
            var k = e.templates.event_class(b.start_date, b.end_date, b);
            D.classList.add("dhx_wa_ev_body"), k && D.classList.add(k), e.config.rtl && D.classList.add("dhx_wa_ev_body_rtl"), b._text_style && (D.style.cssText = b._text_style), b.color && D.style.setProperty("--dhx-scheduler-event-background", b.color), b.textColor && D.style.setProperty("--dhx-scheduler-event-color", b.textColor), e._select_id && b.id == e._select_id && (e.config.week_agenda_select || e.config.week_agenda_select === void 0) && (D.classList.add("dhx_cal_event_selected"), e._wa._selected_divs.push(D));
            var S = "";
            b._timed || (S = "middle", b.start_date.valueOf() >= c.valueOf() && b.start_date.valueOf() <= h.valueOf() && (S = "start"), b.end_date.valueOf() >= c.valueOf() && b.end_date.valueOf() <= h.valueOf() && (S = "end")), D.innerHTML = e.templates.week_agenda_event_text(b.start_date, b.end_date, b, c, S), D.setAttribute("event_id", b.id), D.setAttribute(e.config.event_attribute, b.id), e._waiAria.weekAgendaEvent(D, b), u.appendChild(D);
          }
  ...
  e.clear_view = function() {
    ...
    for (var y = this.getEvents(d, this.date.add(d, 1, "day")), x = "", g = 0; g < y.length; g++) {
      var u = y[g];
      if (this.filter_event(u.id, u)) {
        ...
        x += "<div class='dhx_tooltip_line' style='" + v + l + "' event_id='" + y[g].id + "' " + this.config.event_attribute + "='" + y[g].id + "'>", x += "<div class='dhx_tooltip_date' style='" + v + l + "'>" + (y[g]._timed ? this.templates.event_date(y[g].start_date) : "") + "</div>", x += "<div class='dhx_event_icon icon_details'>&nbsp;</div>", x += this.templates.year_tooltip(y[g].start_date, y[g].end_date, y[g]) + "</div>";
      }
    }
    this._tooltip.style.display = "", this._tooltip.style.top = "0px", document.body.offsetWidth - r.left - this._tooltip.offsetWidth < 0 ? this._tooltip.style.left = r.left - this._tooltip.offsetWidth + "px" : this._tooltip.style.left = r.left + c.offsetWidth + "px", this._tooltip.date = d, this._tooltip.innerHTML = x, document.body.offsetHeight - r.top - this._tooltip.offsetHeight < 0 ? this._tooltip.style.top = r.top - this._tooltip.offsetHeight + c.offsetHeight + "px" : this._tooltip.style.top = r.top + "px";
    ...
    for (let x = 0; x < 12; x++) {
      ...
      g.className = "dhx_year_box", g.setAttribute("date", this._helpers.formatDate(c)), g.setAttribute("data-month-date", this._helpers.formatDate(c)), g.innerHTML = `<div class='dhx_year_month'>${this.templates.year_month(c)}</div>
			<div class='dhx_year_grid'></div>`;
      const u = g.querySelector(".dhx_year_grid"), v = e._createDatePicker(null, { date: c, filterDays: e.ignore_year, minWeeks: 6 });
      v._renderDayGrid(u), v.destructor(), o.appendChild(g), c = this.date.add(c, 1, "month");
    }
    d.appendChild(o);
...
}(Rn), Kt = ha.getSchedulerInstance(), Gt = ha;
typeof window < "u" && (window.scheduler = Kt, window.Scheduler = Gt, window.$dhx || (window.$dhx = {}), window.$dhx.scheduler = Kt, window.$dhx.Scheduler = Gt);
export {
  Gt as Scheduler,
  Kt as scheduler
};
